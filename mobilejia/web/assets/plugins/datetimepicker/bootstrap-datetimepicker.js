...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="glyphicon glyphicon-arrow-left"/></th>'+ //icon modifed by keenthemes.
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="glyphicon glyphicon-arrow-right"/></th>'+//icon modifed by keenthemes.
							'</tr>'+
						'</thead>',
