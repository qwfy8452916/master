var ieSwiper = function (selector, params) {
    'use strict';
    ...
    var defaults = {
        ...
        noSwipingClass : 'ieswiper-no-swiping', //:)
        initialSlide: 0,
        ...
        //Namespace
        slideElement: 'div',
        slideClass: 'ieswiper-slide',
        slideActiveClass: 'ieswiper-slide-active',
        slideVisibleClass: 'ieswiper-slide-visible',
        slideDuplicateClass: 'ieswiper-slide-duplicate',
        wrapperClass: 'ieswiper-wrapper',
        paginationElementClass: 'ieswiper-pagination-switch',
        paginationActiveClass: 'ieswiper-active-switch',
        paginationVisibleClass: 'ieswiper-visible-switch'
    };
    params = params || {};
    ...
    if ((_this.browser.ie10 || _this.browser.ie11) && !params.onlyExternal) {
        _this.wrapper.classList.add('ieswiper-wp8-' + (isH ? 'horizontal' : 'vertical'));
    }
    ...
    /*=========================
      ...
      ===========================*/
    if (params.freeMode) {
        _this.container.className += ' ieswiper-free-mode';
    }
