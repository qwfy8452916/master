...
class Sms extends Controller
{
    ...
    public function sendsms()
    {
        ...
        $smsChannel = OP('sms_channel') ?: 'yuntongxun';
        switch (strtolower($smsChannel)) {
            case 'yuntongxun':
    ...
    public function sendemail()
    {
        ...
        model("LogEmailUserSend")->addLog($data);
        curl_close($ch);
        return json($array);
    }
    ...
    protected function saveLog($cityId, $ip, $tel, $smsMessageSid, $tel_encrypt, $dateCreated, $remark, $addtime, $sms_channel, $flag = true)
    {
        ...
        model("LogSmsUserSend")->addLog($smsData); //写日志
    }
}
