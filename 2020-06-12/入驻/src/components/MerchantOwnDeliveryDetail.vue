<template>
    <div class="platdeliverydetail">
        ...
        <el-table :data="deliveryDateDetail.orderDeliveryDetailDTOList" border style="width:100%;">
            <el-table-column fixed prop="prodProductDTO.prodName" label="商品名称" min-width="200px"></el-table-column>
            ...
            <el-table-column prop="prodStatus" label="状态" min-width="100px" align=center>
                <template slot-scope="scope">
