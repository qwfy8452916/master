<template>
    <div class="owndeliverylist">
        ...
        <el-table :data="DeliveryDataList" border stripe style="width:100%;" >
            <el-table-column fixed prop="orderDeliveryDTO.delivCode" label="配送单号" width="180px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.hotelName" label="酒店名称" min-width="200px"></el-table-column>
            <el-table-column prop="orderDeliveryDTO.roomFloor" label="楼层" min-width="80px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.roomCode" label="房间号" min-width="80px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.funcName" label="功能区" min-width="100px"></el-table-column>
            ...
            <el-table-column prop="prodCount" label="数量" min-width="60px" align=center></el-table-column>
            <el-table-column prop="totalAmount" label="商品金额" min-width="80px" align=center></el-table-column>
            <el-table-column prop="couponAmount" label="优惠券金额" min-width="100px" align=center></el-table-column>
            <el-table-column prop="actualPay" label="实付金额" min-width="80px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.contactPhone" label="手机号" width="120px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.payCompleteTime" label="支付时间" width="160px" align=center></el-table-column>
            <el-table-column prop="orderDeliveryDTO.status" label="状态" min-width="100px" align=center>
                <template slot-scope="scope">
            ...
            <el-table-column fixed="right" label="操作" width="100px" align=center>
                <template slot-scope="scope">
                    <el-button type="text" size="small" @click="deliveryDetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        //查看详情
        deliveryDetail(id){
            this.$router.push({name: 'MerchantServiceDeliveryDetail', query: {id}});
        },
        //查询
        inquire(){
            this.pageNum = 1;
