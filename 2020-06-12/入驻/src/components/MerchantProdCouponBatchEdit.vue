    ...
    <div class="ProdCouponBatchEdit">
         ...
         <el-form label-width="130px" style="width:70%" :model="addCoupondata" ref="addCoupondata" :rules="rules">
            ...
            <div v-if="addCoupondata.discountWay==2">
              ...
              <el-form-item label="封顶金额" prop="discountMaxMoney">
                <el-input
                  :disabled="true"
               ...
               <div>
                  <el-radio @change="changecouponTermType" v-model="addCoupondata.couponTermType" :label="0">领取后</el-radio>
                    ...
                    <el-form-item class="couponTermType" v-if="addCoupondata.couponTermType=='0'" prop="couponTermDays">
                         <el-input v-model.number="addCoupondata.couponTermDays"></el-input>天
                    </el-form-item>
               </div>
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BM_COUPON_MERBATCH_MODSUBMIT']" type="primary" @click="sureBtn('addCoupondata')">确 定</el-button>
            </el-form-item>
         </el-form>
    ...
    data(){
      ...
      return {
          ...
          addCoupondata:{
            discountWay: 1,  //优惠方式
            couponDiscount:"", //折扣
            discountMaxMoney:"", //封顶金额
            discountMinBuyMoney:"", //最低消费金额
            couponTermAfterDay:"", //领取后起
            canSell:1,  //是否可售卖
            canGift:1,  //是否可赠予
