...
export default {
    ...
    mounted(){
        ...
        this.prodSpecsDetail();
    },
    methods: {
        //获取商品详情
        prodSpecsDetail(){
            const params = {};
            this.$api.prodSpecsDetail(params, this.psId)
                .then(response => {
                    ...
                    if(result.code == '0'){
                        ...
                        this.prodId =  result.data.prodId;
                    }else{
        ...
        submitForm(ProdSpecsData){
            ...
            this.$refs[ProdSpecsData].validate((valid) => {
                if (valid) {
                    ...
                    this.isSubmit = true;
                    this.$api.prodSpecsModify(params, this.psId)
                        .then(response => {
                            // console.log(response);
                            const result = response.data;
                            if(result.code == '0'){
