<template>
    <div class="platdeliverydetail">
        ...
        <table cellpadding="0" cellspacing="0" class="deliveryTable">
            ...
            <tr v-if="deliveryDateDetail.lgcHotelId != 0">
                <td class="subTitle">运费</td>
                <td class="subcont">{{deliveryDateDetail.lgcDeductFee}}</td>
            </tr>
            <tr v-if="deliveryDateDetail.lgcHotelId != 0">
                <td class="subTitle">接单时间</td>
                <td class="subcont"></td>
            </tr>
            <tr v-if="deliveryDateDetail.lgcHotelId != 0">
        ...
        <el-table :data="deliveryDateDetail.orderDeliveryDetailDTOList" border style="width:88%;">
            <el-table-column fixed prop="prodOrgKindName" label="类型" align=center></el-table-column>
            ...
            <el-table-column prop="prodStatus" label="状态">
                <template slot-scope="scope">
        ...
        <el-button type="primary" v-if="deliveryDateDetail.status == 0 && authzlist['F:BH_DELIV_OWNDELIVERYLIST_DETAILSUBMIT']" @click="ensurePlatDelivery">确认</el-button>
        <el-button type="primary" v-if="deliveryDateDetail.delivWay == 2 && deliveryDateDetail.status == 1 &&  authzlist['F:BH_DELIV_OWNDELIVERYLIST_DETAILSHIP']" @click="shipmentsPlatDelivery">发货</el-button>
        <el-button type="primary" v-if="deliveryDateDetail.status == 2 && deliveryDateDetail.lgcStatus == 5" @click="againShipmentsDelivery">重新发单</el-button>
        <el-button type="primary" v-if="deliveryDateDetail.lgcHotelId != 0 && deliveryDateDetail.lgcStatus != 4 && deliveryDateDetail.status != 0 && deliveryDateDetail.status != 1" @click="updateLgcStatus">更新状态</el-button>
...
export default {
    ...
    methods: {
        ...
        shipmentsPlatDelivery(){
            if(this.deliveryDateDetail.lgcHotelId != 0){
        ...
        //重新发单
        againShipmentsDelivery(){
            const params = {};
            const delivCode = this.deliveryDateDetail.delivCode;
        ...
        updateLgcStatus(){
            const params = {
                delivCode: this.deliveryDateDetail.delivCode,
            };
        ...
        couponUserDetails(id){
            //跳 ‘ 查看用户卡券详情 ’
            this.$router.push({name: 'HotelCardCouponDetail', query: {id}});
        },
