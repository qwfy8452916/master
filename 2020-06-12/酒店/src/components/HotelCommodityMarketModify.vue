    ...
    <div class="commoditymarket">
        ...
        <el-form :model="CommodityMarketData" :rules="rules" ref="CommodityMarketData" label-width="100px" class="commoditymarketform">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTALTERSUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('CommodityMarketData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
