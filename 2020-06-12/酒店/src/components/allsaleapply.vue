    ...
    <div class="aftersaleapplylist">
        ...
        <el-table :data="aftersaleapplylistDataList" border stripe style="width:100%;" >
            ...
            <el-table-column label="操作" width="120px" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button v-if="authzlist['F:BH_CS_ALLPROD_VIEW']" type="text" size="small" @click="lookdetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        aftersaleapplylist(){
            ...
            this.$api.allAfterSale({params}).then(response=>{
