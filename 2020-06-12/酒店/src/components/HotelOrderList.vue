<template>
    <div class="HotelOrderList">
        <el-form :inline="true" align=left class="searchform">
            ...
            <el-form-item label="订单金额">
                <el-select v-model="orderAmountStatus">
                    ...
                    <el-option label="为0" value="0"></el-option>
                    <el-option label="不为0" value="1"></el-option>
                </el-select>
            </el-form-item>
        ...
        <el-table :data="HotelOrderListDataList" border stripe style="width:100%;" >
            <el-table-column fixed prop="orderCode" label="订单编号" width="180px" align=center></el-table-column>
            ...
            <el-table-column prop="prodCount" label="商品数量" min-width="80px" align=center></el-table-column>
            ...
            <el-table-column prop="orderStatus" label="订单状态" min-width="80px" align=center>
            ...
            <el-table-column fixed="right" label="操作" min-width="140px" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzlist['F:BH_ORDER_ORDERLIST_DETAIL']" type="text" size="small" @click="prodDetails(scope.row.id)">商品详情</el-button>
                    <el-button type="text" size="small" @click="couponDetails(scope.row.id)">卡券详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        HotelOrderList(){
            ...
            this.$api.HotelOrderList(params).then(response=>{
        ...
        exportExe(){
            ...
            window.location.href = "http://hotel.kefangbao.com.cn/longan/api/order/hotel/export/download?orgAs=3&hotelId="+ this.hotelId +"&phone="+ this.phone +"&orderAmountStatus="+ this.orderAmountStatus +"&status="+ this.status +"&startTime="+ this.inquireTime[0] +"&endTime="+ this.inquireTime[1] +"&token="+ this.token;
