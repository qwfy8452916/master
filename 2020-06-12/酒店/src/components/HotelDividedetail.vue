<template>
    <div class="HotelDividedetail">
        ...
        <div class="export"><el-button v-if="!authzlist['F:BH_FIN_ACCOUNTGMAN_ACCOUNTGMANEXPORT']" class="addbutton" @click="exportniu">导出</el-button></div>
    ...
    methods: {
       ...
       addmulMonth(dtstr, n)
        ...
        exportniu(){
          ...
          if(this.formdata.inquireTime==null || this.formdata.inquireTime.length<1){
             this.formdata.inquireTime[0]=""
             this.formdata.inquireTime[1]=""
          }
          window.location.href ="http://hotel.kefangbao.com.cn/longan/api/fin/export/download?orgAs="+this.formdata.identity+"&revenueStartTime="+this.formdata.inquireTime[0]+"&revenueEndTime="+this.formdata.inquireTime[1]+"&token="+this.token
