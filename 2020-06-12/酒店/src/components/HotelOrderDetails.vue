<template>
    <div class="platdeliverydetail">
        ...
        <el-table :data="orderProdDataDetail.orderDetailDTOList" border style="width:100%;">
            ...
            <el-table-column prop="prodGenre" label="商品形式"></el-table-column>
            <el-table-column prop="prodSpecs" label="商品规格"></el-table-column>
        ...
        <el-dialog title="分成详情" :visible.sync="divideDetaildialog" v-if="divideDetaildialog" class="dividedialog">
            <el-form align="left" label-width="125px" :model="divideDetailData" ref="LogisticsEditData">
...
export default {
    ...
    methods: {
        ...
        HotelOrderDetails(){
            const params = {};
            const id = this.opId;
            this.$api.HotelOrderDetails(params, id)
                .then(response => {
