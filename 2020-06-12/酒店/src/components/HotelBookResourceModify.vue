    ...
    <div class="resourceadd">
        ...
        <el-form :model="ResourceDataModify" :rules="rules" ref="ResourceDataModify" label-width="120px" class="bookform">
            ...
            <el-form-item label="房型名称" prop="roomTypeId">
                <el-select v-model="ResourceDataModify.roomTypeId" placeholder="请选择">
                    <el-option 
            ...
            <el-form-item label="是否为钟点房" prop="isHourRoom">
                <el-radio-group v-model="ResourceDataModify.isHourRoom">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_BOOK_RESOURCE_EDIT_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('ResourceDataModify')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        submitForm(ResourceDataModify){
            const that = this;
            const giftJSON = this.ResourceDataModify.GiftData.map(item => item.giftTxt);
            let rpRate;
            ...
            const params = {
                ...
                basicPrice: parseFloat(this.ResourceDataModify.basicPrice).toFixed(2),
            ...
            this.$refs[ResourceDataModify].validate((valid) => {
                if(valid){
                    ...
                    // console.log(params);
                    this.isSubmit = true;
                    this.$api.bookResourceModify(params, id)
                        .then(response => {
