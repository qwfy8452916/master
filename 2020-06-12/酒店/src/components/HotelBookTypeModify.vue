    ...
    <div class="booktypeadd">
        ...
        <el-form :model="BookTypeData" :rules="rules" ref="BookTypeData" label-width="120px" class="bookform">
            ...
            <el-form-item label="是否有钟点房" prop="hourRoomFlag">
                <el-radio-group v-model="BookTypeData.hourRoomFlag">
            ...
            <!-- <el-form-item>
                ...
                <el-input type="textarea" :rows="3" v-model.trim="facilityMedia" maxlength="250" placeholder="请输入媒体科技"></el-input>
                <p class="facilitytitle">浴室设施</p>
                <el-input type="textarea" :rows="3" v-model.trim="facilityShower" maxlength="250" placeholder="请输入浴室设施"></el-input>
                <p class="facilitytitle">食品/饮品</p>
                <el-input type="textarea" :rows="3" v-model.trim="facilityFood" maxlength="250" placeholder="请输入食品/饮品"></el-input>
                <p class="facilitytitle">便利设施</p>
                <el-input type="textarea" :rows="3" v-model.trim="facilityFast" maxlength="250" placeholder="请输入便利设施"></el-input>
                <p class="facilitytitle">其他</p>
                <el-input type="textarea" :rows="3" v-model.trim="facilityElse" maxlength="250" placeholder="请输入其他"></el-input>
            </el-form-item> -->
            <el-form-item>
            ...
            <el-form-item>
                ...
                <el-button v-if="authzlist['F:BH_BOOK_TYPE_EDIT_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('BookTypeData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        submitForm(BookTypeData){
            ...
            /*let facilityList = [
                {
                    facilityContent: this.facilityMedia,
                    facilityType: 4
                },{
                    facilityContent: this.facilityShower,
                    facilityType: 2
                },{
                    facilityContent: this.facilityFood,
                    facilityType: 3
                },{
                    facilityContent: this.facilityFast,
                    facilityType: 1
                },{
                    facilityContent: this.facilityElse,
                    facilityType: 5
                }
            ];*/
            ...
            this.$refs[BookTypeData].validate((valid) => {
                if(valid){
                    if(this.BookTypeData.hourRoomFlag == 1){
                    ...
                    this.isSubmit = true;
                    this.$api.bookTypeModify(params, id)
                        .then(response => {
                            // console.log(response);
                            const result = response.data;
                            if(result.code == '0'){
