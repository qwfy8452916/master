   ...
   <div class="CardticketAdd">
      <el-form align="left" :model="carddata" label-width="140px" ref="carddata" :rules="rules">
          ...
          <el-form-item label="基础价格" prop="vouBasicPrice">
               <el-input v-model="carddata.vouBasicPrice" maxlength="18" oninput ="value=value.replace(/[^0-9.]/g,'')"></el-input>元
          </el-form-item>
          <el-form-item label="允许转赠" prop="canGive">
               <el-switch v-model="carddata.canGive" :active-value="1" :inactive-value="0"  @change="updateStatus()"></el-switch>
          </el-form-item>
          ...
          <el-form-item label="使用有效期" prop="vouTermType">
            ...
            <el-form-item label="抵扣设置" prop="vouDeductibleType" v-if="carddata.vouUseScene==2">
               ...
               金额:<el-input v-model="carddata.vouDeductibleMoney" class="vouDeductibleType" oninput ="value=value.replace(/[^0-9.]/g,'')"></el-input>元</el-form-item>
               <div>
                  ...
                  <span v-if="carddata.vouDeductibleType==1">
                    ...
                    <el-form-item prop="vouDeductibleHotelProdSpecId" v-if="carddata.vouDeductibleHotelProd.isSupportSpec>0" style="display:inline-block;">
                      <el-select v-model="carddata.vouDeductibleHotelProdSpecId" class="specguige" value-key="id">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_VOU_CARDTICKET_MODIFY_SUBMIT']" type="primary" @click="sureBtn('carddata')">确定</el-button>
            </el-form-item>
      </el-form>
   </div>
</template>
...
export default {
  ...
  data(){
      ...
      rules:{
        ...
        vouDeductibleMoney:{required:true,validator: validateMoney,message:"请填写现金金额",trigger:["blur","change"]},
        vouDeductibleHotelProdId:{required:true,validator: validateProd,message:"请选择商品",trigger:["blur","change"]},
        vouDeductibleHotelProdSpecId:{required:true,message:"请选择商品规格",trigger:"change"},
  ...
  methods:{
        ...
        CardticketDetail(){
          let that=this;
          let params={};
          this.$api.CardticketDetail(params,this.editId).then(response=>{
        ...
        sureBtn(carddata){
           ...
           this.$refs[carddata].validate((valid,model)=>{
            ...
            let params={
                ...
                vouDeductibleHotelProdSpecId:that.carddata.vouDeductibleHotelProdSpecId,
                vouOwnerOrgKind:3,
                };
                that.$api.cardticketEdit(params,this.editId).then(response=>{
                   let result=response.data;
                   if(result.code==0){
