    ...
    <div class="outhouselist">
        ...
        <el-table :data="HotelGodownEntryDataList" border stripe style="width:100%;" >
            ...
            <el-table-column fixed="right" label="操作" width="200px" align=center>
                <template slot-scope="scope">
                    <el-button v-if="scope.row.reviewStatus== 2 && authzlist['F:BH_INV_OWNPRODOUTLIST_SCHEDULE']" type="text" size="small" @click="examineDetail(scope.row.wfId)">审核进度</el-button>
                    <el-button v-if="authzlist['F:BH_INV_OWNPRODOUTLIST_DETAIL']" type="text" size="small" @click="lookDetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
