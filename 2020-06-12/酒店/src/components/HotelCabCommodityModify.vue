    ...
    <div class="commoditymodify">
        ...
        <el-form v-model="HotelCommodityDataModity" :model="HotelCommodityDataModity" :rules="rules" ref="HotelCommodityDataModity" label-width="100px" class="hotelcommodityform">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_PROD_CABPROD_EDIT_SUBMIT']" type="primary" @click="submitForm('HotelCommodityDataModity')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
                    ...
                    that.$api.hotelCabinetCommodityModify(params,id)
                        .then(response => {
                            if(response.data.code == '0'){
                                ...
                                const hotelId = that.hotelId;
                                const id = that.profileId;
                                that.$router.push({name: 'HotelCabCommodityManage', query: {hotelId, id}});
                            }else{
