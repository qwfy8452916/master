      ...
      <el-form align="left" :model="carddata" label-width="140px">
          ...
          <el-form-item label="使用有效期" prop="vouTermType">
            ...
            <el-form-item label="核销次数" prop="vouVerifiedTotalType" v-if="carddata.vouUseScene==1">
               <el-radio v-model="carddata.vouVerifiedTotalType" :disabled="true" :label="1" @change="vouVerifiedTotalType">一次</el-radio>
               <el-radio v-model="carddata.vouVerifiedTotalType" :disabled="true" :label="2" @change="vouVerifiedTotalType">多次</el-radio>
            ...
            <el-form-item label="抵扣设置" prop="vouDeductibleType" v-if="carddata.vouUseScene==2">
               <el-radio v-model="carddata.vouDeductibleType" :disabled="true" :label="0" @change="setdikou">现金</el-radio>
               ...
               <div>
                  <el-radio v-model="carddata.vouDeductibleType" :disabled="true" :label="1" @change="setdikou">商品</el-radio>
...
export default {
  ...
  methods:{
        ...
        setdikou(e){
          if(e==0){
            this.carddata.vou_deductible_hotel_prod_id=""
          }else if(e==1){
            this.carddata.vouDeductibleMoney=""
          }
