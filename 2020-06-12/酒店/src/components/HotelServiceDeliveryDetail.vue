<template>
    <div class="platdeliverydetail">
        ...
        <el-table v-if="deliveryType != 1" :data="deliveryDateDetail.orderDeliveryDetailDTOList" border style="width:88%;">
            <el-table-column prop="prodOrgKindName" label="类型" align=center></el-table-column>
            <el-table-column prop="prodOwner" label="商家" width="180px" align=center></el-table-column>
        ...
        <el-button type="primary" v-if="deliveryDateDetail.status == 0 && authzlist['F:BH_DELIV_SERVICEDELIVERYLIST_DETAILSUBMIT']" @click="ensurePlatDelivery">确认</el-button>
