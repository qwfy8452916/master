<template>
    <div class="commoditymarket">
        <!-- <div>
            <div>
                <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTADD']" class="addbutton" @click="commodityMarketAdd">添加市场分类</el-button>
                <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTIMPORT']" class="addbutton" @click="importTemplate">导入模板</el-button>
            </div>
            <el-table :data="CommodityMarketDataList" border style="width:100%;" >
                ...
                <el-table-column label="操作" width="180px" align=center>
                    <template slot-scope="scope">
                        <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTALTER']" type="text" size="small" @click="modifyCommodityMarket(scope.row.id)">修改</el-button>
                        <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTDELETE']" type="text" size="small" @click="deleteCommodityMarket(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <div style="text-align: left;">
            <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTADD']" class="addbtn" @click="levelOneAdd">新增</el-button>
            <el-button v-if="authzlist['F:BH_HOTEL_COMMODITYMARKETLISTIMPORT']" class="addbtn" @click="importTemplate">导入模板</el-button>
        </div>
        <el-tree
            :data = "typeDataDetail"
            :props="defaultProps"
...
export default {
    ...
    methods: {
        ...
        // //添加市场分类
        // commodityMarketAdd(){
        //     this.$router.push({name:'HotelCommodityMarketAdd'});
        // },
        // //导入模板
        // importTemplate(){
        //     const params = {
        ...
        //     this.$router.push({name:'HotelCommodityMarketModify', query: {id}});
        // },
        // //删除
