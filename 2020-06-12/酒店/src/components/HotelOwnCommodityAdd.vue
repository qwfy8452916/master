<template>
    <div class="commodityadd">
        ...
        <el-form :model="CommodityDataAdd" :rules="rules" ref="CommodityDataAdd" label-width="140px" class="commodityform">
            ...
            <el-form-item v-if="isInvShow" prop="isNeedInv">
                ...
                <el-switch v-model="CommodityDataAdd.isNeedInv" @change="selectIsInv"></el-switch>
            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button v-if="authzlist['F:BH_PROD_HOTELPRODADDSUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('CommodityDataAdd')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
