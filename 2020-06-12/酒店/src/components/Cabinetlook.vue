<template>
    <div class="hotellist">
        ...
        <el-table :data="CabinetLook" border style="width:100%;" >
          <el-table-column prop="latticeCode" label="格子序号" width="180px" align=center></el-table-column>
            ...
            <el-table-column prop="prodProductDTO.prodName" label="商品名称" width="180px" align=center></el-table-column>
            <el-table-column prop="prodProductDTO.prodUnitMeasure" label="规格" width="180px" align=center></el-table-column>
            <el-table-column prop="hotelProduct.prodRetailPrice" label="零售价" width="180px" align=center></el-table-column>
