   ...
   <div class="CouponList">
       ...
       <el-table :data="CouponList" border stripe style="width:100%">
          ...
          <el-table-column prop="id" label="操作" align="center" fixed="right" min-width="180px">
              <template slot-scope="scope">
                  <el-button v-if="authzData['F:BH_COUPON_HOTELCOUPON_EXTEND']" type="text" @click="extendTime(scope.row.id,scope.row.couponBatchName,scope.row.couponName)">延长有效期</el-button>
