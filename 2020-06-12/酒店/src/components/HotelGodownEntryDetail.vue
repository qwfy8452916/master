<template>
    <div class="godownentryadd">
        ...
        <el-form :model="godownEntryDataDetail" :inline="true" align=left>
            ...
            <el-form-item label="类型" prop="ownerKindName">
                <el-input :disabled="true" v-model="godownEntryDataDetail.ownerKindName"></el-input>
            </el-form-item>
            <el-form-item label="入驻商名称" prop="merName">
                <el-input :disabled="true" v-model="godownEntryDataDetail.merName"></el-input>
            </el-form-item>
