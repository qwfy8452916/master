<template>
    <div class="aftersaleapplylist">
        ...
        <el-table :data="aftersaleapplylistDataList" border stripe style="width:100%;" >
            ...
            <el-table-column prop="funcName" label="功能区" width="120px" align=center></el-table-column>
            ...
            <el-table-column label="操作" width="120px" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button type="text" v-if="scope.row.status==1 && authzlist['F:BH_CS_HOTELPROD_DEAL']" size="small" @click="handle(scope.$index, aftersaleapplylistDataList)">处理</el-button>
                    <el-button v-if="authzlist['F:BH_CS_HOTELPROD_VIEW']" type="text" size="small" @click="lookdetail(scope.$index, aftersaleapplylistDataList)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        handleaftersale(csType,status){
            ...
            const params = {
                supplierLogisticsCode: this.logisticsgs,
                supplierLogisticsInfo: this.businessnumber,
