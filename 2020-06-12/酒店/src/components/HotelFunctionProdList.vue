<template>
    <div class="functionlist">
        ...
        <div v-if="authzData['F:BH_PROD_FUNCPROD_ADD']"><el-button class="addbutton" @click="functionProdAdd">添&nbsp;&nbsp;加</el-button></div>
        <el-table :data="functionProdDataList" border stripe style="width:100%;" >
            ...
            <el-table-column v-if="authzData['F:BH_PROD_FUNCPROD_USING']" prop="onShelfProd" label="上下架" min-width="80px" align=center>
                <template slot-scope="scope">
            ...
            <el-table-column fixed="right" label="操作" min-width="200px" align=center>
                <template slot-scope="scope">
                    ...
                    <el-button v-if="authzData['F:BH_PROD_FUNCPROD_EDIT']" type="text" size="small" @click="funcProdModify(scope.row.id)">修改</el-button>
                    <el-button v-if="authzData['F:BH_PROD_FUNCPROD_DELETE']" type="text" size="small" @click="funcProdDelete(scope.row.id)">移除</el-button>
...
export default {
    ...
    methods: {
        ...
        //新增
        functionProdAdd(){
            this.$router.push({name:'HotelFunctionProdAdd'});
        },
        //详情
        funcProdDetail(id){
            this.$router.push({name:'HotelFunctionProdDetail', query: {id}});
        },
        //修改
        funcProdModify(id){
            this.$router.push({name:'HotelFunctionProdModify', query: {id}});
        },
        //移除
        funcProdDelete(id){
            this.fpId = id;
