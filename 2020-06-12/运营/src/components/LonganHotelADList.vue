    ...
    <div class="hotellist">
        ...
        <el-table :data="AdDataList" border stripe style="width:100%;" >
            ...
            <el-table-column fixed="right" label="操作" min-width="280px" align=center>
                <template slot-scope="scope">
                    <el-button v-if="scope.row.status == 2" type="text" size="small" @click="ADModifyCancel(scope.row.id)">撤销修改</el-button>
                    ...
                    <el-button v-if="scope.row.status != 1" type="text" size="small" @click="hotelADIssue(scope.row.id)">发布</el-button>
                </template>
            </el-table-column>
        </el-table>
