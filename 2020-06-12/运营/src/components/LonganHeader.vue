        ...
        <div class="loginuser">
            <el-dropdown @command="handleCommand">
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item v-if="authzData['M:BO_OPR_OPRINFO']" command='1'><i class="el-icon-thirdicon_bangzhuwendang"></i>企业信息</el-dropdown-item>
    ...
    methods:{
        ...
        handleCommand(command){
            if(command == 0){
                ...
                this.$router.push({name: 'LonganPrivilegeUpdatePWD'});
            }else if(command == 3){
                this.$router.push({name: 'LonganPrivilegeUpdateUserInfo'});
            }
        },
        //退出登录
        logOut(){
            // window.location.href = 'http://172.16.200.90/longan/opr/#/login';
