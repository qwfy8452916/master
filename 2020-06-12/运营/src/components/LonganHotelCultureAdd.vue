    ...
    <div class="hotelserviceadd">
        ...
        <el-form :model="HotelCultureData" :rules="rules" ref="HotelCultureData" label-width="100px" class="hotelservicetypeform">
            <el-form-item label="酒店名称" prop="hotelInfo">
                <el-select 
                    v-model="HotelCultureData.hotelInfo" 
                    filterable
                    remote
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BO_HOTEL_CULTURE_ADD_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('HotelCultureData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        submitForm(HotelCultureData){
            const params = {
                oprId: this.oprId,
                hotelId: this.HotelCultureData.hotelInfo,
