<template>
    <div class="servicetypelist">
        <div class="modifybtn"><el-button type="primary" @click="formIntroduceModify">修改动态表单介绍信息</el-button></div>
        ...
        <div><el-button class="addbutton" @click="serviceFormAdd">新增表单明细</el-button></div>
...
export default {
    ...
    methods: {
        ...
        formIntroduceModify(){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceFormIntroduce', query: {hsId}});
        },
        //新增
        serviceFormAdd(){
            const hsId = this.hsId;
        ...
        serviceFormModify(id){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceFormModify', query: {hsId, id}});
        },
        //删除
