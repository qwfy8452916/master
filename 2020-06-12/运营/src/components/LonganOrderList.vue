<template>
    <div class="LonganOrderList">
        ...
        <el-table :data="LonganOrderListDataList" border stripe style="width:100%;" >
            ...
            <el-table-column fixed="right" label="操作" width="200px" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_ORDER_ORDER_PROD']" type="text" size="small" @click="productdetails(scope.row.id)">商品详情</el-button>
                    <el-button v-if="authzData['F:BO_ORDER_ORDER_DELIV'] && scope.row.orderStatus != 2" type="text" size="small" @click="deliverydetails(scope.row.id)">配送详情</el-button>
...
export default {
    ...
    methods: {
        ...
        LonganOrderList(){
            ...
            this.$api.LonganOrderList(params).then(response=>{
