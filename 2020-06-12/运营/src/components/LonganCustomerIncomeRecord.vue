<template>
    <div class="CustomerIncomeRecord">
        ...
        <el-table :data="incomeRecordDataList" border stripe style="width:100%;" >
            ...
            <el-table-column label="操作" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_FIN_CUSTINCOME_DETAIL']" type="text" size="small" @click="lookdetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    mounted(){
        ...
        this.HotelFuncList();
        this.getHotelList();
        this.customerIncomeRecord();
    },
    methods: {

          //查看详情
         lookdetail(id){
            this.$router.push({name:'LonganCustomerInRecordDetail',query:{id}})
         },
         ...
         customerIncomeRecord(){
            ...
            const params = {
                ...
                roomFloorAndCode:this.roomFloorAndCode,
                startTime:this.query.inquireTime[0],
                endTime:this.query.inquireTime[1],
                userId:this.query.userId
            };
            this.$api.incomeRecord({params},2).then(response=>{
