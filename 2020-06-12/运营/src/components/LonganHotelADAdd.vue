    ...
    <div class="hotelserviceadd">
        ...
        <el-form :model="HotelADData" :rules="rules" ref="HotelADData" label-width="80px" class="hotelform">
            ...
            <el-form-item label="级别" prop="adLevel">
                <el-radio-group v-model="HotelADData.adLevel" @change="selectADRank">
                    <el-radio :label="0">通用</el-radio>
                    <el-radio :label="1">专用</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item v-if="HotelADData.adLevel == 0">
                <span slot="label"><label class="required-icon">*</label> 适用范围</span>
                <el-radio-group v-model="HotelADData.adScope" @change="selectADScope">
                    <el-radio :label="0" class="radioscope">平台</el-radio><br/>
                    <el-radio :label="1" class="radioscope">特定酒店</el-radio>
                    <el-button v-if="HotelADData.adScope == 1" type="text" size="small" @click="selectHotel(1)">选择酒店</el-button><br/>
                    <el-table v-if="HotelADData.adScope == 1" :data="SelectedHotelData" border stripe style="width:100%;" >
                        ...
                        <el-table-column fixed="right" label="操作" min-width="80px" align=center>
                            <template slot-scope="scope">
                                <el-button type="text" size="small" @click="hotelDelete(scope.row.id)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <el-radio :label="2" class="radioscope">除特定酒店外</el-radio>
                    <el-button v-if="HotelADData.adScope == 2" type="text" size="small" @click="selectHotel(2)">选择酒店</el-button>
                    <el-table v-if="HotelADData.adScope == 2" :data="SelectedHotelData" border stripe style="width:100%;" >
                        <el-table-column prop="hotelName" label="酒店名称" min-width="240px"></el-table-column>
                        <el-table-column fixed="right" label="操作" min-width="80px" align=center>
                            <template slot-scope="scope">
                                <el-button type="text" size="small" @click="hotelDelete(scope.row.id)">删除</el-button>
            ...
            <el-form-item v-if="HotelADData.adLevel == 1">
                <span slot="label"><label class="required-icon">*</label> 酒店</span>
                <el-select 
        ...
        <el-dialog title="选择酒店" :visible.sync="dialogVisibleHotel" width="48%">
            ...
            <el-table :data="HotelDataList" border stripe @selection-change="selectedHotel" style="width:100%;">
...
export default {
    ...
    methods: {
        ...
        //适用范围 - 删除
        hotelDelete(id){
            let deleteIndex = this.SelectedHotelData.findIndex(item => item.id == id);
