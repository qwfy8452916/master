<template>
    <div class="LonganMessagelist">
      <el-form :inline="true" align=left class="searchform">
        ...
        <div class="addranchisee"><el-button class="addbutton" v-if="authzData['F:BO_MSG_MSGTEMP_ADD']" type="primary" @click="addranchisee">+创建</el-button></div>
        <el-table
            ...
            <el-table-column fixed="right" prop="isSafe" label="操作" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_MSG_MSGTEMP_VIEW']" type="text" size="small" @click="checkmsg(scope.row.tpCode)">查看</el-button>
                    <el-button v-if="authzData['F:BO_MSG_MSGTEMP_SWITCH']" type="text" size="small" @click="enableDisable(scope.row.tpCode,scope.row.status)">
                        <span v-if="scope.row.status=='DISABLE'">启用</span>
                        <span v-if="scope.row.status=='ENABLE'">禁用</span>
                    </el-button>
                    <el-button v-if="authzData['F:BO_MSG_MSGTEMP_MODIFY']" type="text" size="small" @click="editDialog(scope.row.tpCode)">修改</el-button>
                    <el-button v-if="authzData['F:BO_MSG_MSGTEMP_DELETE']" type="text" size="small" @click="delbtn(scope.row.tpCode)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="titleText" :visible.sync="showhidedia">
              ...
              <div slot="footer" class="dialog-footer" center>
                ...
                <el-button v-if="!checkProhibit && authzData['F:BO_MSG_MSGTEMP_SUBMIT']" @click="surebtn('formData')" type="primary">确 定</el-button>
              </div>
