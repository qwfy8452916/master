<template>
    <div class="platdeliverydetail">
        ...
        <el-table :data="orderDelivDataDetail.orderDeliveryDTOS" border style="width:100%;">
            ...
            <el-table-column prop="prodOrgKindName" label="类型" align=center>
                <template slot-scope="scope">
            ...
            <el-table-column prop="confirmTime" label="确认时间" min-width="160px" align=center></el-table-column>
            <el-table-column prop="shipmentsTime" label="发货时间" min-width="160px" align=center></el-table-column>
            <el-table-column prop="logistics" label="物流公司"></el-table-column>
            <el-table-column prop="logisticsCode" label="物流单号" align=center></el-table-column>
            <el-table-column v-if="authzlist['F:BO_ORDER_ORDER_DELIV_VIEW']" fixed="right" label="操作" align=center width="200px">
                <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        orderDeliveryDetail(){
            const params = {};
            const id = this.opId;
            this.$api.orderDeliveryDetail(params, id)
                .then(response => {
