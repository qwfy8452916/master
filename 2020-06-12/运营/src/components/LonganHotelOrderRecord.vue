    ...
    <div>
        ...
        <el-table :data="CabinetList" border stripe style="width:100%;" >
            ...
            <el-table-column fixed="right" label="订单号" min-width="150" align=center>
                <template slot-scope="scope">
                    <el-button type="text" v-if="scope.row.orderStatus == 1" size="small" @click="productdetails(scope.$index, CabinetList)">{{scope.row.orderCode}}</el-button>
...
export default {
    ...
    methods: {
        ...
        Getdata(){ 
            ...
            this.$api.selHotelOrderRecords({params}).then(response => {
