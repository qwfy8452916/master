...
<template>
  <div class="CabTypeDetail">
     <p class="title">查看柜子类型</p>
    <el-form align="left" :model="addCabinetData" :rules="rules" ref="addCabinetData">
        ...
        <el-form-item label="类型名称" label-width="120px" prop="cabTypeName">
           <el-input :disabled="true" v-model="addCabinetData.cabTypeName" maxlength="10"></el-input>
        </el-form-item>
        <el-form-item label="是否虚拟柜子" label-width="120px" prop="virtualFlag">
           <el-switch :disabled="true" v-model="addCabinetData.virtualFlag" :active-value="1" :inactive-value="0"></el-switch>
        </el-form-item>
        ...
        <el-form-item v-if="!addCabinetData.virtualFlag" label="柜子布局" label-width="120px" prop="pageLayout">
            <el-input :disabled="true" v-model="addCabinetData.pageLayout" type="textarea" :rows="8"></el-input>
        </el-form-item>
  ...
  export default{
    ...
    methods:{
      ...
      sureBtn(addCabinetData){
        ...
        this.$refs[addCabinetData].validate((valid,model)=>{
          if(valid){
            ...
            this.$api.editCabinetType(params,that.cabinetTypeId).then(response=>{
      ...
      CabinetTypeDetail(){
         let that=this;
         let params="";
         this.$api.CabinetTypeDetail(params,that.cabinetTypeId).then(response=>{
           if(response.data.code=='0'){
