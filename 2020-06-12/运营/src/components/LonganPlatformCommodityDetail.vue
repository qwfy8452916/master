    ...
    <div class="commodityadd">
        ...
        <el-form :model="CommodityDataModify" :rules="rules" ref="CommodityDataModify" label-width="130px" class="commodityform">
            ...
            <el-form-item label="供货价" prop="prodSupplyPrice">
                <el-input :disabled="true" v-model.trim="CommodityDataModify.prodSupplyPrice" maxlength="18"></el-input> 元
            </el-form-item>
            <el-form-item label="零售价" prop="prodRetailPrice">
                <el-input :disabled="true" v-model.trim="CommodityDataModify.prodRetailPrice" maxlength="18"></el-input> 元
            </el-form-item>
            <el-form-item label="划线价" prop="prodMarketPrice">
                <el-input :disabled="true" v-model.trim="CommodityDataModify.prodMarketPrice" maxlength="18"></el-input> 元
            </el-form-item>
