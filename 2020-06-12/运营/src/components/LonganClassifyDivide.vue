<template>
    <div class="ClassifyDivide">
        ...
        <el-table :data="ClassifyDivideDataList" border stripe style="width:100%;" >
            ...
            <el-table-column prop="revenueKindName" label="类别" align=center>
            </el-table-column>
...
export default {
    ...
    methods: {
        resetFunc(){
         ...
         lookdetail(id,orgId){
            let organId=orgId;
            this.$router.push({name:'LonganDetailedDivide',query:{datetime:this.query.inquireTime,organId}})
         },
        ...
        Classifydivide(){
            ...
            this.$api.getClassifydivide({params}).then(response=>{
                if(response.data.code==0){
