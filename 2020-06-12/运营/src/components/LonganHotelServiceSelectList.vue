<template>
    <div class="servicetypelist">
        ...
        <div><el-button class="addbutton" @click="serviceCommonAdd">新增列表明细</el-button></div>
...
export default {
    ...
    methods: {
        ...
        serviceCommonAdd(){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceSelectAdd', query: {hsId}});
        },
        //修改
        serviceCommonModify(id){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceSelectModify', query: {hsId, id}});
        },
        //删除
