    ...
    <div class="hoteladd">
        ...
        <el-form v-model="HotelDataModify" :model="HotelDataModify" :rules="rules" ref="HotelDataModify" label-width="180px" class="hotelform">
            ...
            <el-form-item label="酒店名称" prop="hotelName">
                <el-input :disabled="true" v-model="HotelDataModify.hotelName"></el-input>
            </el-form-item>
            <el-form-item label="酒店星级" prop="hotelStarLevel">
                <div class="starclass">
                    <el-rate :disabled="true" v-model="HotelDataModify.hotelStarLevel"></el-rate>
                    <el-button disabled type="text" size="small" @click="rateEmpty">清空</el-button>
                </div>
            </el-form-item>
            <el-form-item label="酒店装修时间" prop="hotelDecorationYear">
                <!-- <el-date-picker type="date" :disabled="true" v-model="HotelDataModify.hotelDecorationYear" placeholder="选择日期"></el-date-picker> -->
                <el-date-picker type="year" :disabled="true" v-model="HotelDataModify.hotelDecorationYear" placeholder="选择年" value-format="yyyy"></el-date-picker>
            </el-form-item>
            <el-form-item label="酒店荣誉" prop="hotelHonor">
                <el-input type="textarea" :disabled="true" autosize v-model="HotelDataModify.hotelHonor"></el-input>
            </el-form-item>
             <el-form-item label="酒店风格" prop="hotelStyle">
                <el-input type="textarea" :disabled="true" autosize v-model="HotelDataModify.hotelStyle"></el-input>
            </el-form-item>
            <el-form-item label="停车场" prop="isHasPark">
                <el-switch :disabled="true" v-model="HotelDataModify.isHasPark"></el-switch>
            </el-form-item>
            <el-form-item>
                <span slot="label"><label class="titlebar">酒店信息&nbsp;&nbsp;</label></span>
            </el-form-item>
            <el-form-item label="酒店管理员手机号" prop="adminMobile">
                <el-input :disabled="true" v-model="HotelDataModify.adminMobile"></el-input>
            </el-form-item>
            <el-form-item label="酒店联系人" prop="hotelContactsName">
                <el-input :disabled="true" v-model="HotelDataModify.hotelContactsName"></el-input>
            </el-form-item>
             <el-form-item label="酒店联系人手机" prop="hotelContactsMobile">
                <el-input :disabled="true" v-model="HotelDataModify.hotelContactsMobile"></el-input>
            </el-form-item>
            <el-form-item label="酒店订房电话" prop="hotelBookingPhone">
                <el-input :disabled="true" v-model="HotelDataModify.hotelBookingPhone"></el-input>
            </el-form-item>
            <el-form-item label="客服电话" prop="hotelServicePhone">
                <el-input :disabled="true" v-model="HotelDataModify.hotelServicePhone"></el-input>
            </el-form-item>
            <el-form-item>
                <span slot="label"><label class="required-icon">*</label> 区域选择</span>
                <el-select :disabled="true" v-model="HotelDataModify.selectProvince" placeholder="省级地区" @change="selectProvince" style="width: 26%;">
                    <el-option v-for="item in province" :key="item.id" :label="item.dictName" :value="item.dictValue"></el-option>
                </el-select>
                <el-select :disabled="true" v-model="HotelDataModify.selectCity" placeholder="市级地区" @change="selectCity" style="width: 26%;">
                    <el-option v-for="item in city" :key="item.id" :label="item.dictName" :value="item.dictValue"></el-option>
                </el-select>
                <el-select :disabled="true" v-model="HotelDataModify.selectDistrict" placeholder="区级地区" @change="selectArea" style="width: 28%;">
            ...
            <!-- <el-form-item label="区域选择" prop="selectProvince">
                <el-select :disabled="true" v-model="HotelDataModify.selectProvince" placeholder="省级地区" @change="selectProvince">
                    <el-option v-for="item in province" :key="item.id" :label="item.dictName" :value="item.dictValue"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="selectCity">
                <el-select :disabled="true" v-model="HotelDataModify.selectCity" placeholder="市级地区" @change="selectCity">
                    <el-option v-for="item in city" :key="item.id" :label="item.dictName" :value="item.dictValue"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="selectDistrict">
               <el-select :disabled="true" v-model="HotelDataModify.selectDistrict" placeholder="区级地区" @change="selectArea">
                    <el-option v-for="item in area" :key="item.id" :label="item.dictName" :value="item.dictValue"></el-option>
                </el-select>
            </el-form-item> -->
            <el-form-item label="地址" prop="hotelAddress">
                <el-input :disabled="true" type="textarea" :row="2" id="tipinput" v-model="HotelDataModify.hotelAddress"></el-input>
            </el-form-item>
            <el-form-item label="地图定位" prop="mapPosition" style="width: 150%;">
                <!-- <div id="container" style="width:87%;height:200px;"></div> -->
            ...
            <el-form-item label="经纬度" prop="hotelLngLat">
                <el-input :disabled="true" v-model="HotelDataModify.hotelLngLat" maxlength="30"></el-input>
            </el-form-item>
            <!-- <el-form-item label="经度" prop="hotelLongitude">
                <el-input :disabled="true" v-model="HotelDataModify.hotelLongitude"></el-input>
                <input type="text" id="lng" hidden>
            </el-form-item>
            <el-form-item label="纬度" prop="hotelLatitude">
                <el-input :disabled="true" v-model="HotelDataModify.hotelLatitude"></el-input>
            ...
            <el-form-item label="酒店主题" prop="hotelThemeId">
                <!-- <div class="divskin" v-for="item in skinList" :key="item.id">
                    ...
                    <el-radio name="skin" :disabled="true" v-model="hotelSkinWatch" :label="item.id">模板{{item.id}}</el-radio>
                </div> -->
                <el-select :disabled="true" v-model="HotelDataModify.hotelThemeId" placeholder="请选择" @change="selectSkin">
                    <el-option 
            ...
            <el-form-item label="红包" prop="isSupportRedPacket">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportRedPacket"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportRedPacket" prop="redPacketRate">
                ...
                <el-input :disabled="true" v-model.trim="HotelDataModify.redPacketRate" maxlength="10"></el-input> %
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportRedPacket" prop="minOrderAmount">
                ...
                <el-input :disabled="true" v-model.trim="HotelDataModify.minOrderAmount" maxlength="10"></el-input> 元
            </el-form-item> -->
            <el-form-item>
                <span slot="label"><label class="titlebar">开票设置&nbsp;&nbsp;</label></span>
            </el-form-item>
            <el-form-item label="支持自营商品销售发票" prop="isSupportProdInvoice">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportProdInvoice"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportProdInvoice">
                <span slot="label"><label class="required-icon">*</label> 自营商品销售发票类型</span>
                <el-checkbox-group :disabled="true" v-model="HotelDataModify.prodInvoiceWayList">
            ...
            <el-form-item v-if="HotelDataModify.isSupportProdInvoice">
                ...
                <el-input :disabled="true" v-model.trim="HotelDataModify.prodInvoiceTaxRate" maxlength="10"></el-input> %
                <!-- <el-select :disabled="true" v-model="HotelDataModify.prodInvoiceTaxRate" placeholder="请选择">
            ...
            <el-form-item label="支持以房费形式开具发票" prop="isSupportRoomInvoice">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportRoomInvoice"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportRoomInvoice">
                <span slot="label"><label class="required-icon">*</label> 房费发票税率</span>
                <el-input :disabled="true" v-model.trim="HotelDataModify.roomInvoiceTaxRate" maxlength="10"></el-input> %
            </el-form-item>
            <el-form-item label="是否显示房费发票提醒" prop="isShowInvoiceReminder">
                <el-switch :disabled="true" v-model="HotelDataModify.isShowInvoiceReminder"></el-switch>
            </el-form-item>
            <el-form-item>
                <span slot="label"><label class="titlebar">迷你吧&nbsp;&nbsp;</label></span>
            </el-form-item>
            <!-- <el-form-item label="分成比例" prop="hotelRoyaltyRate">
                <el-input :disabled="true" v-model.trim="HotelDataModify.hotelRoyaltyRate" maxlength="10"></el-input> %
            </el-form-item> -->
            ...
            <!-- <el-form-item prop="isInvoice">
                ...
                <el-radio name="ticket" :disabled="true" v-model="HotelDataModify.isInvoice" :label="1">是</el-radio>
                <el-radio name="ticket" :disabled="true" v-model="HotelDataModify.isInvoice" :label="0">否</el-radio>
            </el-form-item> -->
            <el-form-item label="分成协议" prop="cabAllocId">
                <el-select :disabled="true" v-model="HotelDataModify.cabAllocId" placeholder="请选择">
                    <el-option
            ...
            <el-form-item label="便利店" prop="isSupportStore">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportStore"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportStore" prop="delivFee">
                <span slot="label"><label class="required-icon">*</label> 配送费</span>
                <el-input :disabled="true" v-model.trim="HotelDataModify.delivFee" maxlength="10"></el-input> 元/件
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportStore" prop="storeAllocId">
                ...
                <el-select :disabled="true" v-model="HotelDataModify.storeAllocId" placeholder="请选择">
                    <el-option
                        v-for="item in protocolList" 
                        :key="item.id" 
                        :label="item.allocName" 
            ...
            <el-form-item>
             ...
             <el-form-item label="客房服务" prop="isSupportRmsvc">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportRmsvc"></el-switch>
            </el-form-item>
            ...
            <!-- <el-form-item>
                <span slot="label"><label class="titlebar">酒店商城&nbsp;&nbsp;</label></span>
            </el-form-item>
            <el-form-item label="酒店商城" prop="isSupportHshop">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportHshop" @change="isMall"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportHshop">
                <span slot="label"><label class="required-icon">*</label> 配送方式</span>
                <el-checkbox-group :disabled="true" v-model="distributionType">
                    <el-checkbox label="0" >客房配送</el-checkbox>
                    <el-checkbox label="1" >快递配送</el-checkbox>
                </el-checkbox-group>
            </el-form-item>
            <el-form-item label="酒店合伙人" prop="hotelPartner">
                <el-input :disabled="true" v-model="HotelDataModify.hotelPartner"></el-input>
            </el-form-item>
            <el-form-item label="城市运营商" prop="cityOperator">
                <el-input :disabled="true" v-model="HotelDataModify.cityOperator"></el-input>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportHshop">
                <span slot="label"><label class="required-icon">*</label> 分成协议</span>
                <el-select :disabled="true" v-model="HotelDataModify.hshopAllocId" placeholder="请选择">
                    <el-option
                        v-for="item in protocolList" 
                        :key="item.id" 
                        :label="item.allocName" 
            ...
            <el-form-item v-if="HotelDataModify.isSupportHshop" label="酒店商城banner图">
                ...
                <el-select :disabled="true" v-model="shopBannerlink1" placeholder="图片链接">
                    <el-option v-for="item in cabLinkList" :key="item.id" :label="item.url" :value="item.id"></el-option>
                </el-select>
                <el-select :disabled="true" v-model="shopBannerlink2" placeholder="图片链接">
                    <el-option v-for="item in cabLinkList" :key="item.id" :label="item.url" :value="item.id"></el-option>
                </el-select>
                <el-select :disabled="true" v-model="shopBannerlink3" placeholder="图片链接">
                    <el-option v-for="item in cabLinkList" :key="item.id" :label="item.url" :value="item.id"></el-option>
                </el-select>
            </el-form-item> -->
            <el-form-item>
            ...
            <el-form-item label="客房协议价" prop="isSupportRoomAlloc">
               <el-switch :disabled="true" v-model="HotelDataModify.isSupportRoomAlloc"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportRoomAlloc">
                <span slot="label"><label class="required-icon">*</label> 分成协议</span>
                <el-select :disabled="true" v-model="HotelDataModify.roomAllocId" placeholder="请选择">
                    <el-option
                        v-for="item in protocolList" 
                        :key="item.id" 
                        :label="item.allocName" 
            ...
            <el-form-item label="政策信息" prop="policyInfo">
                <el-input :disabled="true" type="textarea" :rows="10" maxlength="250" v-model="HotelDataModify.policyInfo"></el-input>
            </el-form-item>
            <el-form-item>
                <span slot="label"><label class="titlebar">英文版&nbsp;&nbsp;</label></span>
            </el-form-item>
            <el-form-item label="购物小程序英文显示" prop="isSupportEn">
               <el-switch :disabled="true" v-model="HotelDataModify.isSupportEn"></el-switch>
            </el-form-item>
            <el-form-item>
                <span slot="label"><label class="titlebar">福柜设置&nbsp;&nbsp;</label></span>
            </el-form-item>
            <el-form-item label="福柜" prop="isSupportWelfareCab">
                <el-switch :disabled="true" v-model="HotelDataModify.isSupportWelfareCab"></el-switch>
            </el-form-item>
            <el-form-item v-if="HotelDataModify.isSupportWelfareCab" prop="welfareCabMinOrderAmt">
                <span slot="label"><label class="required-icon">*</label> 最小订单金额</span>
                <el-input :disabled="true" v-model.trim="HotelDataModify.welfareCabMinOrderAmt" maxlength="10"></el-input> 元
            </el-form-item>
            <el-form-item>
                <el-button @click="resetForm('HotelDataModify')">返回</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
