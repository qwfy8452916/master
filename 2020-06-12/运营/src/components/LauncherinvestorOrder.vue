<template>
    <div>
        ...
        <el-table :data="CabinetList" border stripe style="width:100%;" >
            ...
            <el-table-column prop="totalAmount" label="总投资金额" align=center></el-table-column>
            <el-table-column prop="couponAmount" label="优惠金额" align=center></el-table-column>
            <el-table-column prop="discountAmount" label="折扣金额" align=center></el-table-column>
            <el-table-column prop="actualPayAmount" label="实付金额" align=center></el-table-column>
            <el-table-column prop="payTime" label="投资时间" align=center></el-table-column>
            <el-table-column prop="refoundCount" label="已退款数量" align=center></el-table-column>
            <el-table-column fixed="right" prop="refoundAmount" label="已退款金额" align=center></el-table-column>
        </el-table>
    ...
    methods: {
        ...
        Getdata(){ 
            ...
            let params = {
                ...
                investTimeFrom: this.dateRange == null ? undefined : this.dateRange[0],
                investTimeTo: this.dateRange == null ? undefined : this.dateRange[1],
                pageNo: this.pageNum,
                pageSize: this.pageSize
            }
            this.$api.FsPersonOrder({params}).then(response => {
