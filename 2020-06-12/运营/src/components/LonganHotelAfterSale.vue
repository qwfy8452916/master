<template>
    <div class="LonganHotelAfterSale">
        ...
        <el-table :data="LonganHotelAfterSaleDataList" border stripe style="width:100%;" >
            <el-table-column prop="orderId" label="订单号" width="80px" align=center></el-table-column>
            <el-table-column prop="prodName" label="商品名称"></el-table-column>
            <el-table-column prop="hotelName" label="酒店名称"></el-table-column>
            <el-table-column prop="roomFloor" label="酒店楼层" width="60px" align=center></el-table-column>
            ...
            <el-table-column prop="customerMobile" label="用户手机号" width="120px" align=center></el-table-column>
            <el-table-column prop="requestReason" label="申请售后原因">
            ...
            <el-table-column prop="replAmount" label="上传凭证" align=center>
                <template slot-scope="scope">
                    <a v-for="item in scope.row.csRequestDTOs" :key="item.id" :href="item.url" target="_blank">{{item.url}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="requestRemark" label="备注"></el-table-column>
            <el-table-column prop="lastUpdatedAt" label="提交时间" width="160px" align=center></el-table-column>
        </el-table>
