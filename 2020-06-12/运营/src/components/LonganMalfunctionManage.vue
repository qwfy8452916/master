<template>
    <div class="cabinfom">
        ...
        <div class="statusdesc">
            <div class="desc1"><span class="descbg bg1"></span><label>正常</label></div>
            <div class="desc1"><span class="descbg bg2"></span><label>疑似故障</label></div>
            <div class="desc1"><span class="descbg bg3"></span><label>故障</label></div>
        </div>
        <div class="cabstyle">
