    ...
    <div class="servicetypeadd">
        ...
        <el-form v-model="ServiceTypeDataModify" :model="ServiceTypeDataModify" :rules="rules" ref="ServiceTypeDataModify" label-width="100px" class="servicefrom">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BO_RMSVC_TYPE_EDIT_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('ServiceTypeDataModify')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        serviceTypeDetail(){
            const id = this.stId;
            const params = {};
            this.$api.serviceTypeDetail(params, id)
                .then(response => {
