    ...
    <div class="hoteladd">
        ...
        <el-form :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item label="进场配置名称：" prop="cabinetName">
                <el-input :disabled="true" v-model.trim="Commoditygai.cabinetName"></el-input>
            </el-form-item>
            <el-form-item label="是否支持迷你吧：" prop="supportMinibar">
                <el-radio-group :disabled="true" v-model="Commoditygai.supportMinibar">
            ...
            <el-form-item label="是否支持便利店：" prop="supportShop">
                <el-radio-group :disabled="true" v-model="Commoditygai.supportShop">
                    <el-radio label="不支持" name="supportMinibar"></el-radio>
                    <el-radio label="显示" name="supportMinibar"></el-radio>
                    <el-radio label="显示+下单" name="supportMinibar"></el-radio>
                </el-radio-group>
            ...
            <el-form-item label="是否支持客房服务：" prop="supportService">
                <el-radio-group :disabled="true" v-model="Commoditygai.supportService">
                    <el-radio label="不支持" name="supportMinibar"></el-radio>
                    <el-radio label="显示" name="supportMinibar"></el-radio>
                    <el-radio label="显示+下单" name="supportMinibar"></el-radio>
                </el-radio-group>
            ...
            <el-form-item label-width="200" label="是否支持客房协议价：" prop="supportRoomBook">
                <el-radio-group :disabled="true" v-model="Commoditygai.supportRoomBook">
                    <el-radio label="不支持" name="supportMinibar"></el-radio>
                    <el-radio label="显示+下单" name="supportMinibar"></el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="默认进场：" prop="commonEnterDeviList">
                <el-checkbox-group :disabled="true" v-model="Commoditygai.commonEnterDeviList">
            ...
            <el-form-item label="分享进场：" prop="shareEnterDeviList">
                <el-checkbox-group :disabled="true" v-model="Commoditygai.shareEnterDeviList">
                    <el-checkbox v-for="item in deviData" :key="item.id" :label="item.dictValue">{{item.dictName}}</el-checkbox>
                </el-checkbox-group>
            </el-form-item>
            <el-form-item v-if="isAll != 1" label-width="200" label="支持默认开放功能区：" prop="availableFuncSupport">
                <el-switch :disabled="true" v-model="Commoditygai.availableFuncSupport"></el-switch>
            </el-form-item>
            <el-form-item v-if="!Commoditygai.availableFuncSupport" label="功能区：">
                ...
                :key="item.id"
                 class="oneArea">
                    ...
                    <el-radio-group :disabled="true" v-model="item.defaultValue">
                        <el-radio label="不支持" name="supportMinibar"></el-radio>
                        <el-radio label="显示" name="supportMinibar"></el-radio>
                        <el-radio label="显示+下单" name="supportMinibar"></el-radio>
                    </el-radio-group>
                    <el-form-item v-if="item.defaultValue == '显示+下单'" :prop="'areaList.'+index+'.commonEnterDeviList'" label="默认进场：" :rules="[
                        { required: true, message: '请选择至少一个默认进场配置',trigger:'change'}]">
                        <el-checkbox-group :disabled="true" v-model="item.commonEnterDeviList">
                            <el-checkbox v-for="item in deviData" :key="item.id" :label="item.dictValue">{{item.dictName}}</el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                    <el-form-item v-if="item.defaultValue == '显示+下单'" label="分享进场：" :prop="'areaList.'+index+'.shareEnterDeviList'" :rules="[
                        { required: true, message: '请选择至少一个分享进场配置',trigger:'change'}]">
                        <el-checkbox-group :disabled="true" v-model="item.shareEnterDeviList">
                            <el-checkbox v-for="item in deviData" :key="item.id" :label="item.dictValue">{{item.dictName}}</el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                </div>
            ...
            <el-form-item label="默认首页：" prop="defaultHomePage">
                <el-radio-group :disabled="true" v-model="Commoditygai.defaultHomePage">
    ...
    data(){
        return{
            ...
            rules: {
                ...
                cabinetName: [
                    {required: true, message: '请填写虚拟柜配置名称', trigger: 'blur'},
                    {min: 1, max: 20, message: '虚拟柜名称请保持在20个字符以内', trigger: 'blur'}
                ],
            },
            defaultHomePageList:[
                {
