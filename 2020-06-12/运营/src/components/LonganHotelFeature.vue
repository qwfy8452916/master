<template>
    <div class="hotelfeature">
        ...
        <div v-if="authzData['F:BO_HOTEL_FEATURE_ADD']"><el-button class="addbutton" @click="hotelFeatureAdd">添加客房设施</el-button></div>
        <el-table 
            ...
            <el-table-column fixed="right" label="操作" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_HOTEL_FEATURE_DELETE']" type="text" size="small" @click="deleteHotelFeature(scope.row.id)">移除</el-button>
                    <el-button v-if="authzData['F:BO_HOTEL_FEATURE_DETAIL']" type="text" size="small" @click="detailHotelFeature(scope.row.id)">客房设施明细</el-button>
                </template>
            </el-table-column>
        </el-table>
