        ...
        <el-form :model="HotelADData" :rules="rules" ref="HotelADData" label-width="120px" class="hotelform">
            ...
            <el-form-item v-if="HotelADData.adLevel == 0">
                ...
                <el-radio-group :disabled="true" v-model="HotelADData.adScope" @change="selectADScope">
                    ...
                    <el-button v-if="HotelADData.adScope == 1" :disabled="true" type="text" size="small" @click="selectHotel(1)">选择酒店</el-button><br/>
                    <el-table v-if="HotelADData.adScope == 1" :data="SelectedHotelData" border stripe style="width:100%;" >
                        ...
                        <el-table-column fixed="right" label="操作" min-width="80px" align=center>
                            <template slot-scope="scope">
                                <el-button :disabled="true" type="text" size="small" @click="hotelDelete(scope.row.id)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <el-radio :label="2" class="radioscope">除特定酒店外</el-radio>
                    <el-button v-if="HotelADData.adScope == 2" :disabled="true" type="text" size="small" @click="selectHotel(2)">选择酒店</el-button>
