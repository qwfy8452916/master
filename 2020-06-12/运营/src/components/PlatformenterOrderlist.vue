<template>
    <div class="PlatformenterOrderlist">
        ...
        <el-table
            ...
            <el-table-column fixed prop="invInCode" label="入库单编号"></el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_INV_OPRIN_REVIEWPROGRESS'] && scope.row.reviewStatus==2" type="text" size="small" @click="examineDetail(scope.row.wfId)">审核进度</el-button>
                    <el-button v-if="authzData['F:BO_INV_OPRIN_VIEW']" type="text" size="small" @click="lookDetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
   ...
   created(){
    ...
    methods: {
       ...
       lookDetail(id){
        ...
        this.$router.push({name:'PlatformenterOrderdetail',query:{id,query}})
       },
