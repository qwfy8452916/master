    ...
    <div class="HotelEvaluate">
        ...
        <el-table :data="HotelEvaluateDataList" border stripe style="width:100%;" >
            ...
            <el-table-column label="操作" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_REM_PRODEVALUATEDELETE']" type="text" size="small" @click="HotelEvaluatedel(scope.row.id)">删除</el-button>
                    <el-button v-if="authzData['F:BO_REM_PRODEVALUATEDETAIL']" type="text" size="small" @click="HotelEvaluatedetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
