<template>
    <div class="AllCouponBatchEdit">
         <p class="title">修改优惠券批次</p>
         <el-form label-width="130px" style="width:70%" :model="addCoupondata" ref="addCoupondata" :rules="rules">
          <el-form-item label="组织类型" class="textinput">
              <el-select :disabled="true" v-model="addCoupondata.couponOwnerOrgKind">
            ...
            <el-form-item class="textinput" label="组织名称" prop="couponOwnerOrgName">
                <el-input :disabled="true" v-model="addCoupondata.couponOwnerOrgName" maxlength="30"></el-input>
            </el-form-item>
            ...
            <el-form-item label="领取/发放限制">
               ...
               <el-form-item label="每人领取数量" style="margin-top:20px;" prop="drawCountPerUser">
                   <el-input :disabled="addCoupondata.canDraw!='1'" v-model="addCoupondata.drawCountPerUser" style="width:218px;margin-right:5px"></el-input>张
               </el-form-item>
               ...
               <el-form-item label="发放总数量" style="margin-top:20px;" prop="giveCountTotal">
                   <el-input :disabled="addCoupondata.canGive!='1'" v-model="addCoupondata.giveCountTotal" style="width:218px;margin-right:5px"></el-input>张
               </el-form-item>
               <el-form-item label="每人发放数量" style="margin-top:20px;" prop="giveCountPerUser">
                   <el-input :disabled="addCoupondata.canGive!='1'" v-model="addCoupondata.giveCountPerUser"  style="width:218px;margin-right:5px"></el-input>张
               </el-form-item>
            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BO_COUPON_ALLGROUP_MODSUBMIT']" type="primary" @click="sureBtn('addCoupondata')">确 定</el-button>
            </el-form-item>
         </el-form>
    ...
    data(){
      ...
      return {
         ...
         rules:{
             ...
             couponTermDays:{required:true,message:"请填写领取后天数",trigger:'blur'},
             couponTermDate:{validator: Validdate,message:"请选择优惠券使用的固定日期",trigger:'blur'},
             drawCountTotal:{required:true,message:"请填写领取总数量",trigger:'blur'},
             drawCountPerUser:{required:true,message:"请填写每人领取数量",trigger:'blur'},
             giveCountTotal:{required:true,message:"请填写发放总数量",trigger:'blur'},
             giveCountPerUser:{required:true,message:"请填写每人发放数量",trigger:'blur'},
         },
         pickerOptions0: {
          disabledDate(time) {
            ...
            if(valid){
               this.$api.editCouponBatch(params,that.batchId).then(response=>{
                 if(response.data.code=='0'){
                    ...
                    that.$router.push({name:"LonganAllCouponBatch"})
                 }else{
