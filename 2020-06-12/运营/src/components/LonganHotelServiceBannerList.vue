<template>
    <div class="servicetypelist">
        ...
        <div><el-button class="addbutton" @click="serviceCommonAdd">新增Banner明细</el-button></div>
...
export default {
    ...
    methods: {
        ...
        serviceCommonAdd(){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceBannerAdd', query: {hsId}});
        },
        //修改
        serviceCommonModify(id){
            const hsId = this.hsId;
            this.$router.push({name:'LonganHotelServiceBannerModify', query: {hsId, id}});
        },
        //删除
