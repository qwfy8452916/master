    ...
    <div class="incomeRecord">
        ...
        <el-table :data="incomeRecordDataList" border stripe style="width:100%;" >
            ...
            <el-table-column label="操作" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button v-if="authzData['F:BO_FIN_EMPINCOME_DETAIL']" type="text" size="small" @click="lookdetail(scope.row.id)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        resetFunc(){
         ...
         incomeRecord(){
            ...
            this.$api.incomeRecord({params},1).then(response=>{
