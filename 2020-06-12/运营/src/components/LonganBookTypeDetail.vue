<template>
    <div class="booktypeadd">
        ...
        <el-form :model="BookTypeData" :rules="rules" ref="BookTypeData" label-width="120px" class="bookform">
            <el-form-item>
                <span slot="label"><label class="titlebar">基础信息&nbsp;&nbsp;</label></span>
            </el-form-item>
            <hr class="line">
            <el-form-item label="酒店名称" prop="hotelId">
                <el-select :disabled="true" v-model="BookTypeData.hotelId" placeholder="请选择">
            ...
            <el-form-item label="是否有钟点房" prop="hourRoomFlag">
                <el-radio-group :disabled="true" v-model="BookTypeData.hourRoomFlag">
                    <el-radio :label="0">否</el-radio>
                    <el-radio :label="1">是</el-radio>
                </el-radio-group><br/>
                <span v-if="BookTypeData.hourRoomFlag == 1">钟点房时间&nbsp;
                    <el-time-select
                        :disabled="true"
                        v-model="hourStart"
                        :picker-options="{
                    ...
                    <el-time-select
                        ...
                        placeholder="选择时间"
                        class="timeWidth">
                    </el-time-select>&nbsp;&nbsp;&nbsp;每时段为&nbsp;<el-input :disabled="true" v-model.trim="hourTimeSlot" maxlength="2" class="hourwidth"></el-input>&nbsp;小时
                </span>
            </el-form-item>
            <el-form-item label="加床服务" prop="bedAddFlag">
                ...
                <span v-if="BookTypeData.bedAddFlag == 2" style="margin-left: -15px;">
                    <el-input :disabled="true" v-model.trim="addbedPrice" maxlength="6" placeholder="请输入" class="addbed"></el-input> 元
                </span>
            </el-form-item>
            ...
            <div class="facilityadd">
                ...
                <el-button :disabled="true" type="primary" class="addbtn" size="small" @click="facilityAddLine">添加设施</el-button>
                <el-table
                    ...
                    <el-table-column prop="facilityType">
                        <template slot-scope="scope">
                            <el-form-item class="facilityOrderBy" :prop="'facilityDTOS.'+scope.$index+'.orderBy'" :rules="rules.orderBy">
                                <el-input :disabled="true" placeholder="设施排序" v-model.number="scope.row.orderBy"></el-input>
                            </el-form-item>
                            <el-form-item class="facilityType" :prop="'facilityDTOS.'+scope.$index+'.facilityType'" :rules="rules.facilityType">
                                <el-input class="facilityname" :disabled="true" placeholder="设施名称" v-model="scope.row.facilityType"></el-input>&nbsp;&nbsp;&nbsp;
                                <el-button :disabled="true" type="text" size="small" @click="facilityDeleteLine(scope.$index)">删除</el-button>
                            </el-form-item>
                            <el-form-item :prop="'facilityDTOS.'+scope.$index+'.facilityContent'" :rules="rules.facilityContent">
                                <el-input :disabled="true" type="textarea" :rows="2" placeholder="设施内容" v-model="scope.row.facilityContent"></el-input>
                            </el-form-item>
                        </template>
                    </el-table-column>
                </el-table>
            ...
            <!-- <el-form-item>
                ...
                <el-input type="textarea" :rows="3" :disabled="true" v-model.trim="facilityMedia" maxlength="250" placeholder="请输入媒体科技"></el-input>
                <p class="facilitytitle">浴室设施</p>
                <el-input type="textarea" :rows="3" :disabled="true" v-model.trim="facilityShower" maxlength="250" placeholder="请输入浴室设施"></el-input>
                <p class="facilitytitle">食品/饮品</p>
                <el-input type="textarea" :rows="3" :disabled="true" v-model.trim="facilityFood" maxlength="250" placeholder="请输入食品/饮品"></el-input>
                <p class="facilitytitle">便利设施</p>
                <el-input type="textarea" :rows="3" :disabled="true" v-model.trim="facilityFast" maxlength="250" placeholder="请输入便利设施"></el-input>
                <p class="facilitytitle">其他</p>
                <el-input type="textarea" :rows="3" :disabled="true" v-model.trim="facilityElse" maxlength="250" placeholder="请输入其他"></el-input>
            </el-form-item> -->
            <el-form-item>
...
export default {
    ...
    methods: {
        ...
        bookTypeDetail(){
            const params = {};
            const id = this.btId;
            this.$api.bookTypeDetail(params, id)
                .then(response => {
                    // console.log(response);
                    const result = response.data;
                    if(result.code == '0'){
                        this.BookTypeData = result.data;
                        /*let facilityList = result.data.facilityDTOS;
                        for(let i = 0; i < facilityList.length; i++){
                            if(facilityList[i].facilityType == 1){
                                this.facilityFast = facilityList[i].facilityContent;
                            }else if(facilityList[i].facilityType == 2){
                                this.facilityShower = facilityList[i].facilityContent;
                            }else if(facilityList[i].facilityType == 3){
                                this.facilityFood = facilityList[i].facilityContent;
                            }else if(facilityList[i].facilityType == 4){
                                this.facilityMedia = facilityList[i].facilityContent;
                            }else if(facilityList[i].facilityType == 5){
                                this.facilityElse = facilityList[i].facilityContent;
                            }
                        }*/
                        this.hourStart = result.data.hourRoomStartTime;
                        this.hourEnd = result.data.hourRoomEndTime;
                        this.hourTimeSlot = result.data.hourRoomDuration;
                        this.addbedPrice = result.data.bedAddPrice;
                        this.imgList = [{
                            name: result.data.imageListDTOS.imagePath,
                            url:  result.data.imageListDTOS.url,
                            path: result.data.imageListDTOS.imagePath
                        }];
