    ...
    <div class="functionadd">
        ...
        <el-form :model="HotelFunctionData" :rules="rules" ref="HotelFunctionData" label-width="100px" class="functionform">
            ...
            <el-form-item label="配送方式" prop="delivWays">
                ...
                <el-select :disabled="true" v-model="HotelFunctionData.delivWays" multiple placeholder="请选择" @change="selectDelivType">
            ...
            <el-form-item v-if="isExpress" prop="lgcChooseWays">
                ...
                <el-checkbox-group :disabled="true" v-model="HotelFunctionData.lgcChooseWays" @change="selectLgcWay">
                    <el-checkbox :label="'1'">由商家选择</el-checkbox>
                    <el-checkbox :label="'2'">外部物流</el-checkbox>
                </el-checkbox-group>
                <span v-if="isWlgs" class="lgcstyle">
                    <el-select :disabled="true" v-model="HotelFunctionData.hotelLgcIds" multiple placeholder="请选择外部物流" style="width:92%;">
                        <el-option 
            ...
            <el-form-item v-if="isExpress && HotelFunctionData.isTimeLimitedDeliv">
                ...
                <el-input :disabled="true" v-model.number="HotelFunctionData.delivLimitDuration" maxlength="9"></el-input> 分钟
            </el-form-item>
            <el-form-item v-if="isPickUp" label="自提点" prop="pickUpPointIds">
                <el-select :disabled="true" v-model="HotelFunctionData.pickUpPointIds" multiple placeholder="请选择">
            ...
            <el-form-item label="配送服务费" prop="delivFee">
                <el-input :disabled="true" v-model.trim="HotelFunctionData.delivFee" maxlength="10"></el-input> 元/件
            </el-form-item>
            <el-form-item label="分成协议" prop="allocId">
                <el-select :disabled="true" v-model="HotelFunctionData.allocId" placeholder="请选择">
                    <el-option
            ...
            <el-form-item label="默认开放" prop="isShow">
             ...
             <el-form-item label="页面布局" prop="pageLayout">
                <el-select :disabled="true" v-model="HotelFunctionData.pageLayout" placeholder="请选择">
