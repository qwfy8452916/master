    ...
    <div class="aftersaleapplylist">
        ...
        <el-table :data="aftersaleapplylistDataList" border stripe style="width:100%;" >
            ...
            <el-table-column label="操作" width="120px" align=center fixed="right">
               <template slot-scope="scope">
                    <el-button type="text" v-if="authzData['F:BO_CS_OPRPROD_DEAL'] && scope.row.status==1" size="small" @click="handle(scope.$index, aftersaleapplylistDataList)">处理</el-button>
                    <el-button v-if="authzData['F:BO_CS_OPRPROD_VIEW']" type="text" size="small" @click="lookdetail(scope.$index, aftersaleapplylistDataList)">查看详情</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        resetFunc(){
         ...
         lookdetail(index,row){
            let id=row[index].id
            this.$router.push({name:'platformaftersaledetail',query:{id}})
         },
