    ...
    <div class="PlatformCouponEdit">
         ...
         <el-form label-width="130px" style="width:70%" :model="addCoupondata" ref="addCoupondata" :rules="rules">
            ...
            <el-form-item v-if="addCoupondata.discountWay == 2" label="封顶金额" prop="discountMaxMoney">
                <el-input v-model="addCoupondata.discountMaxMoney" :disabled="true" maxlength="10" placeholder="请输入封顶金额" style="width:349px;margin-right:5px" oninput ="value=value.replace(/[^0-9.]/g,'')"></el-input>元
            </el-form-item>
