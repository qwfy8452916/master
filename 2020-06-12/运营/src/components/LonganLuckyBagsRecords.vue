        ...
        <el-form :inline="true" align=left class="searchform">
            ...
            <el-form-item label="格子商品">
                <el-select 
                    ...
                    placeholder="请选择格子商品">
                    <el-option v-for="item in cabGoodsList" :key="item.id" :label="item.prodName" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
        ...
        <el-table :data="CabinetList" border stripe style="width:100%;" >
            ...
            <el-table-column label="领取时间" align=center>
                <template slot-scope="scope">
                    {{scope.row.drawTime=='1970-01-01 00:00:00'?'-':scope.row.drawTime}}
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        Getdata(){ 
            ...
            this.$api.getLuckyBagList({params}).then(response => {
