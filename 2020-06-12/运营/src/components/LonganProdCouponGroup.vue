<template>
   <div class="ProdCouponGroup">
       ...
       <div class="alignleft"><el-button class="addbutton" v-if="authzData['F:BO_COUPON_OPRGROUP_ADD']" @click="addBtn">新增优惠券分组</el-button></div>
       <el-table :data="groupData" border stripe style="width:100%">
          ...
          <el-table-column prop="id" label="操作" align="center">
              <template slot-scope="scope">
                  <el-button v-if="authzData['F:BO_COUPON_OPRGROUP_MODIFY']" type="text" @click="editGroup(scope.row.id)">修改</el-button>
                  <el-button v-if="authzData['F:BO_COUPON_OPRGROUP_DELETE']" type="text" @click="deleGroup(scope.row.id)">删除</el-button>
              </template>
          </el-table-column>
       </el-table>
