...
export default {
    ...
    methods: {
        ...
        hotelPlatCommodityDetail(){
            const params = {};
            this.$api.hotelPlatCommodityDetail(params, this.hpId)
                .then(response => {
        ...
        hotelProdSpecsAdd(){
            ...
            this.$router.push({name: 'LonganHotelProdSpecsAdd', query: {hotelProdId}});
        },
        //添加全部
        ...
        hotelProdSpecsDetail(id){
            const hotelProdId = this.hpId;
            this.$router.push({name: 'LonganHotelProdSpecsDetail', query: {id, hotelProdId}});
        },
        //修改
        hotelProdSpecsModify(id){
            const hotelProdId = this.hpId;
            this.$router.push({name: 'LonganHotelProdSpecsModify', query: {id, hotelProdId}});
        },
        //移除
