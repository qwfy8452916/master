    ...
    <div class="purchaseadd">
        <el-form :model="commodityFormData" :inline="true" :rules="rules" ref="commodityFormData" align=left>
            ...
            <el-form-item label="酒店名称" prop="hotelId">
                <el-select
                    v-model="commodityFormData.hotelId"
                    filterable
                    remote
        ...
        <el-col :span="24" class="niuwrap">
                ...
                <el-button v-if="authzData['F:BO_PUR_PURORDER_EDIT_SUBMIT']" type="primary" @click="surebtn('commodityFormData')">确定</el-button>
            </el-col>
        </el-row>
...
export default {
      ...
      var validatePhone = (rule,value,callback) => {
        ...
        return{
            ...
            commodityFormData:{
             ...
             rules:{
                    hotelId: {required: true, message: '请选择酒店名称！', trigger: 'blur'},
    ...
    methods: {
        ...
        selectCommodity(index,value){
            ...
            this.$set(this.commodityFormData.purOrderDetailDTOS[index], 'prodSize', commodityInfo.prodProductDTO.prodUnitMeasure);
        },
        ...
        surebtn(commodityFormData){
          ...
          let params={
             ...
             hotelId:that.commodityFormData.hotelId,
