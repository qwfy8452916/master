...
export default {
    ...
    methods: {
        ...
        funcProdSpecsAdd(){
            ...
            this.$router.push({name: 'LonganFunctionSpecsAdd', query: {funcProdId}});
        },
        //添加全部
        funcProdSpecsAllAdd(){
        ...
        funcProdSpecsDetail(id){
            const funcProdId = this.fpId;
            this.$router.push({name: 'LonganFunctionSpecsDetail', query: {id, funcProdId}});
        },
        //修改
        funcProdSpecsModify(id){
            const funcProdId = this.fpId;
            this.$router.push({name: 'LonganFunctionSpecsModify', query: {id, funcProdId}});
        },
        //移除
