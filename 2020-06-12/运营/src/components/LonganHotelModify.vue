    ...
    <div class="hoteladd">
        ...
        <el-form v-model="HotelDataModify" :model="HotelDataModify" :rules="rules" ref="HotelDataModify" label-width="180px" class="hotelform">
            ...
            <!-- <el-form-item label="迷你吧banner图">
                <span slot="label"><label class="required-icon">*</label> 迷你吧banner图</span>
                <el-upload
                    :action="uploadUrl"
                    list-type="picture"
                    :limit="3"
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BO_HOTEL_HOTEL_EDIT_SUBMIT']" type="primary" @click="submitForm('HotelDataModify')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
        ...
        methods: {
            ...
            submitForm(HotelDataModify) {
                ...
                if (this.HotelDataModify.isSupportRedPacket) {
                    if (this.HotelDataModify.redPacketRate == '' || this.HotelDataModify.minOrderAmount == '') {
                        rpRate = '';
                        moAmount = '';
                    } else {
                ...
                if (this.HotelDataModify.isSupportWelfareCab) {
                    if (this.HotelDataModify.welfareCabMinOrderAmt == '') {
                        ...
                        wcAmount = parseFloat(this.HotelDataModify.welfareCabMinOrderAmt).toFixed(2);
                    }
                } else {
                    wcAmount = '';
                }
                ...
                this.$refs[HotelDataModify].validate((valid) => {
                    if (valid) {
                        ...
                        let params = {
                            ...
                            isSupportRedPacket: that.switchFunc(that.HotelDataModify.isSupportRedPacket),
                            ...
                            isSupportWelfareCab: that.switchFunc(that.HotelDataModify.isSupportWelfareCab),
