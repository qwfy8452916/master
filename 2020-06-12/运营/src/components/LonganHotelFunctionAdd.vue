<template>
    <div class="functionadd">
        ...
        <el-form :model="HotelFunctionData" :rules="rules" ref="HotelFunctionData" label-width="120px" class="functionform">
            <el-form-item>
            ...
            <el-form-item label="配送方式" prop="delivWays">
                ...
                <el-select v-model="HotelFunctionData.delivWays" multiple placeholder="请选择" @change="selectDelivType">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BO_HOTEL_FUNCTION_ADD_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('HotelFunctionData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
