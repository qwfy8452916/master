    ...
    <div class="commodityadd">
        ...
        <el-form :model="CommodityDataModify" :rules="rules" ref="CommodityDataModify" label-width="140px" class="commodityform">
            ...
            <el-form-item label="类型" prop="prodKindName">
                <el-input :disabled="true" v-model="CommodityDataModify.prodKindName"></el-input>
            </el-form-item>
            <el-form-item label="供应商" prop="prodSupplName">
                <el-input :disabled="true" v-model="CommodityDataModify.prodSupplName"></el-input>
            </el-form-item>
            ...
            <el-form-item v-if="isPickUp" label="自提点" prop="pickUpPointIds">
                <el-select :disabled="true" v-model="CommodityDataModify.pickUpPointIds" multiple placeholder="请选择">
            ...
            <div class="functionadd">
                ...
                <el-button :disabled="true" type="primary" class="addbtn" size="small" @click="functionAddLine">添加</el-button>
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-form-item :prop="'functionData.'+scope.$index+'.funcId'" :rules="rules.funcId">
                                ...
                                <el-button :disabled="true" type="text" size="small" @click="functionDeleteLine(scope.$index)">删除</el-button>
                            </el-form-item>
        ...
        submitForm(CommodityDataModify){
            ...
            this.$refs[CommodityDataModify].validate((valid) => {
                if (valid) {
                    ...
                    this.isSubmit = true;
                    this.$api.newHotelCommodityModify(params, id)
                        .then(response => {
                            // console.log(response);
                            const result = response.data;
                            if(result.code == '0'){
