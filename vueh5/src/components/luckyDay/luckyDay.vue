    ...
    <div class="m-body">
      <div class="m-lucky-box">
        <template v-if="!stepRadius[4]">
          ...
          <div class="sm-two">
            <template v-for="(item,index) in stepRadius" v-if="index!==4">
                ...
                <tr>
                  <td class="top-left">
                    ...
                    <div class="today-nl">
                      ...
                      <p class="small-hz red-color">{{result.current.n_month}}月{{result.current.n_day}}</p>
                      <div class="owf shuom">
              ...
              <div class="owf" style="margin:0px 15px;">
                <div class="fl other-part">
                  <div>
                    ...
                    <p>{{result.other[0].y}}年{{result.other[0].m}}月{{result.other[0].days}}日</p>
                ...
                <div class="fl other-part owf">
                  <div class="fr">
                    ...
                    <p>{{result.other[1].y}}年{{result.other[1].m}}月{{result.other[1].days}}日</p>
