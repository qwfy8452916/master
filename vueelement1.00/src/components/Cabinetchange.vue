    ...
    <div class="hoteladd">
        ...
        <el-form :inline="true" :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            <el-form-item label="柜子id" prop="cabinetCode">
                <el-input disabled v-model="Commoditygai.cabinetCode"></el-input>
            </el-form-item>
            <el-form-item label="物联卡" prop="cabinetIot">
                <el-input disabled v-model="Commoditygai.cabinetIot"></el-input>
            </el-form-item>
            <el-form-item label="二维码id" prop="cabinetQrcode">
                <el-input disabled v-model="Commoditygai.cabinetQrcode"></el-input>
            </el-form-item>
            <el-form-item label="酒店名称" prop="hotelName">
                <el-input v-model="Commoditygai.hotelName"></el-input>
            </el-form-item>
            <el-form-item label="酒店楼层" prop="roomFloor">
                <el-input v-model.number="Commoditygai.roomFloor"></el-input>
            </el-form-item>
            <el-form-item label="房间号" prop="roomCode">
                <el-input v-model="Commoditygai.roomCode"></el-input>
            </el-form-item>
    ...
    methods: {
        ...
        submitForm(Commoditygai) {
            ...
            let params = {
                ...
                hotelName:that.Commoditygai.hotelName,
