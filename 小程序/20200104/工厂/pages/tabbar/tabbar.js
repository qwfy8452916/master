...
Page({
  ...
  data: {
    ...
    tabbardata: [
      ...
      { icon: "iconanzhuang", name: "测试", url: "/pages/test/test?tabindex=" + 0, authz: 'M:MH_CAB_INSTALL' },
      { icon: "iconpeisong", name: "我的", url: "/pages/personalcenter/personalcenter?tabindex=" + 1, authz: 'M:MH_USER_MY_RESTOCK' },
    ],
