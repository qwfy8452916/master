              ...
              if (resdata.data.code == 0) {
                if (resdata.data.data != null){
                  ...
                  if (resdata.data.data.loginType == 3) {
                    ...
                    wx.setStorageSync("userid", resdata.data.data.hotelDTO.adminEmpId)
                    wx.setStorageSync("Token", token)
                    wx.setStorageSync("hotelid", resdata.data.data.hotelDTO.id)
                    wx.setStorageSync("organizationid", resdata.data.data.hotelDTO.encryptedOrgId)
