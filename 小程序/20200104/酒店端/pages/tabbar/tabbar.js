...
Page({
  ...
  data: {
    ...
    tabbardata:[
      ...
      { icon: "iconanzhuang", name: "安装", url: "/pages/cabinetlist/cabinetlist?tabindex=" + 0, authz: 'M:MH_CAB_INSTALL', id: 0},
      { icon: "iconbuhuo", name: "补货", url: "/pages/housematterlist/housematterlist?tabindex=" + 1, authz: 'M:MH_REPL_RESTOCK', id: 1},
      { icon: "iconbuhuo1", name: "配送", url: "/pages/deliveredlist/deliveredlist?tabindex=" + 2, authz: 'M:MH_DELIV_DELIVERY',id: 2},
      { icon: "iconpeisong", name: "我的", url: "/pages/personalcenter/personalcenter?tabindex=" + 3, authz: 'M:MH_USER_MY_RESTOCK', id: 3},
    ],
    currentid:'',  //当前id
  },
