+function ($) {
    $('.fujixz').children().children('.xiugai').show();
    $('.fujixz').children().children('.xiugai').children('span').hide();
    
    var jiequphone=$.trim($('.rightjvli').text());
    if(jiequphone!=""){
      $('.rightjvli').html(jiequphone.substring(0,3)+"****"+jiequphone.substring(7,11))  
    }
    ...
    $('.rightbianji .xiugai span').click(function (event) {
        ...
        switch (panduanzhi) {
            case 'namegai':
            $('.middlebianji .nameinput').show();
            $('.nicheng .leftbianji').hide();
            break;
            case 'sexgai':
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg(data.info, {time: 1300}, function () {
                            ...
                            $('.nicheng .leftbianji').show();
                            $('.middlebianji .nameinput').val(nick_name);
   ...
   var sexxingbieval=$.trim($('.sexxb .xingbie').text());
   if(sexxingbieval!=""){
     $('.sexxb .modifytext').text("修改");
   }else{
     $('.sexxb .modifytext').text("填写");
   }  
    ...
    $('.xinxquyu .touxiang').mouseenter(function(){
        $('.xinxquyu .touxiang .toux_tishi').css("display","inline-block");
    })
    $('.xinxquyu .touxiang').mouseleave(function(){
        $('.xinxquyu .touxiang .toux_tishi').hide();
    })
    ...
    $('.xinxquyu .fujixz').mouseenter(function () {
        if ($(this).children().children('.xiugai').children('span').css('display') == 'none' && $(this).children().children('.bianjicunqu').hasClass('yincang')) {
            $(this).children().children('.xiugai').show();
...
+function ($) {
    ...
    $('.touxiangkz .closequx').click(function (event) {
        $('.clipyinying').hide();
        $('.touxiangkz').hide();
    });
  ...
  $('.guidetanc .phonewk input').on("keyup",function(){
    var phoneshouji=$.trim($('.guidetanc .phonewk input').val());
    if(phoneshouji!=''){
    ...
    $('.yanzengmwk .btnyzm').click(function (event) {
        ...
        if (shoujival == '') {
            ...
            $('.phonewk input').focus();
            $('.guidetanc .tjtishi').html("输入正确的手机号码").show();
            return false;
    ...
    $('.passwordmm .chongse').click(function (event) {
     ...
     function zhixing(){
          var shoujihao = $.trim($('.guidetanc .phonewk input').val()),
              yanzhengma = $.trim($('.guidetanc .yanzengmwk .inputtext').val())
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1){
                         ...
                         $('.guidetanc').hide();
                         $('.guidetanc2').show();
                         $('.guidetanc .yanzengmwk .btnyzm').val("获取验证码");
                         $('.guidetanc .yanzengmwk .btnyzm').attr("disabled",true);
                         countdown = 0;
    ...
    $('.guidetanc .guanbi').click(function (event) {
     ...
     function zhixing2(){
            ...
            var newmima=$.trim($('.guidetanc2 .newpassword input').val()),
                suremima=$.trim($('.guidetanc2 .surepassword input').val());
                if(newmima!="" && suremima!=""){
            ...
            if (!reg.test(newpass)) {
                $('.newpassword input').focus();
                $('.tjtishi02').html('密码必须为6-20位字母、数字或符号').show();
                return;
            }
    ...
    $(".guidetanc2").on("keypress",zhixing2);
