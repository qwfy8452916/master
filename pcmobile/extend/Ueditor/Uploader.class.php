...
class Uploader
{
    ...
    private function uploadQiNiu($file)
    {
        ...
        if (!empty($ext)) {
            $data["upfile"]['url'] = urldecode($data["upfile"]['url']) . '-' . $ext;
        } else {
            $data["upfile"]['url'] = urldecode($data["upfile"]['url']);
        }
        if ($data !== false) {
            $this->fullName = $data["upfile"]["url"];
            $this->stateInfo = $this->stateMap[0];
        } else {
            $this->stateInfo = $this->getStateInfo("ERROR_DIR_NOT_WRITEABLE");
        }
        ...
        //     $this->fullName = "http://".$imgDomain."/".$result["key"];
        //     $this->stateInfo = $this->stateMap[0];
        // }else{
        //     $this->stateInfo = $this->getStateInfo("ERROR_DIR_NOT_WRITEABLE");
        // }
