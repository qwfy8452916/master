...
var data = {
  "videoList": [
    {
      "image": "../../img/sheji1.png",
      "tupian": "../../img/case1.png",
    },
    {
      "image": "../../img/sheji2.png",
      "tupian": "../../img/case2.png",
    },
    {
       "image": "../../img/sheji3.png",
       "tupian": "../../img/case3.png",
    },
    {
        "image": "../../img/sheji4.png",
        "tupian": "../../img/case4.png",
    },
    {
       "image": "../../img/sheji5.png",
       "tupian": "../../img/case5.png",
    }
  ],
...
Page({
  ...
  formSubmit2: function (e) {
    ...
    wx.request({
      url: apiUrl + '/zxjt/submit_order/?src=zxjtxcx-sj',
      data: {
        name: name,
        tel: tel,
        area: city,
    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        if (res.data.length < 0) {
          ...
          wx.request({
            url: cityUrl,// apiUrl+'common/js/rlpca20170721143503.js',
            header: {
      ...
      fail: function () {
        // ajax请求数据并且数据本地缓存存储
        wx.request({
          url: imgUrl+'common/js/rlpca20170721143503.js',
          header: {
            'content-type': 'application/json'
          },
          success: function (res) {
