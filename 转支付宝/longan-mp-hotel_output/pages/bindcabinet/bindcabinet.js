...
Page({
  ...
  onLoad: function (options) {
    this.getWifiData();
    console.log(options);
    let hotelId = wx2my.getStorageSync("hotelid"); // this.setData({
  ...
  yanzhengcode: function () {
    ...
    wx2my.request({
      ...
      success: function (res) {
        ...
        if (res.data.code == 0) {
          if (res.data.data == 1) {} else if (res.data.data == 0) {} else if (res.data.data == 2) {
