...
Page({
  ...
  getfloor: function (hotelId) {
    let that = this;
    wx2my.request({
      url: apiUrl + '/repl/cab/hotel/floor?hotelId='+hotelId,
      // data: {
      //   hotelId: hotelId
      // },
      header: {
  ...
  onShow: function () {
    let that = this;
    let nowfloor = wx2my.getStorageSync("selectFloor") || 0;
  ...
  flooritem: function (e) {
    ...
    wx2my.setStorageSync("selectFloor", newfloor);
    wx2my.request({
      url: apiUrl + '/repl/floor/room/detail?roomFloor='+ encodeURIComponent(that.data.floorlc)+'&hotelId='+wx2my.getStorageSync("hotelid"),
      // data: {
  ...
  getfloorcount: function (e) {
    let that = this;
    wx2my.request({
      url: apiUrl + '/repl/cab/floor/code?roomFloors='+encodeURIComponent(that.data.floorlc)+'&hotelId='+wx2my.getStorageSync("hotelid"),
      // data: {
