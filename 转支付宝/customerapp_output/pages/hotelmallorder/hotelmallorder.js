...
Page({
  ...
  getxcdata: function (total3, province) {
    //现场配送商品
    const that = this;
    let total1 = 0.00;
    let totalnum1 = 0;
  ...
  getkddata: function (total3, total1, province) {
    //快递商品
    const that = this;
    let total2 = 0.00;
    let totalnum2 = 0;
  ...
  getproduct: function (list, provinceCode, total_price) {
    //快递商品分类
    const that = this;
    let postData = {
  ...
  confirm: function (e) {
    ...
    let id = wx2my.getStorageSync("id");
  ...
  settlementfun: function () {
    ...
    let linkData = {
      ...
      //房间楼层
      contactName: usernamekf,
      //联系人姓名
      contactPhone: userphone,
      //联系人手机号码
      roomDeliveryRemark: thatdata.remark1,
      //客房配送留言
  ...
  orderpayfun: function (id, code, delayPayFlag) {
    //支付请求
    const that = this;
    let orderid = id;
    let ordercode = code;
