...
Page({
  ...
  invHeadfun: function (e) {
    //单位名称
    this.setData({
      invHead: e.detail.value
    });
  },
  taxpayerIdfun: function (e) {
    //纳税人识别码
    this.setData({
  ...
  registrationAddrfun: function (e) {
    //注册地址
    this.setData({
      registrationAddr: e.detail.value
    });
  },
  registrationMobilefun: function (e) {
    //注册电话
    this.setData({
  ...
  bankAccountfun: function (e) {
    //银行账户
    this.setData({
      bankAccount: e.detail.value
    });
  },
  addresseeNamefun: function (e) {
    //收票人姓名
    this.setData({
      addresseeName: e.detail.value
    });
  },
  addresseeAddrfun: function (e) {
    //收票人地址
    this.setData({
  ...
  subformfun: function () {
    ...
    let linkData = {
      ...
      invType: invType,
      //开票类型
      finInvoiceApplProdDTOs: finInvoiceApplProdDTOs,
      //商品信息
      mobile: mobile,
      //用户手机号码
      remark: remark,
      //用户备注
      invHeadType: invHeadType,
      //抬头类型（1：企业，2：个人）
      invHead: invHead,
      //单位名称
