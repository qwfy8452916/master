...
<link rel="stylesheet" href="<?php echo ($static_host); ?>/assets/mobile/common/fonts/font-awesome.min.css?v=<?php echo C('STATIC_VERSION');?>" />
    ...
    <link href="/assets/mobile/card/css/couponin.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css"/>
...
<div class="new-kefu" id="new-kefu">
   ...
   <article>
        <div class="contentone">
            <?php if($info['active_type'] == 2): ?><div class="youhuiqwk youhuiqwk2">
            <?php else: ?>
                <div class="youhuiqwk"><?php endif; ?>
                <div class="youhqneir">
                    <div class="youhqneir-title"><?php echo ($info["jc"]); ?></div>
                    <div class="quanzhiwk">
                        <?php if($info['active_type'] == 2): ?><div class="pricewk"><?php echo ($info["gift"]); ?></div>
                        <?php else: ?>
                            <div class="pricewk"><span class="pricewk-danwei">￥</span><?php echo ($info["money2"]); ?></div><?php endif; ?>
                        <div class="pricems">
                            <div><?php echo ($info["name"]); ?></div>
                        </div>
                    </div>
                    <div class="youohuiqtime">使用时间：<span><?php echo (date("Y.m.d",$info["start"])); ?></span>~<span><?php echo (date("Y.m.d",$info["end"])); ?></span></div>
                </div>
            </div>
            <div class="anniuwk"><a href="/<?php echo ($info["bm"]); ?>/company_home/<?php echo ($info["com_id"]); ?>" class="jinniu">进店看看</a></div>
        </div>
       <?php if($info['rule'] != ''): ?><div class="contenttwo">
               <div class="contenttwo-title">使用须知</div>
               <pre class="usemiaos"><?php echo ($info["rule"]); ?></pre>
           </div><?php endif; ?>
   </article>
