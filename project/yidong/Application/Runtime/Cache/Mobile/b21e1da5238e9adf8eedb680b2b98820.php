...
<link rel="stylesheet" href="<?php echo ($static_host); ?>/assets/mobile/common/fonts/font-awesome.min.css?v=<?php echo C('STATIC_VERSION');?>" />
    ...
    <link href="/assets/mobile/common/js/swiper/swiper.min.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css"/>
    <link href="/assets/mobile/card/css/coupoinfenpei.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css"/>
...
<div class="new-kefu" id="new-kefu">
   ...
   <article>
       ...
       <div class="contentwk">
           <div class="phonewk">
               ...
               <span class="yuanquan rightbottom"></span>
                <div class="qiehuanphone">欢迎您,<?php echo ($tel); ?><a href="/cardlogin">【切换号码】</a></div>
                <?php if($countlist == 1): ?><ul>
                    <li class="orderwk" data-id="<?php echo ($vo["id"]); ?>">
                        <div class="orderhagn solidbot"><span>您的订单编号：</span><?php echo ($list["0"]["id"]); ?></div>
                        <div class="orderhagn topjvli"><span>装修地址：</span><?php echo ($list["0"]["dz"]); ?></div>
                        <div class="orderhagn"><span>订单时间：</span><?php echo (date("Y-m-d H:i:s",$list["0"]["time_real"])); ?></div>
                    </li>
                  </ul>
                <?php else: ?>
                    <div class="swiper-container swiper-container-horizontal" id="orderlist">
                        <ul class="swiper-wrapper">
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="swiper-slide orderwk" data-id="<?php echo ($vo["id"]); ?>">
                                    <div class="orderhagn solidbot"><span>您的订单编号：</span><?php echo ($vo["id"]); ?></div>
                                    <div class="orderhagn topjvli"><span>装修地址：</span><?php echo ($vo["dz"]); ?></div>
                                    <div class="orderhagn"><span>订单时间：</span><?php echo (date("Y-m-d H:i:s",$vo["time_real"])); ?></div>
                                    <i class="prevniu fa fa-angle-left"></i>
                                    <i class="nextniu fa fa-angle-right"></i>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div><?php endif; ?>
                <div class="takezige">您有装修优惠可领哦</div>
           </div>
           ...
           <!--  记录公司id，订单id，优惠券id   点击时获取-->
           <input id="comid_text" type="hidden" />
           <input id="orderid_text" type="hidden" />
           <input id="cardid_text" type="hidden" />
       ...
       <!-- 确认量房 -->
       <div class="surelfwk">
           <div class="surelfwk-title">请确认该装修公司已为您完成量房</div>
           <div class="sureniuwk">
               <span class="surequeren">确认</span>
               <span class="consolider">暂未量房</span>
           </div>
       </div>
       <!-- 未确认量房点击立即领取弹窗 -->
       <div class="nolfwk">
       ...
       <!-- 点击已领完弹窗 -->
        ...
        <!-- 领取成功弹窗 -->
        <div class="takesuccesswk">
            <div class="taketopwk">
                <div class="taketopwk-gx">恭喜您<span class="ceshi"></span></div>
                <div class="taketopwk-lingqu">领取成功!</div>
                <div class="taketopwk-look">请至卡券包查看</div>
            </div>
            <a href="/card/cardbag.html" class="gokaquanbao">去我的卡券包</a>
            <div class="takesuccesswk-close">X</div>
        </div>
   </article>
...
<script type="text/javascript" src="/assets/mobile/common/js/disclaimer.js?v=<?php echo C('STATIC_VERSION');?>"></script>
    ...
    <script src="/assets/mobile/common/js/swiper/swiper.min.js?v=<?php echo C('STATIC_VERSION');?>"></script>
    <script src="/assets/mobile/card/js/coupoinfenpei.js?v=<?php echo C('STATIC_VERSION');?>"></script>
