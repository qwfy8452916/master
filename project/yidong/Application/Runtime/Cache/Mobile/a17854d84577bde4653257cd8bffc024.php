...
<link href="/assets/mobile/companyhome/css/m-assess.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
...
<div class="change">
    ...
    <div class="grade_xing">
        <div class="grade_right">
            <p>设计水平:
                <?php $__FOR_START_19277__=1;$__FOR_END_19277__=6;for($i=$__FOR_START_19277__;$i < $__FOR_END_19277__;$i+=1){ if(($i - 1) <= ($info['user']['avgsj'] / 2)): ?><i class="fa fa-star"></i>
                    <?php else: ?>
                        <i class="fa fa-star star-empty"></i><?php endif; } ?>
            </p>
            <p>服务态度:
                <?php $__FOR_START_13826__=1;$__FOR_END_13826__=6;for($i=$__FOR_START_13826__;$i < $__FOR_END_13826__;$i+=1){ if(($i - 1) <= ($info['user']['avgfw'] / 2)): ?><i class="fa fa-star"></i>
                    <?php else: ?>
                        <i class="fa fa-star star-empty"></i><?php endif; } ?>
            </p>
            <p>施工水平:
                <?php $__FOR_START_19219__=1;$__FOR_END_19219__=6;for($i=$__FOR_START_19219__;$i < $__FOR_END_19219__;$i+=1){ if(($i - 1) <= ($info['user']['avgsg'] / 2)): ?><i class="fa fa-star"></i>
                    <?php else: ?>
                        <i class="fa fa-star star-empty"></i><?php endif; } ?>
            </p>
        </div>
    ...
    <div class="btn_left">
        <a rel="nofollow" href="/sheji/">免费帮我做设计</a>
   </div>
   <div class="btn_right">
        <a rel="nofollow" href="/baojia/">免费帮我出报价</a>
    </div>
</div>

        <?php if(!empty($info["comments"])): if(is_array($info["comments"])): $i = 0; $__LIST__ = $info["comments"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="comment_box clearfix">
                <div class="comment_head clearfix">
                    <span class="c_head"><img src="<?php echo ($vo["logo"]); ?>" alt="<?php echo ($vo["name"]); ?>"></span>
                    <span class="c_name"><?php echo ($vo["name"]); ?><br> <em>综合评分:<?php echo ($vo["totalCount"]); ?>分</em></span>
                    <span class="c_time"> <?php echo (timeFormat($vo["time"])); ?></span>
                </div>
                <div class="c_content">
                    <?php echo ((isset($vo["text"]) && ($vo["text"] !== ""))?($vo["text"]):"评论内容被外星人抓走啦~~"); ?>
                </div>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <?php echo ($info["page"]); ?>
        <?php else: ?>
            <img class="ch-blank" src="/assets/mobile/common/img/blank.png" alt="暂无相关数据">
            <p class="ch-blank-text">该公司还没有业主评论哦~</p><?php endif; ?>
    </article>
