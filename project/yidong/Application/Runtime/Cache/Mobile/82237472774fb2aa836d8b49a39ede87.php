...
<link rel="stylesheet" href="<?php echo ($static_host); ?>/assets/mobile/common/fonts/font-awesome.min.css?v=<?php echo C('STATIC_VERSION');?>" />
    ...
    <link rel="canonical" href="http://www.<?php echo C('QZ_YUMING');?>/video/v<?php echo ($info["info"]["id"]); ?>.html"/>
    <link href="<?php echo ($static_host); ?>/assets/mobile/video/css/gl-base.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo ($static_host); ?>/assets/mobile/video/css/gl-video-tagend.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
...
<article>
    <div class="zt-box">
        <div class="qzvedio" style="width:100%;">
            <iframe src="<?php echo ($info["info"]["mobile_url"]); ?>" frameborder=0 allowfullscreen style="width: 100%;"></iframe>
        </div>
        ...
        <div class="zt-jie">
            <p>
                ...
                <span class="assist like-btn" data-id="<?php echo ($info["info"]["id"]); ?>">
                    <i class="fa fa-thumbs-up"></i>
                    <span><?php echo ($info["info"]["likes"]); ?></span>
                </span>
            </p>
        ...
        <?php if(is_array($info["recommend"])): $i = 0; $__LIST__ = $info["recommend"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="fg-list-box">
                <div class="fg-list clearfix">
                    <a href="/video/v<?php echo ($vo["id"]); ?>.html">
                        ...
                        <div class="zt-sent fg-send">
                            <p class="h2"><?php echo ($vo["title"]); ?></p>
                            <p>本期讲师: <?php echo ($vo["author"]); ?></p>
                            <em>第<?php echo (date("Y-m-d",$vo["time"])); ?>期</em>
                            <i class="fg-yj fa fa-eye"> <?php echo ($vo["pv"]); ?></i>
...
<script language="javascript">
    $(function(){
        ...
        $('.like-btn').click(function(){
                ...
                $(this).find('span').text(<?php echo ($info["info"]["likes"]); ?>+1);
