...
<link href="/assets/mobile/companyhome/css/m-case.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
...
<div class="change">
    <ul class="change_title">
        ...
        <?php if(!empty($info["cases"])): if(is_array($info["cases"])): $i = 0; $__LIST__ = $info["cases"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="change_img">
        ...
        <?php else: ?>
            ...
            <p class="ch-blank-text">该公司还没有上传案例哦~</p><?php endif; ?>
    </article>
