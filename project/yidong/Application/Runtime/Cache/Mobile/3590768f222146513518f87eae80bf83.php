...
<link rel="stylesheet" type="text/css" href="/assets/mobile/common/css/404.css?v=<?php echo C('STATIC_VERSION');?>">
...
<img class="logo404" src="/assets/mobile/images/m-logo404.png" alt="" rel="nofollow">
<div class="nav">
    <a rel="nofollow" href="<?php echo OP('53kf_ty');?>">联系我们</a>
    <a class="" href="/">返回首页</a>
</div>
</div>
</div>
