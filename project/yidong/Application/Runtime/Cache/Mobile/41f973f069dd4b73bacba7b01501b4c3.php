...
<link rel="stylesheet" href="<?php echo ($static_host); ?>/assets/mobile/common/fonts/font-awesome.min.css?v=<?php echo C('STATIC_VERSION');?>" />
    ...
    <link href="/assets/mobile/card/css/apply.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css"/>
       ...
       <div class="contentwk">
           <div class="phonewk">
               ...
               <span class="yuanquan rightbottom"></span>
                ...
                <div class="qiehuanphone dizhi"><span id="showcity"><i class="fa fa-map-marker">
                </i><?php echo ($mapUseInfo["provincefull"]); ?> <?php echo ($mapUseInfo["name"]); ?> <?php echo ($cityinfo["cityarea"]["name"]); ?></span>
                ...
                <input type="hidden" name="area" data-id="<?php echo ($info["cityarea"]["id"]); ?>"><a id="qiehuanweiz">【切换位置】</a></div>
                <div class="inputwk">
                    <a href="/baojia/" class="lijitake">免费申请</a>
                </div>
                <div class="takezige">立即发布装修需求,抢大额装修优惠!</div>
           </div>
...
<script type="text/javascript" src="/assets/mobile/common/js/disclaimer.js?v=<?php echo C('STATIC_VERSION');?>"></script>
    ...
    <script type="text/javascript" src="/assets/mobile/card/js/qzCitySelect.js?v=<?php echo C('STATIC_VERSION');?>"></script>
