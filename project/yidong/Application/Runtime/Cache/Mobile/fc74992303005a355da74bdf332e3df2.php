...
<link href="<?php echo ($static_host); ?>/assets/mobile/zb/css/r-hxsj.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="m-header-tit">商家入驻</div>
...
<article id="article-height">
    <div class="m-box">
        ...
        <p>专业客服正马不停蹄赶来您的身边，并会在第一时间与您联系，请您注意接听哦，如有疑问请致电4008659600</p>
    </div>
</article>
