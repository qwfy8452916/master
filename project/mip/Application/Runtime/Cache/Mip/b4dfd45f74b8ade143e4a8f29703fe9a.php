...
<html mip>
    ...
    <link rel="canonical" href="http://m.qizuaung.com<?php echo ($canonical); ?>"/>
   ...
   <div class="m-header-tit">
        <div class="m-header-city"><a href="<?php echo ($global_basehost); ?>/city/"><?php echo ($cityInfo["name"]); ?><i class="fa fa-sort-desc"></i></a></div>
   </div>
    ...
    <?php if($zixun != 'empty'): ?><div class="white_bg">
        <div class="home-sec">
                <div class="home-sec-title">
                    <h2 class="pull-left">本地资讯</h2>
                    <a data-type="mip" href="<?php echo ($global_basehost); ?>/<?php echo ($bm); ?>/zxinfo/bendi/" class="more pull-right">更多&gt;</a>
                </div>
                <div class="bd_list">
                    <?php if(is_array($info["zixun"])): $i = 0; $__LIST__ = $info["zixun"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$oo): $mod = ($i % 2 );++$i;?><div class="fg-list-box">
                            <div class="fg-list clearfix">
                                <a data-type="mip" href="http://<?php echo C('MIP_DONAMES');?>/<?php echo ($bm); ?>/zxinfo/<?php echo ($oo["id"]); ?>.html">
                                    <div class="fg-img">
                                        <mip-img src="<?php echo ($oo["face"]); ?>"></mip-img>
                                    </div>
                                    <div class="fg-send">
