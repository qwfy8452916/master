...
class SPage{
    ...
    public function show($extra = '') {
        ...
        if($up_row > 0){
            ...
            $up_page = '<a class="first disabled" href="'.$this->url($up_row).'" '.$extra.'>' . $this->config['prev'] . '</a>';
        }
        ...
        if($down_row <= $this->totalPages){
            ...
            $down_page = '<a class="disabled" href="' . $this->url($down_row) . '" '.$extra.'>' . $this->config['next'] . '</a>';
        }
