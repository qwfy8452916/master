    ...
    methods = {
        init: function(options) {
            ...
            var $queuelist = $('<div id="fileList" class="queuelist" class="uploader-list"></div>').appendTo($wrap),
                $queue = $('<ul class="filelist gallery"></ul>')
                .appendTo($queuelist),
                //添加按钮
                ...
                */
                //重置按钮
                //$retBtn = $('<button class="btn btn-info resetBtn">重置</button>').appendTo($buttons),
                //上传信息
            ...
            function addFile(file) {
                ...
                var $statusBar = $('<div class="statusBar"></div>').appendTo($li.find(".file-content"));
                        ...
                        if (isSupportBase64) {
                            ...
                            li.click(function(event) {
                                ...
                                if(typeof options.callback == "function"){
                                   var res = {};
                                   res["status"] = 99;
                                   options.callback(res,file,uploader);
                                }
                            });
                        } else {
                            $.ajax(previewPath, {
           ...
           function addMyFiles(){
                ...
                function addMyFile($file){
                    ...
                    $btns = $('<i title="删除" class="icon-remove"></i>').appendTo($li.find(".imgWrap"));
                    ...
                    var img = $('<a href="javascript:void(0)" data-href="'+src+'"><img src="'+src+ '"></a>');
                ...
                var zoom = $('#zoom').hide(),
                    ...
                    zoomedIn = false,
                    openedImage = null,
                    windowWidth = $('#zoom').width()-80,
                    windowHeight = $('#zoom').height();
                ...
                function open(event) {
                    ...
                    function render() {
                        ...
                        image.load(render).addClass('thunm-img');
                    }
                }

                function openPrevious() {
                    var prev = openedImage.parent().parent().parent('li').prev();
                    if (!prev.html()){
                ...
                function openNext() {
                    var next = openedImage.parent().parent().parent('li').next();
                    if (!next.html()){
