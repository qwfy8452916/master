    ...
    methods = {
        init: function(options) {
            ...
            function addFile(file) {
                 ...
                 $('.upload-buttons .uploadBtn').css("background","#00b7ee");
                 $('.upload-buttons .uploadBtn').css("color","#fff");
                 $('.upload-buttons .resetBtn').css("background","#FF5500");
                 $('.upload-buttons .resetBtn').css("color","#fff");

                $('.upload-buttons .uploadBtn').hover(function(){
                    $(this).css("background","#00B7EE");
                })
                $('.upload-buttons .resetBtn').hover(function(){
           ...
           function addMyFiles(){
            ...
            uploader.onUploadSuccess = function(file, res) {
                ...
                if(typeof options.callback == "function"){
                 ...
                 $('.upload-buttons .uploadBtn').css("background","#C5C5C5");
                 $('.upload-buttons .uploadBtn').css("color","#fff");
                 $('.upload-buttons .resetBtn').css("background","#C5C5C5");
                 $('.upload-buttons .resetBtn').css("color","#fff");
            }
