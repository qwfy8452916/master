function fullAvatarEditor() {
	...
	var file			= '/assets/cpa/js/plugin/touxiangjs/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/assets/cpa/js/plugin/touxiangjs/expressInstall.swf';			//expressInstall.swf的路径
