...
function sys_windows()
{
	...
	$sysinfo[0]['Caption']=iconv('GB18030', 'UTF-8',$sysinfo[0]['Caption']);

	$sysinfo[0]['CSDVersion']=iconv('GB18030', 'UTF-8',$sysinfo[0]['CSDVersion']);
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td width="60%">
              <input type="text" name="ipOrder" size="50" placeholder="" value="HTTP_CF_CONNECTING_IP,HTTP_X_REAL_IP,HTTP_X_FORWARDED_FOR,HTTP_CLIENT_IP,REMOTE_ADDR"
              style="width: 540px;" />
            </td>
            <td width="25%">
