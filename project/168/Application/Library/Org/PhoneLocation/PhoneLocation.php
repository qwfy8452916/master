...
class PhoneLocation
{
    protected static $spList = ['移动', '联通', '电信', '电信虚拟运营商', '联通虚拟运营商', '移动虚拟运营商'];
    ...
    {
        if ($datafile==''){
            $datafile = __DIR__.DIRECTORY_SEPARATOR.'phone.dat';
        }
        $this->_fileHandle = fopen($datafile, 'r');
        $this->_fileSize = filesize($datafile);
    }
