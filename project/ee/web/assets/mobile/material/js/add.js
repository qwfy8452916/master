    ...
    function saveMaterialAction() {
        ...
        ajaxAction({
            ...
            data : {
                ...
                materialSize : $materialSizeInput.val(),
                materialsinglePrice : $materialsinglePriceInput.val(),
                materialtotalPrice : $materialtotalPriceInput.val(),
                materialShopTime : $materialShopTime.val(),
                materialSendTime : $materialSendTime.val()
            },
            successCallback: function () {
                if(res.status == 1){
                    ...
                    $.closePopup();
                    $(".materials-container").find("input").val("");
                }
            }
        })
