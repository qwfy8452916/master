function fullAvatarEditor() {
	...
	var file			= '/assets/pc/js/Plugin/touxiangjs2/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/assets/pc/js/Plugin/touxiangjs2/expressInstall.swf';			//expressInstall.swf的路径
