   ...
   $(function(){
    ...
    var create_time_start = $("input[name='kaigong_start_time']").val();
    var create_time_end = $("input[name='kaigong_end_time']").val();
    if(create_time_start && create_time_end){
        $(".shigongdateriqi").val(create_time_start+" ~ "+create_time_end);
    }

       console.log( $(".dateriqi").val());
