...
class Fiftercontact
{
     ...
     */
    public function filter_specialChar($str){
        $reg = '/[\`~!@#$%^&*\(\)_+<>?:"{},.\/;\[\]\-]/';
        $str = preg_replace($reg,"",$str);
        return $str;
    }
