...
<head>
    ...
    <meta name="mobile-agent" content="format=html5;url=http://<?php echo C('MOBILE_DONAMES');?>/" />
    <title>齐装网-专业的装饰装修公司门户网站</title>
    <meta name="keywords" content="装修网，装修公司，装饰公司，装修报价" />
    <meta name="description" content="齐装网专业的家居装饰装修门户网站，汇集全国具有性价比的装饰公司，为您和业内提供装修设计、装修公司、装修流程、装修知识等内容，让您的装修更安心！" />
    <link rel="canonical" href="http://<?php echo C('QZ_YUMINGWWW');?>/"/>
...
<script type="text/javascript">
    ...
    <div class="play">
        ...
        <div class="wrap">
            <div class="order-box validate">
                ...
                <div class="box-line">
                    <input class="edit-text" type="text" name="tel" placeholder="输入手机号获取免费设计与报价" maxlength="11" id="tel">
    ...
    <a href="http://www.qizuang.com/about/disclamer" target="_blank" class="pull-left"><span>《免责申明》</span></a>
                ...
                <div class="order-box-tip">
                    ...
                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/zxbj/?source=18013029" rel="nofollow" target="_blank">智能报价</a>
                </div>
            </div>
        </div>
    </div>
    <div class="zx-step">
        <div class="wrap">
            <ul>
                ...
                <li class="s2" data-type="sjnew">
                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/sheji/" target="_blank" rel="nofollow">
                        <div>
                            <span class="img"></span>
                ...
                <li class="s3">
                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/company/" target="_blank" rel="nofollow">
                        <div>
                            <span class="img"></span>
    ...
    <div class="wrap">
        <div class="box">
            ...
            <ul class="box-list-link">
                <?php if(is_array($info["location"])): $i = 0; $__LIST__ = $info["location"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="active"><a href="<?php echo ($vo["url"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div class="xgt-box">
                <ul class="row-1">
                    <li>
    ...
    <div class="wrap ofw">
        <div class="box">
            <div class="box-tit">
                <div class="tit"><a href="http://<?php echo C('QZ_YUMINGWWW');?>/company/" target="_blank">装修公司</a></div>
                <div class="heng-line"></div>
                <div class="tit-sm">甄选<i class="f-red">优质装修公司</i>，为您提供优质的装修服务</div>
            </div>
            <div class="company-lunbo">
                <div class="company-slider">
                    <?php if(is_array($info["brands"])): $i = 0; $__LIST__ = $info["brands"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="slide-item">
                            <div class="company-anli">
                                <a href="http://<?php echo ($vo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/company_home/<?php echo ($vo["company_id"]); ?>/"
                                   rel="nofollow" target="_blank">
                                   <img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ((isset($vo['img']) && ($vo['img'] !== ""))?($vo['img']):'file/20180123/FsmhNCcgLnXA8gVgmUMbK2uwqlSd.jpg'); ?> "
                                             alt="<?php echo ($vo['jc']); ?>">
                                </a>
                            </div>
                            <div class="company-img">
                                <a href="http://<?php echo ($vo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/company_home/<?php echo ($vo["company_id"]); ?>/"
                                   rel="nofollow" target="_blank"><img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ($vo["img_url"]); ?>"
                                                       alt="<?php echo ($vo['jc']); ?>"></a>
                            </div>
            ...
            <a rel="nofollow" class="more" href="http://<?php echo C('QZ_YUMINGWWW');?>/company/" target="_blank">查看更多装修公司</a>
        </div>
    </div>
    <!-- 装修公司模块 E -->
                    ...
                    <ul>
                        <?php if(is_array($videos)): $i = 0; $__LIST__ = $videos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
                            <div class="video-icon">
                                <a href="/video/v<?php echo ($vol["id"]); ?>.html" target="_blank">
                                    <img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ($vol["cover_img"]); ?>-w400.jpg" alt="<?php echo ($vol["title"]); ?>">
                                </a>
                            </div>
                            <div class="video-text">
                                <h3><a href="/video/v<?php echo ($vol["id"]); ?>.html" target="_blank"><?php echo (mbstr($vol["title"],0,14)); ?></a></h3>
                        ...
                        <li>
                            ...
                            <div class="gl-list-wz">
                                <?php if(is_array($info["liucheng"])): $i = 0; $__LIST__ = $info["liucheng"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                    <a href="http://www.<?php echo C('QZ_YUMING');?>/gonglue/<?php echo ($vo["shortname"]); ?>/" target="_blank" title="<?php echo ($vo["classname"]); ?>"><span class="wz-fenlei"><?php echo ($vo["classname"]); ?></span></a>
                                ...
                                <div class="to-gl"><p><a href="http://<?php echo C('QZ_YUMINGWWW');?>/gonglue/lc/" target="_blank">GO<i class="go-to"></i></a></p></div>
                            </div>
                        </li>
                        <li>
                            <div class="gl-img">
                            ...
                            <div class="gl-list-wd">
                                <?php if(is_array($info["wenda"])): $i = 0; $__LIST__ = $info["wenda"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                        <a title="<?php echo ($vo["title"]); ?>" href="http://<?php echo C('QZ_YUMINGWWW');?>/wenda/x<?php echo ($vo["id"]); ?>.html" target="_blank">
                                            <span class="wz-det"><?php echo ($vo["title"]); ?></span>
                                        </a>
                                        <span class="wz-shijian"><?php echo ($vo["anwsers"]); ?>个回答</span>
                                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                <div class="to-gl"><p><a href="http://<?php echo C('QZ_YUMINGWWW');?>/wenda/" target="_blank">GO<i class="go-to"></i></a></p></div>
                            </div>
                        </li>
                        <li>
                            <div class="gl-img">
                            ...
                            <div class="gl-list-wz">
                                <?php if(is_array($info["baike"])): $i = 0; $__LIST__ = $info["baike"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/baike/<?php echo ($vo["url"]); ?>" title="<?php echo ($vo["sub_category"]); ?>"><span class="wz-fenlei"><?php echo ($vo["sub_category"]); ?></span></a>
                                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/baike/<?php echo ($vo["id"]); ?>.html" title="<?php echo ($vo["title"]); ?>"><span class="wz-det"><?php echo ($vo["title"]); ?></span></a>
                                </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <li>
                            ...
                            <div class="gl-list-wd">
                                <?php if(is_array($info["riji"])): $i = 0; $__LIST__ = $info["riji"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/riji/s<?php echo ($vo["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><span class="wz-det"><?php echo ($vo["title"]); ?></span></a>
    ...
    <div class="wrap">
        <div class="box">
            <div class="box-tit">
                <div class="tit"> <a href="http://<?php echo C('QZ_YUMINGWWW');?>/xgt/" target="_blank">真实案例，任你挑选</a></div>
                <div class="heng-line"></div>
            ...
            <a rel="nofollow" class="more" href="http://<?php echo C('QZ_YUMINGWWW');?>/xgt/" target="_blank">查看更多装修案例</a>
        </div>
    </div>
    <!-- 装修案列模块 E -->
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        $('#disigner-backward').click(function() {
            $('#disigner').trigger('backward');
        });
        $('#disigner-forward').click(function() {
            $('#disigner').trigger('forward');
        });

        //发单按钮
        $('#quickAskSubmit').click(function(event) {
            $(".quickask .focus").removeClass('focus');
            window.order({
                wrap:'.quick-ask-submit',
                extra:{
                    source: '161' //这里额外参数只有source，获取的是wrap属性下的class包含order-item的参数的值
                },
                success:function(data, status, xhr){
                    if (data.status == 1) {
                        $('#quickCBox').html('<div class="secusess"><img src="/assets/home/index/img/quickask-success.png" width="88" height="155" alt="齐装网"/><h3>您的问题已经提交成功！</h3><p>15分站内齐装网会联系您，为您解决装修问题</p></div>');
                    } else {
                        alert(data.info);
                    }
                },
                validate:function(item, value, method, info){
                    if ('name' == item && 'notempty' == method) {
                        $('.quickask input[name="name"]').addClass('focus').focus();
                        alert("请输入您的称呼");
                        return false;
                    };
                    if ('name' == item && 'isword' == method) {
                        $('.quickask input[name="name"]').addClass('focus').focus();
                        $('.quickask input[name="name"]').val('');
                        alert("请输入正确的名称，只支持中文和英文");
                        return false;
                    };
                    if ('tel' == item && 'notempty' == method) {
                        $('.quickask-tel').addClass('focus').focus();
                        alert(info);
                        return false;
                    };
                    ...
                    if ('cs' == item && 'notempty' == method) {
                        $('.quickask select[name="quickaskquyu"]').addClass('focus').focus();
                        alert(info);
                        return false;
                    };
                    if ('content' == item) {
                        if (!App.validate.run(value)) {
                            alert('必须要输出提问内容。');
                            $('.quickask-main').addClass('focus').focus();
                            return false;
                        }
                        if (!App.validate.run(value.length, "maxlength",50)) {
                            alert('您输入的字数超出限制');
                            $('.quickask-main').addClass('focus').focus();
                            return false;
                        }
        ...
        $(".play #btnSave").click(function(event) {
            ...
            window.order({
                wrap:'.play',
                extra:{
                    cs: $(".play .edit-city").val(),
                    qx: $(".play .edit-quyu").val(),
                    name: $(".play input[name=name]").val(),
                    tel: $(".play input[name=tel]").val(),
                    fb_type: $(".play input[name=fb_type]").val(),
                    source: '156',
                    step: 2
                },
                success:function(data, status, xhr){
        ...
        $(".quickdesi #btnSubmit").click(function(event) {
            var container = $(".quickdesi");
            $(".focus", container).removeClass('focus');
            $(".height_auto", container).removeClass('height_auto');
            $(".valdate-info", container).remove();
            window.order({
                ...
                extra:{
                    ...
                    cs:$("select[name=quickdesicity]", container).val(),
                    qx:$("select[name=quickdesiquyu]", container).val(),
                    source: '162',
                    step: 2
                },
                success:function(data, status, xhr){
                ...
                validate:function(item, value, method, info){
                    ...
                    if ('cs' == item && 'notempty' == method) {
                        $("select[name=quickdesicity]", container).parent().addClass('height_auto');
                        $("select[name=quickdesicity]", container).addClass('focus').focus();
                        var span = $("<i class='valdate-info'></i>");
                        span.html("请选择城市~");
                        $("select[name=quickdesicity]", container).parent().append(span);
                        return false;
                    };
                    return true;
                }
