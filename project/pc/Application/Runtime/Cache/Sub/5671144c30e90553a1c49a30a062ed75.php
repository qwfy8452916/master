...
<div class="zb_footer_box">
    ...
    <div class="wrap">
        ...
        <div class="zb_m_container">
            <div class="zb_m_tit">
                <p>免费获得四份不同的设计方案</p>
                <span>免费户型设计，今日仅剩 <a href="javascript:void(0)"><?php echo releaseCount("fbrs");?></a>个名额</span>
            </div>
...
<div class="zb_footer_box_little">
    <img src="<?php echo ($static_host); ?>/assets/common/img/tanchuang.png" alt="免费获取设计" class="baiduab-beha"/>
</div>
<script>
