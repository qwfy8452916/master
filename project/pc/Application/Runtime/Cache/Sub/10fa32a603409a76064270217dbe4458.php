...
<head>
    ...
    <link rel="canonical" href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/"/>
...
<script type="text/javascript" src="<?php echo ($cityfile); ?>"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/home/index/css/home_20181221.css?v=<?php echo C('STATIC_VERSION');?>" />
...
<script type="text/javascript">
    ...
    <a rel="nofollow" href="http://www.qizuang.com/about/disclamer" target="_blank" class="pull-left"><span>《免责申明》</span></a>
</div>
    ...
    <!-- 装修公司 S -->
    <div class="wrap">
        <div class="box company-model">
            <div class="box-tit">
                <div class="tit"><a href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/company/" target="_blank"><h2><?php echo ($cityInfo["name"]); ?>装修公司</h2></a></div>
                <div class="heng-line"></div>
                <div class="tit-sm"><?php echo ($cityInfo["name"]); ?>装修网为您甄选<i class="f-red">本地优质</i>装修公司</div>
            </div>
            <div class="company-box">
                <ul>
                    <?php if(is_array($info["brands"])): $i = 0; $__LIST__ = $info["brands"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['real'] == '2' and $vo['fake'] == '0'): ?><li>
                                <div class="recommend"><img src="/assets/home/index/img/recommend.png" /></div>
                                <div class="img-logo">
                                    <a rel="nofollow" href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/company_home/<?php echo ($vo["company_id"]); ?>/" target="_blank"><img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ($vo["img_url"]); ?>" alt="<?php echo ($vo['jc']); ?>"></a>
                                </div>
                                <p class="company-description"><a href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/company_home/<?php echo ($vo["company_id"]); ?>/" target="_blank" title="<?php echo ($vo["qc"]); ?>"><?php echo ($vo['jc']); ?></a></p>
                                <p class="company-location"><?php echo ($vo["area_name"]); ?></p>
                                ...
                                <a href="javascript:void(0)" class="free-sheji">免费设计</a>
                            </li>
                            <?php else: ?>
                            <li>
                                <div class="img-logo">
                    ...
                    <?php $__FOR_START_2028__=0;$__FOR_END_2028__=$info["brandscount"];for($i=$__FOR_START_2028__;$i < $__FOR_END_2028__;$i+=1){ ?><li>
                            <div class="img-logo">
                                <a rel="nofollow" href="#"><img src="/assets/home/index/img/companglogo.png" title="公司简称"></a>
                            </div>
                            <p class="company-description">虚位以待</p>
                            <p class="company-location nocompany">装修公司火热招商中</br>
                                等你加入
                            </p>
                            <a rel="nofollow" href="http://www.<?php echo C('QZ_YUMING');?>/ruzhu/" class="free-ruzhu" target="_blank">申请入驻</a>
                        </li><?php } ?>
                </ul>
            </div>
            <a rel="nofollow" class="more" href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/company/" target="_blank" style="margin-bottom: 0;">查看更多装修公司</a>
        </div>
    </div>
    <!-- 装修公司 E -->
    ...
    <div class="wrap">
        <div class="box">
            <div class="box-tit">
                <div class="tit"><a href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/xgt/" target="_blank"><h2><?php echo ($cityInfo["name"]); ?>装修案例</h2></a></div>
                <div class="heng-line"></div>
                <div class="tit-sm"><?php echo ($cityInfo["name"]); ?>装修网提供<i class="f-red"><?php echo ($info["casesCount"]); ?>套</i>真实装修案例，任您挑选</div>
            </div>
            <div class="al-box">
                <ul class="al-list">
            ...
            <a rel="nofollow" class="more zx-more"  href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/xgt/" target="_blank">查看更多装修案例</a>
        </div>
    </div>
    <!-- 装修案列模块 E -->
    ...
    <div class="zx-xgt">
        <div class="wrap">
            <div class="box">
                <div class="box-tit">
                    <div class="tit"><a href="http://meitu.<?php echo C('QZ_YUMING');?>/" target="_blank"><h2><?php echo ($cityInfo["name"]); ?>装修效果图</h2></a></div>
                    <div class="heng-line"></div>
                    <div class="tit-sm"><i class="f-red"><?php echo ($info["caseimgsCount"]); ?>张</i>装修美图任您挑选，帮您找到您喜欢的装修风格</div>
                </div>
                <div class="ulist-center">
                    <ul class="ullist">
                        <?php if(is_array($info["effect_meitu"]["wdrecommend"])): $i = 0; $__LIST__ = $info["effect_meitu"]["wdrecommend"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["url"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        <li class="xgt-more"><a href="http://meitu.<?php echo C('QZ_YUMING');?>/" target="_blank">更多</a></li>
                    </ul>
                </div>

                <div class="xgt-box xgt-box-tit">
                    <ul class="row-1">
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][0]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][0]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][0]['title']); ?></p></a>
                        </li>
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][5]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][5]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][5]['title']); ?></p></a>
                        </li>
                    </ul>
                    <ul class="row-2">
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][1]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][1]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][1]['title']); ?></p></a>
                        </li>
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][4]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][4]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][4]['title']); ?></p></a>
                        </li>
                    </ul>
                    <ul class="row-1">
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][2]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][2]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][2]['title']); ?></p></a>
                        </li>
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][7]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][7]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][7]['title']); ?></p></a>
                        </li>
                    </ul>
                    <ul class="row-2" id="row-3">
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][3]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][3]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][3]['title']); ?></p></a>
                        </li>
                        <li><a href="<?php echo ($info['effect_meitu']['imrecommend'][6]['url']); ?>" target="_blank">
                            <img src="<?php echo ($info['effect_meitu']['imrecommend'][6]['img']); ?>" />
                            <p><?php echo ($info['effect_meitu']['imrecommend'][6]['title']); ?></p></a>
                        </li>
                    </ul>
                </div>
                <a rel="nofollow" class="more" href="http://<?php echo C('MEITU_DONAMES');?>/" target="_blank">查看更多装修效果图</a>
            </div>
        </div>
    </div>
    <!-- 装修效果图模块 E -->
    ...
    <div class="wrap">
        <div class="box">
            <div class="box-tit">
                <div class="tit"><a href="http://<?php echo ($cityInfo['bm']); ?>.<?php echo C('QZ_YUMING');?>/zxinfo/" target="_blank"><h2><?php echo ($cityInfo["name"]); ?>装修资讯</h2></a></div>
                <div class="heng-line"></div>
                <div class="tit-sm">学习更多的装修资讯，<i class="f-red">轻松装修</i>乐无忧</div>
            </div>
            <div class="xgt-box" style="overflow:hidden;">
                <div class="zx-box">
                    <ul class="zxlist">
                        <?php if(is_array($info["cateGory"])): $ke = 0; $__LIST__ = $info["cateGory"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($ke % 2 );++$ke;?><li>
                                <div class="leftimg">
                                    <a href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/zxinfo/<?php echo ($value["shortname"]); ?>/" target="_blank">
                                        <img src="/assets/home/index/img/zx0<?php echo ($ke); ?>.jpg" alt="<?php echo ($value["name"]); ?>"/>
                                        <div class="zxcover"><?php echo ($value["name"]); ?></div>
                                    </a>
                                </div>
                                <div class="leftcontent">
                                    <ul>
                                        <?php if(is_array($value["content"])): $i = 0; $__LIST__ = $value["content"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$content): $mod = ($i % 2 );++$i;?><li>
                                            <a href="/zxinfo/<?php echo ($content["id"]); ?>.html" target="_blank"><?php echo ($content['title']); ?></a>
                                            <span><?php echo (date("Y-m-d",$content["addtime"])); ?></span>
                                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                </div>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <a rel="nofollow" class="more" href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/zxinfo/" target="_blank" style="margin-bottom: 0;">查看更多装修资讯</a>
        </div>
    </div>
    <!-- 苏州装修资讯 E -->
    ...
    <div class="wrap">
        <div class="box">
            <div class="box-tit">
                <div class="tit"><a href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/designer/" target="_blank"><h2><?php echo ($cityInfo["name"]); ?>装修设计师</h2></a></div>
                <div class="heng-line"></div>
                <div class="tit-sm">挑选到适合您的好装修设计师，让装修变得<i class="f-red">更轻松</i></div>
            </div>
            <div class="decorator-designer">
                <ul>
                    <?php if(is_array($info["designer"])): $i = 0; $__LIST__ = $info["designer"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a rel="nofollow" href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/blog/<?php echo ($vo["uid"]); ?>/" target="_blank">
                            <div class="designer-photo"><img src="<?php echo ($vo["logo"]); ?>" width="121" height="121" ></div>
                            <p class="designer-name"><?php echo ($vo["uname"]); ?></p>
                            <p class="designer-position"><?php echo ((isset($vo["zw"]) && ($vo["zw"] !== ""))?($vo["zw"]):"设计师"); ?></p>
                        </a>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php $__FOR_START_30645__=0;$__FOR_END_30645__=$info["designercount"];for($i=$__FOR_START_30645__;$i < $__FOR_END_30645__;$i+=1){ ?><li>
                            <a rel="nofollow" href="javascript:void(0)" alt="">
                                <div class="designer-photo"><img src="/assets/home/index/img/companglogo.png"></div>
                                <p class="designer-name">暂无</p>
                                <p class="designer-position"></p>
                            </a>
                        </li><?php } ?>
                </ul>
            </div>
            <a rel="nofollow" class="more" href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/designer/" target="_blank" style="margin-bottom: 0;">查看更多装修设计师</a>
        </div>
    </div>
    <!-- 装修设计师模块 E -->
    ...
    <div class="wrap">
        <div class="box">
            <div class="box-tit">
                <div class="tit"><h2><?php echo ($cityInfo["name"]); ?>装修业主评价</h2></div>
                <div class="heng-line"></div>
                <div class="tit-sm">一起来看看业主们在装修过程中的<i class="f-red">体验</i>吧</div>
            </div>
            <div class="decorator-comment">
                <ul>
                    <?php if(is_array($info["comment"])): $i = 0; $__LIST__ = $info["comment"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="marginbottom">
                            <div class="comment-top">
                                <a rel="nofollow" href="http://<?php echo ($cityInfo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/company_home/<?php echo ($vo["company_id"]); ?>" target="_blank">

                                    <?php if($vo["logo"] != ''): ?><img src="<?php echo ($vo["logo"]); ?>">
                                        <?php else: ?>
                                        <img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo OP('DEFAULT_COMPANY_LOGO');?>" /><?php endif; ?>
                                    <span class="comment-company"><?php echo ($vo["jc"]); ?></span>
                                </a>
                            </div>
                            <div class="comment-center">
                                <span><?php echo ($vo["name"]); ?>：</span>
                                <span><?php echo mbstr($vo['text'],0,96);?></span>
                            </div>
                            <div class="comment-bottom">
                                <span>评分：</span>
                                <span class="company-star">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
    ...
    <div class="zx-gl">
        <div class="wrap">
            <div class="box">
                <div class="box-tit">
                    <div class="tit"><a href="http://<?php echo C('QZ_YUMINGWWW');?>/gonglue/" target="_blank"><h3>装修攻略</h3></a></div>
                    <div class="heng-line"></div>
                        ...
                        <li>
                            ...
                            <div class="gl-list-wz">
                                <?php if(is_array($info["liucheng"])): $i = 0; $__LIST__ = $info["liucheng"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                        <a href="http://www.<?php echo C('QZ_YUMING');?>/gonglue/<?php echo ($vo["shortname"]); ?>/" target="_blank">
                                            <span class="wz-fenlei"><?php echo ($vo["classname"]); ?></span>
                                        </a>
                                        <a href="http://www.<?php echo C('QZ_YUMING');?>/gonglue/<?php echo ($vo["shortname"]); ?>/<?php echo ($vo["id"]); ?>.html" target="_blank">
                        ...
                        <li>
                            ...
                            <div class="gl-list-wd">
                                <?php if(is_array($info["wenda"])): $i = 0; $__LIST__ = $info["wenda"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                        <a href="http://<?php echo C('QZ_YUMINGWWW');?>/wenda/x<?php echo ($vo["id"]); ?>.html" target="_blank">
                                            <span class="wz-det"><?php echo ($vo['title']); ?></span>
                                        </a>
                        ...
                        <li>
                            ...
                            <div class="gl-list-wz">
                                <?php if(is_array($info["baike"])): $i = 0; $__LIST__ = $info["baike"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                        <a href="http://<?php echo C('QZ_YUMINGWWW');?>/baike/<?php echo ($vo["url"]); ?>/" target="_blank"><span class="wz-fenlei"><?php echo ($vo["sub_category"]); ?></span></a>
                                        <a href="http://<?php echo C('QZ_YUMINGWWW');?>/baike/<?php echo ($vo["id"]); ?>.html" target="_blank">
                                            <span class="wz-det"><?php echo ($vo['title']); ?></span>
                                        </a>
                                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <li>
                            ...
                            <div class="gl-list-wd">
                                <?php if(is_array($info["riji"])): $i = 0; $__LIST__ = $info["riji"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gl-list-item">
                                        <a href="http://<?php echo C('QZ_YUMINGWWW');?>/riji/d<?php echo ($vo["id"]); ?>.html" target="_blank"><span class="zx-rj"><?php echo ($vo['xf']); ?></span></a>
                                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <a rel="nofollow" class="more" href="http://<?php echo C('QZ_YUMINGWWW');?>/gonglue/" target="_blank">查看更多装修攻略</a>
    </div>
    </div>
    </div>
    <!-- 装修攻略模块 E -->
        ...
        <div class="box">
            ...
            <div class="video-container ofw">
                <div class="pay-area pull-left">
                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/video/v<?php echo ($vRecommend['id']); ?>.html" target="_blank">
                        <img src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ($vRecommend['cover_img']); ?>-w660.jpg" class="cover-img">
                    ...
                    <ul>
                        <?php if(is_array($videos)): $i = 0; $__LIST__ = $videos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
                                ...
                                <div class="video-text">
                                    <a href="http://<?php echo C('QZ_YUMINGWWW');?>/video/v<?php echo ($vol["id"]); ?>.html" target="_blank"><span><?php echo ($vol["title"]); ?></span></a>
            ...
            <a rel="nofollow" class="more" style="margin-bottom: 0;" href="http://<?php echo C('QZ_YUMINGWWW');?>/video/" target="_blank">查看更多装修视频</a>
        </div>
    </div>
    <!-- 装修视频模块 E -->
...
<script type="text/javascript">
    ...
    //装修效果图鼠标移入效果
    $(".xgt-box-tit ul li").mouseenter(function () {
        $(this).find("p").stop().animate({height:"40px"});
    }).mouseleave(function () {
        $(this).find("p").stop().animate({height:"0px"});
    })
    ...
    $(".free-sheji").click(function (event) {
        var _this = $(this);
        $.ajax({
            url: '/dispatcher/',
            type: 'POST',
