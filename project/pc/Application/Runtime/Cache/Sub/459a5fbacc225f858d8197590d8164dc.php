...
<head>
    ...
    <title><?php echo ($keys["title"]); ?>11</title>
...
<script type="text/javascript" src="<?php echo ($cityfile); ?>"></script>
    ...
    <![endif]-->
    <link href="<?php echo ($static_host); ?>/assets/sub/company/css/zxcompany.css?v=<?php echo C('STATIC_VERSION');?>" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="wrap ofw">
    ...
    <div class="listxz_title">
        <ul>
            <li class="sort">排序：</li>
            <li><a class="fa fa-exclamation-circle koubei <?php echo ($orderby[1]['active']); ?>" aria-hidden="true" href="<?php echo ($orderby[1]['url']); ?>">口碑<div class="tishi01"><div class="content_quyu"><p>口碑是装修公司服务水平得重要体现,也是业主选择装修公司的重要参考依据。</p>
            <p class="topjvli">口碑由以下三部分构成，七天动态更新。</p><p class="yuanfu"><span></span>装修公司的服务质量</p>
            <p class="yuanfu"><span></span>用户好评数</p>
            <p class="yuanfu"><span></span>装修公司的专业水平</p></div></div></a></li>
            <li><a class="fa fa-exclamation-circle shilizh <?php echo ($orderby[5]['active']); ?>" aria-hidden="true" href="<?php echo ($orderby[5]['url']); ?>">综合实力<div class="tishi02"><div class="content_quyu"><p>实力是装修公司整体能力的重要体现，也是业主选择装修公司的重要参考依据。</p>
            <p class="topjvli">实力由以下三部分构成，七天动态更新。</p><p class="yuanfu"><span></span>案例</p>
            <p class="yuanfu"><span></span>设计团队</p>
            <p class="yuanfu"><span></span>施工团队</p></div></div></a></li>
        </ul>
    ...
    <ul class="gongslist">
        <?php if(is_array($companyInfo["companyList"])): $i = 0; $__LIST__ = $companyInfo["companyList"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
            <div class="contentop">
                <a class="tuplj" rel="nofollow" href="http://<?php echo ($vo["bm"]); ?>.<?php echo C('QZ_YUMING');?>/company_case/<?php echo ($vo["id"]); ?>.html" target="_blank">
                    <img class="bjtupian" src="http://<?php echo C('QINIU_DOMAIN');?>/<?php echo ((isset($vo['img']) && ($vo['img'] !== ""))?($vo['img']):'file/20180123/FsmhNCcgLnXA8gVgmUMbK2uwqlSd.jpg'); ?>" alt="">
                </a>
                <div class="gongsjskz">
                    <div class="company_tituw f0">
                        ...
                        <span class="rel">
                            <img src="/assets/sub/company/img/cert.png" alt="" class="license mr10">
                            <span class="cert-desc">营业执照已审核</span>
                            <span class="ieShadow"></span>
                        </span>
                        <span class="rel">
                            <img src="/assets/sub/company/img/license.png" alt="" class="license">
                            <span class="cert-desc">具备装修资质</span>
                            <span class="ieShadow"></span>
                        </span>
                    </div>
                    <div class="company_Grade">
                        <?php $__FOR_START_18831__=0;$__FOR_END_18831__=$vo["star"];for($i=$__FOR_START_18831__;$i < $__FOR_END_18831__;$i+=1){ ?><span class="xingxing"></span><?php } ?>
                        <span class="ping_number">好评率</span>
                    </div>
                    <div class="anliteam">
                        <span class="anliteam_anli">案例数</span>
                        <span><?php echo ((isset($vo["case_count"]) && ($vo["case_count"] !== ""))?($vo["case_count"]):0); ?>套</span>
                        <span class="anliteam_sheji">设计师</span>
                        <span><?php echo ((isset($vo["team_count"]) && ($vo["team_count"] !== ""))?($vo["team_count"]):0); ?></span>
                        <span class="anliteam_shigong">施工团队</span>
                        <span><?php echo ((isset($vo["team_num"]) && ($vo["team_num"] !== ""))?($vo["team_num"]):0); ?>队</span>
                    </div>
                    <div class="company_address">
                        <span class="address_logo"></span>
                        <span class="address_ms" title="<?php echo ($vo["dz"]); ?>"><?php echo (mbstr($vo["dz"],0,25)); ?></span>
                    </div>
            ...
            <div class="zhuagnx_process homeowner-order-container">
                ...
                <div class="homeowner-scroll box">
                    <ul class="homeowner-order list">
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>陈先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>马女士</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>朱先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>李先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>赵先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>李小姐</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>曹小姐</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>吴先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>钱小姐</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>冯小姐</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>杨先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>周女士</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>王先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>吴先生</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                        <li><span class="info"><?php echo ($cityinfo["name"]); ?>的<i>冒小姐</i>签订了服务方案</span><span class="date"><?php echo rand(1,7) ?>天前</span>天前</span>
                        </li>
                    </ul>
                </div>
            </div>

            <?php if(!empty($companyInfo["recomArticle"])): ?><div class="recom-article">
                <div class="zxtitle"><?php echo ($cityinfo["name"]); ?>装修公司资讯</div>
                <div class="zxcontent">
                    <ul>
                        <?php if(is_array($companyInfo["recomArticle"])): $i = 0; $__LIST__ = $companyInfo["recomArticle"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/zxinfo/<?php echo ($vo["id"]); ?>.html" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div><?php endif; ?>
    </div>
