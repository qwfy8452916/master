;(function ($){
	...
	WySilder.prototype._init = function (eles,options){
		...
		this._options = {
            ...
            interval: 9000,//自动轮播的时间，以毫秒为单位，默认3000毫秒
		...
		$(this).each(function(index, ele) {
			var $this = $(this),
				silderCtrl = $(".js-silder-ctrl"),
				silderMain = $this.find(".silder-main");
			$this.addClass('js-silder');
			//判断是否有轮播图主结构，如果没有则生成
			if(silderMain.length == 0){
				var silderScroll = $('<div class="silder-scroll1"><div class="silder-main"></div></div>');
    ...
    WySilder.prototype._autoPlay = function (){
        var that = this,
            $that = $(that),
            //轮播时间
            interval = isNaN(that.interval * 1) ? 9000 : that.interval;
