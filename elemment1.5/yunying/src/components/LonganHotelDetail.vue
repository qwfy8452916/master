    ...
    <div class="hoteladd">
        ...
        <el-form v-model="HotelDataModify" :model="HotelDataModify" :rules="rules" ref="HotelDataModify" label-width="140px" class="hotelform">
            ...
            <el-form-item label="是否有停车场" prop="isHasPark">
                <el-radio name="park" :disabled="true" v-model="HotelDataModify.isHasPark" :label="1">有</el-radio>
                <el-radio name="park" :disabled="true" v-model="HotelDataModify.isHasPark" :label="0">没有</el-radio>
            </el-form-item>
            <el-form-item>
            ...
            <el-form-item label="地址" prop="hotelAddress">
                <el-input :disabled="true" v-model="HotelDataModify.hotelAddress"></el-input>
            </el-form-item>
