<template>
    <div class="purchaselist">
        ...
        <el-col :span="24" class="addcommodity">
                <el-button type="primary" @click="addproduct()">新增采购</el-button>
            </el-col>
        </el-row>

        <el-table :data="Productlist" border style="width:100%;" >
            <el-table-column fixed prop="purCode" label="采购单id" width="180px" align=center></el-table-column>
            <el-table-column prop="hotelName" label="酒店名称" width="180px" align=center></el-table-column>
            ...
            <el-table-column prop="createdBy" label="操作人姓名" width="160px" align=center></el-table-column>
    ...
    methods: {
        ...
        //查看
         Seeorder(index,rows){
            ...
            this.$router.push({name:'SeepurchaseOrder',params:{productid: lookid}});
         },
        //删除
