    ...
    <div class="servicetypeadd">
        ...
        <el-form v-model="ServiceTypeDataAdd" :model="ServiceTypeDataAdd" :rules="rules" ref="ServiceTypeDataAdd" label-width="100px" class="servicefrom">
            ...
            <el-form-item label="服务类型" prop="serviceType">
                <el-input v-model.trim="ServiceTypeDataAdd.serviceType"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button @click="resetForm()">取消</el-button>
                <el-button type="primary" :disabled="isSubmit" @click="submitForm('ServiceTypeDataAdd')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
    ...
    methods: {
        ...
        submitForm(ServiceTypeDataAdd){
            const params = {
                ...
                name: this.ServiceTypeDataAdd.serviceType
            };
