<template>
    <div class="hotellist">
        ...
        <el-table :data="Productlist" border style="width:100%;" >
            <el-table-column fixed prop="id" label="商品id" width="100px" align=center></el-table-column>
            <el-table-column prop='prodLogoUrl' label="商品图片" width="100px" align=center>
                <template slot-scope="scope">
                    <img :src="scope.row.prodLogoUrl" alt="" style="width: 50px;height: 50px">
                </template>
            </el-table-column>
            <el-table-column prop="productName" label="商品名称" width="100px" align=center></el-table-column>
            <el-table-column prop="supplierName" label="供应商名称" width="100px" align=center></el-table-column>
            <el-table-column prop="sqSign" label="商品编码" width="100px" align=center></el-table-column>
            ...
            <el-table-column prop="createdAt" label="添加时间" width="110px" align=center></el-table-column>
            <el-table-column prop="lastUpdatedByName" label="操作人姓名" width="80px" align=center></el-table-column>
