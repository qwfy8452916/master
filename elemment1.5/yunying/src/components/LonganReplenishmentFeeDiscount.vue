<template>
    <div class="LonganWithdrawalsRecord">
        ...
        <el-table :data="LonganWithdrawalsRecordDataList" border style="width:100%;" >
            ...
            <el-table-column prop="TradeName" label="提现人" align=center></el-table-column>
            <el-table-column prop="SalesAmount" label="提现金额（元）" align=center></el-table-column>
            <el-table-column prop="DividedTntoAmount" label="提现时间" align=center></el-table-column>
            <el-table-column prop="SalesAmount" label="提现状态" align=center></el-table-column>
        </el-table>
