<template>
    <div class="LonganRevenueDetail">
        <ul class="HotelRevenueDetail-ul" v-for="item in detailList">
            <li>
                <div class="table-font1">酒店名称</div>
                <div class="table-font2">{{item.hotelName}}</div>
            </li>
            <li>
...
export default {
    ...
    methods: {
        ...
        LonganRevenueDetail(){
            ...
            this.$api.LonganRevenueDetail({params})
                .then(response => {
