...
export default {
    ...
    data(){
        ...
        var ValiduseLimitMoney = (rule,value,callback) => {
            if(this.addCoupondata.useLimitMoney<=0 || this.addCoupondata.useLimitMoney<this.addCoupondata.reduceMoney){
        ...
        var ValidreduceMoney = (rule,value,callback) => {
            if(this.addCoupondata.reduceMoney<=0 || this.addCoupondata.useLimitMoney<this.addCoupondata.reduceMoney){
                callback(new Error('11'))
            }else{
                callback()
            }
