<template>
    <div class="Franchisee">
        <el-form ref="formdata" :inline="true" align=left class="searchform">
            <el-form-item label="合作伙伴名称" prop="status">
                <el-input v-model="franchiseename"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="inquire">查&nbsp;&nbsp;询</el-button>
            </el-form-item>
        </el-form>
        <div v-if="authzData['F:BO_ALLY_ALLY_ADD']" class="addranchisee"><el-button type="primary" @click="addranchisee">新增</el-button></div>
...
export default {
    ...
    methods: {
         ...
         //查看详情
         lookdetail(id){
            this.$router.push({name:'LonganFranchiseeedetail',query:{id}})
         },
         ...
         partnersetup(id,namexm){
            this.$router.push({name:'LonganPartnerSetup',query:{id,namexm}})
         },
