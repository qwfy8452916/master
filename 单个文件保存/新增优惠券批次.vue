    ...
    <div class="PlatformCouponAdd">
         ...
         <el-form label-width="130px" style="width:70%" :model="addCoupondata" ref="addCoupondata" :rules="rules">
            ...
            <el-form-item label="使用门槛" prop="useLimitMoney">
                满<el-input v-model="addCoupondata.useLimitMoney" placeholder="使用门槛需高于金额" style="width:334px;margin-right:5px"></el-input>元
            </el-form-item>
            <el-form-item label="优惠券金额" prop="reduceMoney">
                <el-input v-model="addCoupondata.reduceMoney" placeholder="请输入优惠券金额" style="width:349px;margin-right:5px"></el-input>元
            </el-form-item>
            ...
            <el-form-item label="使用有效期" prop="couponTermType">
               <div>
                  <el-radio @change="changecouponTermType" v-model="addCoupondata.couponTermType" label="0">领取后天数</el-radio>
                    <el-form-item class="couponTermType" v-if="addCoupondata.couponTermType==='0'" prop="couponTermDays">
                         <el-input v-model="addCoupondata.couponTermDays"></el-input>天
                    </el-form-item>
               </div>
            ...
            <el-form-item>
                ...
                <el-button type="primary" @click="sureBtn('addCoupondata')">确 定</el-button>
            </el-form-item>
         </el-form>
    ...
    data(){
      ...
      return {
         ...
         rules:{
             ...
             sceneCodes:{required:true,message:"请选择使用的场景",trigger:'change'},
             couponLimit:{required:true,message:"请选择优惠券类型",trigger:'change'},
             groupId:{required:true,message:"请选择优惠券分组",trigger:'change'},
             useLimitMoney:{required:true,message:"请填写优惠券使用门槛金额",trigger:'blur'},
             reduceMoney:{required:true,message:"请填写优惠券金额",trigger:'blur'},
             ...
             drawWays:{validator: ValidcanDraw,message:"请选择领取渠道",trigger:'change'},
    ...
    methods:{
        ...
        sureBtn(addCoupondata){
          ...
          let params={
             ...
             couponLimit:this.addCoupondata.couponLimit,
