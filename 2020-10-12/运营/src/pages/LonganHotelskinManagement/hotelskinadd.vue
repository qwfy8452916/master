<template>
    <div class="hotelskinadd">
        <p class="title">新增主题</p>

        <el-form :model="hotelskinAdd" :rules="rules" ref="hotelskinAdd" label-width="140px" class="hotelform">
           <el-form-item label="主题名称" prop="skinname">
                <el-input v-model.trim="hotelskinAdd.skinname" maxlength="50"></el-input>
            </el-form-item>
            ...
            <el-form-item label="主题内容" prop="skinms">
                <el-input type="textarea" resize="vertical" :autosize="textareasize" v-model.trim="hotelskinAdd.skinms"></el-input>
            </el-form-item>
            ...
            <el-form-item class="btnwrap">
                ...
                <el-button v-if="authzData['F:BO_HOTEL_THEME_ADD_SUBMIT']" type="primary" @click="submitForm('hotelskinAdd')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
    ...
    methods: {
        ...
        submitForm(hotelskinAdd) {
            ...
            let params = {
                ...
                orgAs: 2,
                themeName:that.hotelskinAdd.skinname,
                themeDescription:that.hotelskinAdd.skinms,
                themePath:that.hotelskinAdd.bannerList
            }
            if(that.hotelskinAdd.bannerList!=null){
               if(that.hotelskinAdd.bannerList.length == 0){
        ...
        handleSuccess(res, file, fileList) {
            this.hotelskinAdd.bannerList=res.data
            console.log(this.hotelskinAdd)
        },
        //图片移除
        handleRemove(file, fileList) {
            this.hotelskinAdd.bannerList =[];
        },
