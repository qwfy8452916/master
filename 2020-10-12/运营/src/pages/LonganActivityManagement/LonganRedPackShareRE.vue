<template>
  <div class="channellist">
    ...
    <el-table :data="PacketDataList" border stripe style="width:100%;">
      ...
      <el-table-column label="分享时间" width="160px" align="center">
        <template
          slot-scope="scope"
        >{{scope.row.shareTime=='1970-01-01 00:00:00'?'-':scope.row.shareTime}}</template>
      </el-table-column>
      <el-table-column prop="receivedNum" label="领取数量" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    packetGetRecord(shareId) {
      this.$router.push({ name: "LonganRedPackGetRecord", query: { shareId } });
    },
  },
};
</script>
