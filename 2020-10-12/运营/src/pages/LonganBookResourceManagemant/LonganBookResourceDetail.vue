<template>
  <div class="resourceadd">
    ...
    >
      ...
      <el-form-item label prop v-if="ResourceDataModify.isHourRoom==1">
        钟点房时间为
        <el-time-select
          :disabled="true"
          class="hourRoomInput"
          ...
          :picker-options="{start: '00:00',step: '00:15',end: '23:59',minTime: ResourceDataModify.hourRoomStartTime}"
        ></el-time-select>
        至
        <el-time-select
          :disabled="true"
        ...
        <el-input
          ...
          v-model="ResourceDataModify.hourRoomDuration"
        ></el-input>&nbsp;小时
      </el-form-item>
      <el-form-item>
        <span slot="label">
      ...
      <div class="facilityadd">
        ...
        <el-button :disabled="true" type="primary" class="addbtn" size="small">+ 添加</el-button>
