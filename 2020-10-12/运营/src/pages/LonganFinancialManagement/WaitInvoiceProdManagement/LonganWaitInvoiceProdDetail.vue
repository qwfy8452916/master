<template>
    <div class="bookorderdetail">
        ...
        <table cellpadding="0" cellspacing="0" class="ordertable">
            ...
            <tr v-if="orderDataDetail.invType == 1">
            ...
            <tr v-if="orderDataDetail.invHeadType == 1 || orderDataDetail.invType == 2">
            ...
            <tr v-if="orderDataDetail.invType == 2">
        ...
        <el-button v-if="orderStatus == 1 && authzlist['F:BO_FIN_INVOICE_WAIT_DEAL_SUBMIT']" type="primary" @click="waitInvoiceProdDeal">处理</el-button>
