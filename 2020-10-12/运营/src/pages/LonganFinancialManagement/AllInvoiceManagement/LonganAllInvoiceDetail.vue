<template>
    <div class="bookorderdetail">
        ...
        <el-button v-if="orderStatus == 1  && orderinvOrgId == 2 && authzlist['F:BO_FIN_INVOICE_DEAL_SUBMIT']" type="primary" @click="waitInvoiceProdDeal">处理</el-button>
            ...
            this.$api.waitInvoiceProdDetail(params, id)
                .then(response => {
                    ...
                    if(result.code == '0'){
                        ...
                        this.orderinvOrgId = result.data.invOrgId;
                    }else{
