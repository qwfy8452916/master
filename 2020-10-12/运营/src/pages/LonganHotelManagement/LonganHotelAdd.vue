  ...
  <div class="hoteladd">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-select
          v-model="HotelDataAdd.selectProvince"
          placeholder="省级地区"
        ...
        <el-select
          v-model="HotelDataAdd.selectCity"
          placeholder="市级地区"
      ...
      <!-- <el-form-item prop="isTicket">
        <span class="ticketlabel">
          <label class="required-icon">*</label> 是否支持开具含商品金额的发票
        </span>
      ...
      <!-- <LonganUploadPicCommen :uploadType="uploadType='banner'" :isDisabled="isDisabled" :bannerList="serBannerList" :bannerType="bannerType" @bannerListEvent="serBannerEvent"></LonganUploadPicCommen> -->
      <!-- </div> -->
      <!-- <el-form-item>
      ...
      <!-- <LonganUploadPicCommen :uploadType="uploadType='banner'" :isDisabled="isDisabled" :bannerList="roomBannerList" :bannerType="bannerType" @bannerListEvent="roomBannerEvent"></LonganUploadPicCommen> -->
      <!-- </div> -->
      ...
      <el-form-item label="支持外卖" prop="isSupportTakeOutOrder">
        <el-switch v-model="HotelDataAdd.isSupportTakeOutOrder"></el-switch>
      </el-form-item>
      <el-form-item v-if="HotelDataAdd.isSupportTakeOutOrder" prop="startPrice">
        <span slot="label">
          <label class="required-icon">*</label> 运费起步价
        </span>
        <el-input v-model.trim="HotelDataAdd.startPrice" maxlength="10"></el-input>元
      </el-form-item>
      <el-form-item v-if="HotelDataAdd.isSupportTakeOutOrder" prop="startMileage">
        <span slot="label">
          <label class="required-icon">*</label> 起步里程
        </span>
        <el-input v-model.trim="HotelDataAdd.startMileage" maxlength="10"></el-input>公里
      </el-form-item>
      <el-form-item v-if="HotelDataAdd.isSupportTakeOutOrder" prop="exceededMileagePrice">
        <span slot="label">
          <label class="required-icon">*</label> 超出价
        </span>
        <el-input v-model.trim="HotelDataAdd.exceededMileagePrice" maxlength="10"></el-input>元/公里
      </el-form-item>
      ...
      <el-form-item label="最优弹性价开关" prop="isSupportAdaptPrice">
        <el-switch v-model="HotelDataAdd.isSupportAdaptPrice"></el-switch>
      </el-form-item>
      <div v-if="HotelDataAdd.isSupportAdaptPrice">
        <el-form-item prop="enterSettingId">
          <span slot="label">
            <label class="required-icon">*</label> 进场配置
          </span>
          <el-select v-model="HotelDataAdd.enterSettingId" placeholder="请选择进场配置">
            <el-option
        ...
        <el-form-item prop="flexiblePriceStyle">
          ...
          <el-checkbox v-model="HotelDataAdd.isAdaptByPercentage">
        ...
        <el-form-item v-if="HotelDataAdd.isAdaptByPercentage" label>
          弹性范围
          <el-input
            v-model="HotelDataAdd.adaptLowestPercent"
            class="priceRangeInput"
            @blur="positiveIntegerValidation(HotelDataAdd.adaptLowestPercent)"
          ></el-input>&nbsp;% -
          <el-input
            v-model="HotelDataAdd.adaptHighestPercent"
            class="priceRangeInput"
            @blur="positiveIntegerValidation(HotelDataAdd.adaptHighestPercent)"
          ></el-input>&nbsp;%
        </el-form-item>
        <el-form-item label>
          <el-checkbox v-model="HotelDataAdd.isAdaptByMoney">
            <el-tooltip effect="dark" :content="priceRangeAmountTip" placement="right">
              <el-button type="text" style="color:#2C3E50;">加价金额</el-button>
            </el-tooltip>
          </el-checkbox>
        </el-form-item>
        <el-form-item v-if="HotelDataAdd.isAdaptByMoney" label>
          弹性范围
          <el-input
            v-model="HotelDataAdd.adaptLowestMoney"
            class="priceRangeInput"
            @blur="moneyValidation(HotelDataAdd.adaptLowestMoney)"
          ></el-input>&nbsp;元 -
          <el-input
            v-model="HotelDataAdd.adaptHighestMoney"
            class="priceRangeInput"
            @blur="moneyValidation(HotelDataAdd.adaptHighestMoney)"
          ></el-input>&nbsp;元
        </el-form-item>
        <el-form-item prop="commissionPercentage">
          ...
          <el-input
            v-model.number="HotelDataAdd.commissionPercentage"
            maxlength="3"
            @blur="commissionPercentageReg(HotelDataAdd.commissionPercentage)"
          ></el-input>&nbsp;%
        </el-form-item>
      </div>
      <!-- 最优弹性价结束 -->
      ...
      <el-form-item>
        ...
        <el-button
          v-if="authzData['F:BO_HOTEL_HOTEL_ADD_SUBMIT']"
          type="primary"
          :disabled="isSubmit"
          @click="submitForm('HotelDataAdd')"
        >确定</el-button>
      </el-form-item>
    </el-form>
  </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        hotelContactPhone: [{ validator: validateCMPhone, trigger: "blur" }],
        // hotelReservePhone: [
  ...
  methods: {
    ...
    commissionPercentageReg(item) {
      ...
      if (this.HotelDataAdd.commissionPercentage == "") {
        this.HotelDataAdd.commissionPercentage = "0";
      }
    ...
    positiveIntegerValidation(item) {
      ...
      if (this.HotelDataAdd.adaptHighestPercent == "") {
        this.HotelDataAdd.adaptHighestPercent = "0";
      }
      if (this.HotelDataAdd.adaptLowestPercent == "") {
        this.HotelDataAdd.adaptLowestPercent = "0";
      }
      if (!positiveInteger.test(item)) {
        ...
        let result =
          this.HotelDataAdd.adaptHighestPercent -
          this.HotelDataAdd.adaptLowestPercent;
        if (result < 0) {
    ...
    moneyValidation(item) {
      ...
      if (this.HotelDataAdd.adaptHighestMoney == "") {
        this.HotelDataAdd.adaptHighestMoney = "0";
      }
      if (this.HotelDataAdd.adaptLowestMoney == "") {
        this.HotelDataAdd.adaptLowestMoney = "0";
      }
      if (!money.test(item)) {
        ...
        let result =
          this.HotelDataAdd.adaptHighestMoney -
          this.HotelDataAdd.adaptLowestMoney;
        if (result < 0) {
    ...
    submitForm(HotelDataAdd) {
      ...
      if (this.HotelDataAdd.isSupportRedPacket) {
        if (
          this.HotelDataAdd.redPacketRate == "" ||
          this.HotelDataAdd.minOrderAmount == ""
        ) {
          rpRate = "";
          moAmount = "";
        } else {
      ...
      if (this.HotelDataAdd.isSupportWelfareCab) {
        if (this.HotelDataAdd.welfareCabMinOrderAmt == "") {
          ...
          wcAmount = parseFloat(
            this.HotelDataAdd.welfareCabMinOrderAmt
          ).toFixed(2);
        }
      } else {
        wcAmount = "";
      ...
      this.$refs[HotelDataAdd].validate((valid) => {
        if (valid) {
          if (
            that.HotelDataAdd.selectProvince == "" ||
            that.HotelDataAdd.selectCity == "" ||
            that.HotelDataAdd.selectDistrict == ""
          ) {
          ...
          //   shippingFeeType = "";
          // } else {
          //   shippingFeeType = parseFloat(
          //     that.HotelDataAdd.hotelShippingFee
          //   ).toFixed(2);
          // }
          if (that.HotelDataAdd.isHprodTicket) {
            ...
            if (
              that.HotelDataAdd.hprodRate == "" ||
              that.HotelDataAdd.hprodRate == undefined
            ) {
              this.$message.error("请输入自营商品销售发票税率!");
              return false;
            }
            if (
              that.HotelDataAdd.hprodRate > 100 ||
              that.HotelDataAdd.hprodRate < 0
            ) {
          ...
          if (that.HotelDataAdd.isHroomTicket) {
            if (
              that.HotelDataAdd.roomRate == "" ||
              that.HotelDataAdd.roomRate == undefined
            ) {
              this.$message.error("请输入房费税率!");
              return false;
            }
            if (
              that.HotelDataAdd.roomRate > 100 ||
              that.HotelDataAdd.roomRate < 0
            ) {
          ...
          // }
          //外卖设置
          if (that.HotelDataAdd.isSupportTakeOutOrder) {
            if (
              that.HotelDataAdd.startPrice == "" ||
              that.HotelDataAdd.startMileage == "" ||
              that.HotelDataAdd.exceededMileagePrice == ""
            ) {
              this.$message.error("请输入运费起步价/起步里程/超出价!");
              return false;
            }
          } else {
            if (this.HotelDataAdd.startPrice == "") {
              this.HotelDataAdd.startPrice = 0;
            }
            if (this.HotelDataAdd.startMileage == "") {
              this.HotelDataAdd.startMileage = 0;
            }
            if (this.HotelDataAdd.exceededMileagePrice == "") {
              this.HotelDataAdd.exceededMileagePrice = 0;
            }
          }
          //最优弹性价

          if (that.HotelDataAdd.isSupportAdaptPrice) {
            if (
              !that.HotelDataAdd.isAdaptByPercentage &&
              !that.HotelDataAdd.isAdaptByMoney
            ) {
              this.$message.error("请选择弹性价方式!");
              return false;
            }
            if (that.HotelDataAdd.enterSettingId == "") {
              this.$message.error("请选择进场配置!");
              return false;
            }
            if (that.HotelDataAdd.isAdaptByPercentage) {
              if (that.HotelDataAdd.adaptLowestPercent == "") {
                this.$message.error("请输入加价百分比弹性范围初始值!");
                return false;
              }
              if (that.HotelDataAdd.adaptHighestPercent == "") {
                this.$message.error("请输入加价百分比弹性范围最大值!");
                return false;
              }
              if (
                !this.positiveIntegerValidation(
                  that.HotelDataAdd.adaptLowestPercent
                ) &&
                this.positiveIntegerValidation(
                  that.HotelDataAdd.adaptHighestPercent
                )
              ) {
                return false;
              }
            ...
            if (that.HotelDataAdd.isAdaptByMoney) {
              if (that.HotelDataAdd.adaptLowestMoney == "") {
                this.$message.error("请输入加价金额弹性范围初始值!");
                return false;
              }
              if (that.HotelDataAdd.adaptHighestMoney == "") {
                this.$message.error("请输入加价金额弹性范围最大值!");
                return false;
              }
              if (
                !this.moneyValidation(that.HotelDataAdd.adaptHighestMoney) &&
                this.moneyValidation(that.HotelDataAdd.adaptLowestMoney)
              ) {
                return false;
              }
            } else {
              that.HotelDataAdd.adaptLowestMoney == "";
              that.HotelDataAdd.adaptHighestMoney == "";
            }
            if (that.HotelDataAdd.commissionPercentage == "") {
              this.$message.error("请输入提成比例!");
              return false;
            }
          } else {
            that.HotelDataAdd.enterSettingId = "";
            that.HotelDataAdd.isAdaptByPercentage = false;
            that.HotelDataAdd.isAdaptByMoney = false;
            that.HotelDataAdd.adaptLowestPercent = "";
            that.HotelDataAdd.adaptHighestPercent = "";
            that.HotelDataAdd.adaptLowestMoney = "";
            that.HotelDataAdd.adaptHighestMoney = "";
            that.HotelDataAdd.commissionPercentage = "";
          }
          ...
          let params = {
            ...
            isSupportRedPacket: that.switchFunc(
              that.HotelDataAdd.isSupportRedPacket
            ),

            //最优弹性价
            isSupportAdaptPrice: that.switchFunc(
              that.HotelDataAdd.isSupportAdaptPrice
            ),
            enterSettingId: that.HotelDataAdd.enterSettingId,
            isAdaptByPercentage: that.switchFunc(
              that.HotelDataAdd.isAdaptByPercentage
            ),
            adaptLowestPercent: that.HotelDataAdd.adaptLowestPercent,
            adaptHighestPercent: that.HotelDataAdd.adaptHighestPercent,
            isAdaptByMoney: that.switchFunc(that.HotelDataAdd.isAdaptByMoney),
            adaptLowestMoney: that.HotelDataAdd.adaptLowestMoney,
            adaptHighestMoney: that.HotelDataAdd.adaptHighestMoney,
            commissionPercentage: that.HotelDataAdd.commissionPercentage,
            ...
            isSupportProdInvoice: that.switchFunc(
              that.HotelDataAdd.isHprodTicket
            ),
            ...
            isSupportRoomInvoice: that.switchFunc(
              that.HotelDataAdd.isHroomTicket
            ),
            roomInvoiceTaxRate: roomRateType,
            isShowInvoiceReminder: that.switchFunc(
              that.HotelDataAdd.isShowInvoiceReminder
            ),
            ...
            isSupportWelfareCab: that.switchFunc(
              that.HotelDataAdd.isSupportWelfareCab
            ),
            welfareCabMinOrderAmt: wcAmount,
            //外卖设置
            isSupportTakeOutOrder: that.switchFunc(
              that.HotelDataAdd.isSupportTakeOutOrder
            ),
            startPrice: parseFloat(that.HotelDataAdd.startPrice).toFixed(2),
            startMileage: parseFloat(that.HotelDataAdd.startMileage).toFixed(2),
