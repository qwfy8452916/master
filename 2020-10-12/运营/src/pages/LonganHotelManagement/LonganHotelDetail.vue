    ...
    >
      ...
      <el-form-item label="地址" prop="hotelAddress">
        <el-input
          ...
          :row="2"
          id="tipinput"
          v-model="HotelDataModify.hotelAddress"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="酒店主题" prop="hotelThemeId">
        ...
        <el-select
          :disabled="true"
          v-model="HotelDataModify.hotelThemeId"
          placeholder="请选择"
          @change="selectSkin"
        >
          <el-option
      ...
      <!-- <el-form-item label="政策信息" prop="policyInfo">
        <el-input
          ...
          :rows="10"
          maxlength="250"
          v-model="HotelDataModify.policyInfo"
        ></el-input>
      </el-form-item>-->
      <el-form-item>
        <span slot="label">
      ...
      <el-form-item label="支持外卖" prop="isSupportTakeOutOrder">
        <el-switch :disabled="true" v-model="HotelDataModify.isSupportTakeOutOrder"></el-switch>
      </el-form-item>
      <el-form-item v-if="HotelDataModify.isSupportTakeOutOrder" prop="startPrice">
        <span slot="label">
          <label class="required-icon">*</label> 运费起步价
        </span>
        <el-input :disabled="true" v-model.trim="HotelDataModify.startPrice" maxlength="10"></el-input>元
      </el-form-item>
      <el-form-item v-if="HotelDataModify.isSupportTakeOutOrder" prop="startMileage">
        <span slot="label">
          <label class="required-icon">*</label> 起步里程
        </span>
        <el-input :disabled="true" v-model.trim="HotelDataModify.startMileage" maxlength="10"></el-input>公里
      </el-form-item>
      <el-form-item v-if="HotelDataModify.isSupportTakeOutOrder" prop="exceededMileagePrice">
        ...
        <el-input
          :disabled="true"
          v-model.trim="HotelDataModify.exceededMileagePrice"
          maxlength="10"
        ></el-input>元/公里
      </el-form-item>
      ...
      <el-form-item label="最优弹性价开关" prop="isSupportAdaptPrice">
        <el-switch :disabled="true" v-model="HotelDataModify.isSupportAdaptPrice"></el-switch>
      </el-form-item>
      <div v-if="HotelDataModify.isSupportAdaptPrice">
        <el-form-item prop="enterSettingId">
          ...
          <el-select
            v-model="HotelDataModify.enterSettingId"
            :disabled="true"
            placeholder="请选择进场配置"
          >
            <el-option
        ...
        <el-form-item prop="flexiblePriceStyle">
          ...
          <el-checkbox v-model="HotelDataModify.isAdaptByPercentage" :disabled="true">
        ...
        <el-form-item label>
          <el-checkbox v-model="HotelDataModify.isAdaptByMoney" :disabled="true">
      ...
      <el-form-item v-if="HotelDataModify.isSupportWelfareCab" prop="welfareCabMinOrderAmt">
        ...
        <el-input
          :disabled="true"
          v-model.trim="HotelDataModify.welfareCabMinOrderAmt"
          maxlength="10"
        ></el-input>元
      </el-form-item>
      <el-form-item>
        ...
        this.$api
          ...
          .then((response) => {
            if (response.data.code == 0) {
              ...
              that
                .$alert(response.data.data.msg, "警告", {
