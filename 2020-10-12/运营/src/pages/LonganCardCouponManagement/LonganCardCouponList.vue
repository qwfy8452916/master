  ...
  <div class="CardCouponList">
    ...
    <el-table :data="cardData" border stripe>
      ...
      <el-table-column fixed="right" prop="id" label="操作" align="center" width="240px">
        <template slot-scope="scope">
          <el-button
            v-if="authzData['F:BO_VOU_CARDCOUPON_DETAIL']"
            type="text"
            @click="detailCard(scope.row.id)"
          >详情</el-button>
          <el-button
            v-if="authzData['F:BO_VOU_CARDCOUPON_DELAY'] && scope.row.isUsed===0"
            type="text"
          ...
          >查看订单</el-button>
          <el-button
            v-if="authzData['F:BO_VOU_CARDCOUPON_CHECKDETAIL'] && scope.row.isUsed===1"
            type="text"
    ...
    <el-dialog title="延长有效期" :visible.sync="datchdialog" width="30%">
      ...
      <span slot="footer">
        ...
        <el-button
          v-if="authzData['F:BO_VOU_CARDCOUPON_DELAY_SUBMIT']"
          type="primary"
