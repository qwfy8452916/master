      ...
      <div class="facilityadd">
        ...
        <el-table :data="BookTypeData.featureDTOS" :show-header="false" class="facilitytable">
          <el-table-column prop="orderFeature">
            <template slot-scope="scope">
              <el-form-item
                :prop="'featureDTOS.'+scope.$index+'.sort'"
                :rules="rules.orderFeature"
              >
                <el-input class="featureOrderBy" :disabled="true" placeholder="特色排序" v-model.number="scope.row.sort"></el-input>
                <el-button :disabled="true" type="text" size="small">删除</el-button>
              </el-form-item>
              <el-form-item
            ...
            this.imgList = [
              {
                ...
                path: result.data.layoutTraditionImageUrl,
              },
            ];
            this.descList = [
              {
                ...
                path: result.data.layoutBannerImageUrl,
              },
            ];
