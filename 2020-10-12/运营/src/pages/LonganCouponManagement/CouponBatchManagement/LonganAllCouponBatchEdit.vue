          ...
          <el-form-item label="组织类型" class="textinput">
            ...
            <el-form-item label="领取/发放限制">
               ...
               <el-form-item label="每人领取数量" style="margin-top:20px;" prop="drawCountPerUser">
                   <el-input :disabled="addCoupondata.canDraw!='1'" v-model="addCoupondata.drawCountPerUser" style="width:218px;margin-right:5px" maxlength="5"></el-input>张
               </el-form-item>
               ...
               <el-form-item label="发放总数量" style="margin-top:20px;" prop="giveCountTotal">
                   <el-input :disabled="addCoupondata.canGive!='1'" v-model="addCoupondata.giveCountTotal" style="width:218px;margin-right:5px" maxlength="5"></el-input>张
               </el-form-item>
               <el-form-item label="每人发放数量" style="margin-top:20px;" prop="giveCountPerUser">
                   <el-input :disabled="addCoupondata.canGive!='1'" v-model="addCoupondata.giveCountPerUser"  style="width:218px;margin-right:5px" maxlength="5"></el-input>张
               </el-form-item>
            </el-form-item>
