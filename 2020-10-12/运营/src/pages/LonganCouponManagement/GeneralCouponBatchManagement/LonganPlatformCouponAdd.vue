<template>
  <div class="PlatformCouponAdd">
    ...
    <el-form :model="addCoupondata" ref="addCoupondata" :rules="rules" label-width="130px" style="width:70%">
      ...
      <el-form-item label="酒店名称" prop="hotelRelationFlag">
        ...
        <div>
          ...
          <el-form-item v-if="addCoupondata.hotelRelationFlag=='3'" label="酒店名称" prop="hotelObj">
            <el-select
              v-model="addCoupondata.hotelObj"
              filterable
              remote
              :remote-method="remoteHotel"
              :loading="loadingH"
              @focus="getHotelList()"
              @change="selectOneHotel"
              value-key="id">
              <el-option v-for="item in hotelList" :key="item.id" :label="item.hotelName" :value="item"></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-form-item v-if="addCoupondata.discountWay == 2" prop="couponDiscount">
          ...
          <el-input v-model="addCoupondata.couponDiscount" maxlength="2" placeholder="请输入折扣" style="width:349px;margin-right:5px" oninput ="value=value.replace(/[^0-9]/g,'')"></el-input>%
      </el-form-item>
      <el-form-item v-if="addCoupondata.discountWay == 2" label="最高优惠金额" prop="discountMaxMoney">
          <el-input v-model="addCoupondata.discountMaxMoney" maxlength="12" placeholder="请输入最高优惠金额" style="width:349px;margin-right:5px" oninput ="value=value.replace(/[^0-9.]/g,'')"></el-input>元
      </el-form-item>
      <el-form-item v-if="addCoupondata.discountWay == 2" label="最低消费金额" prop="discountMinBuyMoney">
          <el-input v-model="addCoupondata.discountMinBuyMoney" maxlength="12" placeholder="请输入最低消费金额" style="width:349px;margin-right:5px" oninput ="value=value.replace(/[^0-9.]/g,'')"></el-input>元
      </el-form-item>
      ...
      <el-form-item label="使用有效期" prop="couponTermType">
        ...
        <div style="margin-top:10px;">
          ...
          <el-form-item v-if="addCoupondata.couponTermType=='1'" prop="couponTermDate" class="couponTermType">
            <el-date-picker
      ...
      <el-form-item label="领取/发放限制">
        ...
        <el-form-item prop="drawWays">
          ...
          <el-select v-model="addCoupondata.drawWays" :disabled="addCoupondata.canDraw!='1'" multiple collapse-tags>
            <el-option
      ...
      <el-form-item>
        ...
        <el-button v-if="authzData['F:BO_COUPON_CURRBATCH_ADDSUBMIT']" type="primary" @click="sureBtn('addCoupondata')">确 定</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    var ValiduseLimitMoney = (rule, value, callback) => {
      ...
      if (
        this.addCoupondata.useLimitMoney <= 0 ||
        this.addCoupondata.useLimitMoney == "" ||
        parseInt(this.addCoupondata.useLimitMoney) <
          parseInt(this.addCoupondata.reduceMoney)
      ) {
        // console.log("走");
    ...
    var ValidreduceMoney = (rule, value, callback) => {
      if (
        this.addCoupondata.reduceMoney <= 0 ||
  ...
  methods: {
    ...
    sondatamethod(e) {
      if (e.hoteldialogjudge == "noUseHotel") {
        ...
        this.addCoupondata.useFuncData[this.selectClassIndex].getTypeData =
          e.getTypedata;
        this.addCoupondata.useFuncData[this.selectClassIndex].categoryIds =
          e.getTypekey;
    ...
    selectClass(index, row) {
      ...
      //获取当前弹窗选中的分类id
      this.addCoupondata.checkedkeysData = this.addCoupondata.useFuncData[
        index
      ].categoryIds;
