<template>
  <div>
    ...
    <div>
      <el-button class="addbutton" @click="Cabinetgladd">新增</el-button>
    </div>
    <el-table :data="CabinetList" border stripe style="width:100%;">
      ...
      <el-table-column prop="cabinetStatus" label="状态" min-width="80px" align="center">
        <template slot-scope="scope">{{ scope.row.cabinetStatus=='1' ? "正常":"故障" }}</template>
      </el-table-column>
      ...
      <el-table-column fixed="right" label="操作" min-width="140px" align="center">
        <template slot-scope="scope">
          ...
          <el-button
            v-if="authzData['F:BO_CAB_CAB_EDIT']"
            type="text"
            size="small"
          ...
          <el-button
            type="text"
            size="small"
            @click="Cabinetgllook(scope.$index, CabinetList)"
          >查看二维码</el-button>
          <el-button
            type="text"
            v-if="authzData['F:BO_CAB_CAB_VIEW'] && scope.row.cabType!='02' && scope.row.isVisual!='1'"
            size="small"
            @click="Cabinetgllooks(scope.$index, CabinetList)"
          >查看商品信息</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    >
      <div class="imagelist">
        ...
        <div v-for="(item,index) in virtuaQrcodel" :key="index">
...
export default {
  ...
  methods: {
    ...
    //     //     console.log(imgs[i].getElementsByTagName('img'))
    //     //     console.log(imgs[i])
    //     // }
    //     console.log(imgs)
