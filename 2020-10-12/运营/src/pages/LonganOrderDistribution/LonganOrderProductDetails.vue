    ...
    <div class="platdeliverydetail">
        ...
        >
            ...
            <tr v-if="orderProdDataDetail.orderStatus == 2">
                ...
                <td class="subcont">{{orderProdDataDetail.cancelTime =='1970-01-01 00:00:00'?"":orderProdDataDetail.cancelTime}}</td>
            </tr>
            <tr>
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <span>{{scope.row.refundTime == '1970-01-01 00:00:00'?'':scope.row.refundTime}}</span>
                </template>
            </el-table-column>
            <el-table-column
                prop="returnTime"
            ...
            >
                <template slot-scope="scope">
                    <span>{{scope.row.returnTime == '1970-01-01 00:00:00'?'':scope.row.returnTime}}</span>
                </template>
            </el-table-column>
            <el-table-column
                prop="tipFee"
            ...
            >
                <div v-if="divideDetailData.orderType==1">
                    ...
                    <el-form-item label="减免金额">
                        <span>￥{{divideDetailData.orderDetailAllocBean.discountAmount}}</span>
                    </el-form-item>
