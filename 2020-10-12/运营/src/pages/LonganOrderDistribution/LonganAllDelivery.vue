  ...
  <div class="alldelivery">
    ...
    <el-table :data="alldelivery" border stripe style="width:100%;">
      ...
      <el-table-column fixed="right" label="操作" min-width="80px" align="center">
        <template slot-scope="scope">
          <!-- <el-button v-if="authzData['F:BO_DELIV_ALLSALEAPPLY_CHECKDETAIL']"  type="text" size="small" @click="Seeorder(scope.$index,alldelivery)">详情</el-button> -->
          <el-button
            v-if="authzData['F:BO_DELIV_ALLSALEAPPLY_CHECKDETAIL']"
            type="text"
            size="small"
            @click="Seeorder(scope.row.id)"
          >详情</el-button>
        </template>
      </el-table-column>
    </el-table>
