...
<template>
  <div class="LonganChoiceCabinet">
    ...
    <el-dialog title="选择柜子" :visible.sync="dislogVisibleRole" width="42%" class="userMangeDialog">
      <el-transfer
        filterable
        :data="cabDataList"
      ...
      <div slot="footer">
        ...
        <el-button
          v-if="authzData['F:BO_ALLY_MANAGECABINET_ADDSURE']"
          type="primary"
          @click="createSelectCabinet"
        >确 定</el-button>
      </div>
    </el-dialog>
  </div>
...
<style lang="less">
.seeordertitle .el-form-item__label {
  width: 100px;
}
.hangitem {
  .el-input__inner {
...
.LonganChoiceCabinet /deep/ .el-transfer-panel {
  text-align: left;
  width: 35% !important;
}
