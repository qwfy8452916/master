<template>
  <div>
    ...
    <el-table :data="CabinetList" border stripe style="width:100%;">
      ...
      <el-table-column prop="hotelRelationDTO.hotelName" label="酒店名称" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    addNewSetting() {
      this.$router.push({ name: "LonganFunctionLeadAdd" });
    },
    //修改
