<template>
  <div class="LonganHotelFunctionHouseResourceAdd">
    ...
    <el-form
      ...
      :rules="rules"
      ref="formdata"
      class="LonganHotelFunctionHouseResourceAddWid"
    >
...
export default {
  ...
  methods: {
    changeBookType() {
      ...
      this.houseResourceOptions = []; //房源名称options
    },
    changeHotel() {
      this.formdata.inquireFunctionName = "";
      this.formdata.inquireHouseRerource = "";
      this.formdata.inquireBookType = "";
      this.functionOptions = []; //功能区名称options
      this.houseResourceOptions = []; //房源名称options
      this.bookTypeOptions = []; //房型options
    },
    surebtn(formdata) {
      let that = this;
      this.$refs[formdata].validate((valid, model) => {
        if (valid) {
          let params = {
            sort: 0,
            hotelId: this.formdata.inquireHotelName,
...
.LonganHotelFunctionHouseResourceAdd {
  .LonganHotelFunctionHouseResourceAddWid {
    width: 60%;
  }
}
.sortForm {
