<template>
  <div class="LonganHotelFunctionHouseResourceDetail">
    ...
    <el-form
      ...
      :model="formdata"
      ref="formdata"
      class="LonganHotelFunctionHouseResourceDetailWid"
    >
...
.LonganHotelFunctionHouseResourceDetail {
  .LonganHotelFunctionHouseResourceDetailWid {
    width: 60%;
  }
}
.sortForm {
