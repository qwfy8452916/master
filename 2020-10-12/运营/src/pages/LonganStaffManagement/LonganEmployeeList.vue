<template>
    <div>
        ...
        <el-table :data="CabinetList" border stripe style="width:100%;" >
            ...
            <el-table-column  min-width="150" label="解绑时间" align=center>
                <template slot-scope="scope">
                    <span>{{scope.row.unlockTime == '1970-01-01 00:00:00'?'-':scope.row.unlockTime}}</span>
                </template>
            </el-table-column>
            <el-table-column fixed="right" min-width="150" label="操作" align=center>
                <template slot-scope="scope">
                    <el-button type="text" size="small" v-if="!scope.row.status" @click="unlock(scope.$index, CabinetList)">解绑</el-button>
                    <el-button type="text" size="small" v-else>-</el-button>
                    <el-button type="text" size="small" @click="viewShareRecord(scope.$index, CabinetList)">查看分享记录</el-button>
                </template>
            </el-table-column>
        </el-table>
