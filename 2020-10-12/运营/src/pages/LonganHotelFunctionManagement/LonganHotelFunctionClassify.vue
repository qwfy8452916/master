<template>
    <div class="functionclassify">
        <div v-if="authzData['F:BO_HOTEL_FUNCTION_CLASSIFY_ADD']" class="addlevelone"><el-button type="primary" @click="levelOneAdd">新增一级分类</el-button></div>
        <el-tree
            :data = "typeDataDetail"
            :props="defaultProps"
            node-key = 'id'
        ...
        <el-dialog title="新增一级分类" :visible.sync="dialogLevelOneVisible" width="30%">
            <el-form :model="levelOneData" :rules="rules" ref="levelOneData" label-width="100px" class="formclass">
                <el-form-item label="酒店名称">
                    <el-input :disabled="true" v-model="hotelName"></el-input>
                </el-form-item>
                ...
                <el-form-item label="分成协议" prop="allocId">
                    <el-select v-model="levelOneData.allocId" placeholder="请选择">
                        <el-option
        ...
        <el-dialog title="新增" :visible.sync="dialogAddVisible" width="30%">
            <el-form :model="SubclausesDataAdd" :rules="rules" ref="SubclausesDataAdd" label-width="100px" class="formclass">
                ...
                <el-form-item label="分成协议" prop="allocId">
                    <el-select v-model="SubclausesDataAdd.allocId" placeholder="请选择">
                        <el-option
                            v-for="item in protocolList" 
                            :key="item.id" 
                            :label="item.allocName" 
        ...
        <el-dialog title="修改" :visible.sync="dialogModifyVisible" width="30%">
            <el-form :model="SubclausesDataModify" :rules="rules" ref="SubclausesDataModify" label-width="100px" class="formclass">
                ...
                <el-form-item label="分成协议" prop="allocId">
                    <el-select v-model="SubclausesDataModify.allocId" placeholder="请选择">
                        <el-option
                            v-for="item in protocolList" 
                            :key="item.id" 
                            :label="item.allocName" 
