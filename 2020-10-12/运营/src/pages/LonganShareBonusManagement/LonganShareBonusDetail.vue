    ...
    <div class="hoteladd">
        ...
        <el-form :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item label="板块类型：" prop="modelType">
                <el-select :disabled="true" @change="changeModel" v-model="Commoditygai.modelType" placeholder="请选择板块类型">
            ...
            <el-form-item label="板块：" prop="modelId">
                <el-select :disabled="true" @change="clearShareObj" v-model="Commoditygai.modelId" placeholder="请选择板块">
            ...
            <el-form-item label="分享类型：" prop="shareType">
                <el-select :disabled="true" @change="clearShareObj" v-model="Commoditygai.shareType" placeholder="请选择分享类型">
                ...
                :loading="loading">
                    <div v-if="Commoditygai.shareType == 2 && Commoditygai.modelType == 1">
                        ...
                        :label="group.categoryName">
                            <el-option
                                v-for="item in group.prods"   
                                :key="item.funcProdId"
                                :label="item.prodName"
                                :value="item.funcProdId">
                            </el-option>
                        </el-option-group>
                    </div>
            ...
            <el-form-item label="指定奖励：" prop="bonusSettingType">
                <el-radio-group :disabled="true" v-model="Commoditygai.bonusSettingType">
            ...
            <el-form-item v-if="Commoditygai.bonusSettingType == 1" label="分享奖励来源：" prop="bonusAmountFrom">
                <el-select :disabled="true" v-model="Commoditygai.bonusAmountFrom" placeholder="请选择分享类型">
            ...
            <el-form-item v-if="Commoditygai.bonusSettingType == 1" label="分享奖励类型" prop="bonusType">
                <el-radio-group :disabled="true" @change="Commoditygai.firstBonus='';Commoditygai.secBounus='';" v-model="Commoditygai.bonusType">
                    <div style="margin-bottom:20px;margin-top:10px;">
                        ...
                        <el-form-item v-if="Commoditygai.bonusType == 1" style="height:60px;" label="计算基准" prop="bonusBaselineType">
                            <el-select :disabled="true" v-model="Commoditygai.bonusBaselineType" placeholder="请选择计算基准">
                        ...
                        <el-form-item v-if="Commoditygai.bonusType == 1" style="height:60px;" label="分享奖励" prop="firstBonus">
                            <el-input :disabled="true" style="width:140px;" v-model.trim="Commoditygai.firstBonus"></el-input><span>&nbsp;%</span>
                        </el-form-item>
                        <el-form-item v-if="Commoditygai.bonusType == 1" style="height:60px;" label="管理奖励" prop="secBounus">
                            <el-input :disabled="true" style="width:140px;" v-model.trim="Commoditygai.secBounus"></el-input><span>&nbsp;%</span>
                        </el-form-item>
                    </div>
                    <div>
                        ...
                        <el-form-item v-if="Commoditygai.bonusType == 2" style="height:60px;" label="分享奖励" prop="firstBonus">
                            <el-input :disabled="true" style="width:140px;" v-model.trim="Commoditygai.firstBonus"></el-input><span>&nbsp;元</span>
                        </el-form-item>
                        <el-form-item v-if="Commoditygai.bonusType == 2" style="height:60px;" label="管理奖励" prop="secBounus">
                            <el-input :disabled="true" style="width:140px;" v-model.trim="Commoditygai.secBounus"></el-input><span>&nbsp;元</span>
                        </el-form-item>
                    </div>
                </el-radio-group>
            </el-form-item>
            ...
            <el-form-item label="转发开关：" prop="shareFlag">
                <el-switch :disabled="true" v-model="Commoditygai.shareFlag"></el-switch>
            </el-form-item>
            <el-form-item label="转发提示：" prop="shareMsg">
                <el-input :disabled="true" style="width:300px" maxlength="50" v-model="Commoditygai.shareMsg" type="textarea"></el-input>
            </el-form-item>
            <el-form-item label="转发预览：" prop="shareImgType">
                <el-radio-group :disabled="true" v-model="Commoditygai.shareImgType">
            ...
            <el-form-item label="海报开关：" prop="posterFlag">
                <el-switch :disabled="true" v-model="Commoditygai.posterFlag"></el-switch>
            </el-form-item>
            ...
            <el-form-item label="二维码：" prop="posterQr">
                <div>
                    <span>位置：</span>
                    <span>X轴：<el-input style="width:120px" :disabled="true" v-model="Commoditygai.posterQrX" placeholder="请填写二维码X轴位置"></el-input></span>
                    <span>Y轴：<el-input style="width:120px" :disabled="true" v-model="Commoditygai.posterQrY" placeholder="请填写二维码Y轴位置"></el-input></span>
                </div>
                <div>
                    <span>尺寸：<el-input style="width:120px" :disabled="true" v-model="Commoditygai.posterQrPx" placeholder="请填写二维码尺寸"></el-input></span>
                </div>
                <el-checkbox :disabled="true" v-model="Commoditygai.posterQrBtFlag" label="二维码区域覆盖图片背景"></el-checkbox>
            </el-form-item>
            <el-form-item>
    ...
    data(){
        ...
        return{
            ...
            rules: {
                ...
                posterImgPath: [{required: true, message: '请上传海报模板', trigger: 'change'}],
        ...
        getFillBackData(){
            ...
            this.$api.selHotelShareArea(this.modelID).then(response => {
                if(response.data.code == 0){
                    ...
                    this.Commoditygai.enterSettingId = response.data.data.enterSettingId?'':response.data.data.enterSettingId;
