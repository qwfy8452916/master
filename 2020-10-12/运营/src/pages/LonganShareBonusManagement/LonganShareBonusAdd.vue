    ...
    <div class="hoteladd">
        ...
        <el-form :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item label="进场配置：" prop="enterSetting">
                <el-select
                    v-model="Commoditygai.enterSetting"
                    @focus="getenterSettingList()"
                    placeholder="请选择进场配置">
                    <el-option
    ...
    methods: {
        ...
        submitForm(Commoditygai) {
            let params = {
                ...
                enterSettingId:this.Commoditygai.enterSetting
            }
            if(params.shareFlag){
            ...
            this.$refs[Commoditygai].validate((valid) => {
                if (valid) {
                    this.$api.addHotelShareArea(params)
                        .then(response => {
                            if(response.data.code==0){
