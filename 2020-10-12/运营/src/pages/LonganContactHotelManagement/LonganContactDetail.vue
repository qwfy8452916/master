...
<template>
  <div class="CabTypeListAdd">
     ...
     <el-form align="left" :disabled="true" :model="addLinkData" label-width="120px" :rules="rules" ref="addLinkData">
        ...
        <el-form-item label="关联酒店" prop="relateHotelId">
            <el-select
                :disabled="true"
                filterable
                remote
        ...
        <el-form-item label="描述文本" label-width="120px" prop="description">
           <el-input type="textarea" v-model="addLinkData.description" maxlength="255"></el-input>
        </el-form-item>
...
<script>
  export default{
    ...
    data(){
      ...
      return {
         ...
         rules:{
            ...
            description:[{required:true,message:"请填写文本描述",trigger:"blur"}],
    ...
    mounted(){
      ...
      this.addLinkData.hotelId = this.$route.query.hotelId;
      this.addLinkData.relateHotelId = this.$route.query.relateHotelId;
