<template>
  <div class="HotelLogistics">
    ...
    <div class="alignleft">
      <el-button class="addbutton" @click="addBtn">新&nbsp;&nbsp;增</el-button>
    </div>
    <el-table :data="hotelLogisticsData" border stripe style="width:100%;">
      <el-table-column fixed prop="hotelName" label="酒店名称" min-width="200px"></el-table-column>
      <el-table-column prop="lgcName" label="外部物流" min-width="140px"></el-table-column>
      ...
      <el-table-column prop="storeCode" label="门店编码" min-width="100px" align="center"></el-table-column>
      <el-table-column prop="cityCode" label="城市代码" min-width="80px" align="center"></el-table-column>
      <el-table-column prop="orderProdType" label="订单商品类型" min-width="120px" align="center"></el-table-column>
      <el-table-column fixed="right" prop="id" label="操作" min-width="140px" align="center">
        <template slot-scope="scope">
