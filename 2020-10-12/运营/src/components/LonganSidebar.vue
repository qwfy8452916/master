  ...
  methods: {
    ...
    sidebarLink(index) {
      ...
      if (index == "1-1") {
        ...
        this.$router.push({ name: "LonganContactHotelList" });
      } else if (index == "2-11") {
        ...
        this.$router.push({ name: "LonganBookResourceList" });
      } else if (index == "25-2") {
        ...
        this.$router.push({ name: "LonganBookTypeList" });
      } else if (index == "26-1") {
        ...
        this.$router.push({ name: "LonganCouponSendRecord" });
      } else if (index == "31-5") {
        ...
        this.$router.push({ name: "LonganReportOrderAll" });
      } else if (index == "34-1") {
        this.$router.push({ name: "LonganActivityList" });
      } else if (index == "35-1") {
        this.$router.push({ name: "LonganRedPackList" });
      } else if (index == "35-2") {
        this.$router.push({ name: "LonganRedPackTotal" });
      } else if (index == "35-3") {
        this.$router.push({ name: "LonganRedPackHotelTotal" });
      } else if (index == "35-4") {
        this.$router.push({ name: "LonganActivityMeetingRecords" });
      } else if (index == "35-5") {
        this.$router.push({ name: "LonganActivityScanRecord" });
      } else if (index == "36-1") {
        ...
        this.$router.push({ name: "LonganCustomerOrder" });
      } else if (index == "40-1") {
        ...
        this.$router.push({ name: "LonganHotelFunctionHouseResourceList" });
      } else if (index == "45-1") {
        this.$router.push({ name: "LonganEnterprisesList" });
      } else if (index == "45-2") {
        this.$router.push({ name: "LonganEnterprisesRoomsList" });
      } else if (index == "45-3") {
        this.$router.push({ name: "LonganEnterprisesCodeList" });
      } else if (index == "45-4") {
        this.$router.push({ name: "LonganEnterprisesCodeOrderList" });
      } else if (index == "45-5") {
        this.$router.push({ name: "LonganAdaptPriceList" });
      } else if (index == "45-6") {
        this.$router.push({ name: "LonganAdaptPriceOrderList" });
      }
    },
    //获取权限信息
                ...
                },*/
        {
          ...
          items: [
            ...
            },
            {
              ...
              pathindex: "30-6",
              status: false,
              Permission: "M:BO_MSG_MARKETINGSMS", //
            },
          ],
        },
        {
