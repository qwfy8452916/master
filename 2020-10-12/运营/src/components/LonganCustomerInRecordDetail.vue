<template>
    <div class="CustomerInRecordDetail">
...
export default {
    ...
    methods: {
       ...
       //取消
      cancelbtn(){
       this.$router.push({name:'LonganCustomerIncomeRecord'})
      },

      //更新数据
       Getdata(){
            let that=this;
            this.$api.inRecordDetail(that.detailId,2).then(response=>{
