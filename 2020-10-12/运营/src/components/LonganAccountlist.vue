<template>
    <div class="Accountlist">
        ...
        <el-table :data="AccountlistDataList" border stripe >
            ...
            <el-table-column prop="withdrawMayAmount" label="余额(元)" align=center></el-table-column>
            ...
            <el-table-column label="操作" align=center fixed="right">
               <template slot-scope="scope">
                    ...
                    <el-button v-if="authzData['F:BO_FIN_ACCOUNT_CHECKGETCASH']" type="text" size="small" @click="carrydetail(scope.row.id,scope.row.orgId)">提现明细</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        ...
        Accountlist(){
            const params = {
                ...
                oprId:this.oprId,
                accountStatus:this.query.handlestatus,
            };
            this.$api.getaccount({params}).then(response=>{
