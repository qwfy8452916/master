...
const api = {
    ...
    */
    ...
    singlehotelprod(params) {
        ...
        return axios.get('/longan/api/prod/hotel/product/prodCode', params);
    },
    ...
    */
    ...
    //接收人类型
    receiveType() {
        return axios.get('/longan/api/message/template/userType')
    },
    //消息状态
    getMessageStatus() {
        return axios.get('/longan/api/message/template/msgStatus')
    },
    //模板状态
    templateStatus() {
        return axios.get('/longan/api/message/template/templateStatus')
    },
    //消息模板所有者类型
    ownerMessageType() {
        return axios.get('/longan/api/message/template/ownerType')
    },
    //查询组织营销短信发送记录
    smsrecord(params) {
        return axios.get('/longan/api/msg/sms/record', params)
    },
    //查看营销短信发送记录详情
    smsrecordDetail(id) {
    ...
    //终端列表
    terminalList() {
        return axios.get('/longan/api/message/template/terminal')
    },
    //订阅类型
    subscribeType() {
        return axios.get('/longan/api/message/template/subscribeType')
    },
    //创建运费模板
    ...
    //分享统计
    shareRedpackTotal(params) {
        return axios.get('/longan/api/act/redPacket/census', params)
    },
    //酒店分享统计
