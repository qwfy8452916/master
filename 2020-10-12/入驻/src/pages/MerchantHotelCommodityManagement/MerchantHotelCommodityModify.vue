    ...
    <div class="commodityadd">
        ...
        <el-form :model="CommodityDataModify" :rules="rules" ref="CommodityDataModify" label-width="140px" class="commodityform">
            <el-form-item label="酒店" prop="hotelId">
                <el-select :disabled="true" v-model="CommodityDataModify.hotelId" placeholder="请选择">
                    <el-option
            ...
            <el-form-item label="保质期" prop="prodWarrantyPeriod">
                ...
                <el-input :disabled="true" v-model="CommodityDataModify.prodWarrantyPeriod"></el-input>
            </el-form-item>
            ...
            <!-- <el-form-item label="建议零售价" prop="prodAdvisePrice">
                <el-input :disabled="true" v-model.trim="CommodityDataModify.prodAdvisePrice" maxlength="10"></el-input> 元
            </el-form-item> -->
            ...
            <el-form-item label="配送方式" prop="delivWays">
                <!-- <el-checkbox-group :disabled="isAbleModify" v-model="CommodityDataModify.delivWays" @change="selectDelivType">
                    <el-checkbox label="1">现场送</el-checkbox>
                    <el-checkbox label="2">快递送</el-checkbox>
                </el-checkbox-group> -->
                <el-select :disabled="isAbleModify" v-model="CommodityDataModify.delivWays" multiple placeholder="请选择" @change="selectDelivType">
            ...
            <el-form-item label="商品销售发票税率">
                <el-select
                    v-model="CommodityDataModify.prodInvoiceTaxRateId"
                    filterable
                    remote
                    ...
                    <el-table-column>
                        <template slot-scope="scope">
                            <el-form-item :prop="'functionData.'+scope.$index+'.funcId'" :rules="rules.funcId">
                                ...
                                <el-button type="text" size="small" @click="deleteFuncLine(scope.$index)">删除</el-button>
                            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BM_PROD_HOTELPRODUCTEDIT_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('CommodityDataModify')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    data(){
        ...
        return {
            ...
            rules: {
                ...
                prodShowName: [
                    {min: 0, max: 50, message: '显示名称请保持在50个字符以内', trigger: ['blur','change']}
                ],
                prodType: [
    ...
    methods: {
        ...
        getFunctionList(){
            ...
            let nowdelivWays=this.CommodityDataModify.delivWays;
            if(nowdelivWays!=null){
               nowdelivWays=nowdelivWays.toString()
            }else{
              nowdelivWays=""
            }
            ...
            this.$api.invoiceRateList(params)
                .then(response => {
                    ...
                    if(result.code == 0){
                        ...
                        this.invoiceRateList.push(rateNo);
                    }else{
                        this.$message.error(result.msg);
                    }
                })
            ...
            this.$api.hotelCommodityDetail(params, id)
                .then(response => {
                    ...
                    if(result.code == '0'){
                        ...
                        // }
                        // this.selectMarketData = treeNameArr;
                        if(result.data.prodLogoUrl != null){
                            this.imgList = [{
                        ...
                        this.CommodityDataModify = {
                            ...
                            prodWarrantyPeriod: result.data.prodProductDTO.prodWarrantyPeriod,
                            ...
                            prodInvoiceTaxRateId: result.data.prodInvoiceTaxRateId,
                        },
                        this.getHotelCouponList();
                        this.getProdCouponList();
                        // this.CommodityDataModify = result.data;
                        // this.CommodityDataModify.prodSupplName = result.data.prodProductDTO.prodSupplName;
                        // this.CommodityDataModify.prodWarrantyPeriod = result.data.prodProductDTO.prodWarrantyPeriod;
                        // this.CommodityDataModify.prodUnitMeasure = result.data.prodProductDTO.prodUnitMeasure;
                        this.commodityName = result.data.prodProductDTO.prodName;
                        this.commodityCode = result.data.prodProductDTO.prodCode;
                        this.prodId = result.data.prodProductDTO.id;
                        ...
                        // this.getHotelMarketDetail(result.data.hotelId);
                        this.isDisableDelivWay(result.data.hotelId, result.data.id);
                        this.getFunctionList();
                    }else{
                        this.$message.error('酒店商品获取失败！');
                    }
                })
                .catch(error => {
                    this.$alert(error,"警告",{
            ...
            this.$refs[CommodityDataModify].validate((valid) => {
                if (valid) {
                    ...
                    const params = {
                        ...
                        prodWarrantyPeriod: this.CommodityDataModify.prodWarrantyPeriod,
                        ...
                        prodInvoiceTaxRateId: this.CommodityDataModify.prodInvoiceTaxRateId,
