   ...
   <div class="AllCouponGroupAdd">
      ...
      <el-form :model="groupdata" :rules="rules" ref="groupdata" label-width="140px" class="groupform">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BM_COUPON_MERGROUP_ADDSUBMIT']" type="primary" @click="sureBtn('groupdata')">确 定</el-button>
            </el-form-item>
            ...
            if(valid){
               this.$api.addCouponGroup(params).then(response=>{
                  if(response.data.code=='0'){
                    ...
                    that.$router.push({name:"MerchantProdCouponGroup"})
                  }else{
