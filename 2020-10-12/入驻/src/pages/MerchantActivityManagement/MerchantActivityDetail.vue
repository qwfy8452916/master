<template>
    <div class="hoteladd">
        ...
        <el-form :disabled="true" :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            <el-form-item label="ID：" prop="activityName">
                <el-input v-model="Commoditygai.id"></el-input>
            </el-form-item>
            <el-form-item label="状态：" prop="activityName">
                <el-input v-model="Commoditygai.status"></el-input>
            </el-form-item>
            <el-form-item label="活动名称：" prop="activityName">
                <el-input v-model="Commoditygai.activityName" placeholder="请输入活动名称"></el-input>
            </el-form-item>
...
当设置为“每X月”时，例如每1月，指这个月的月初到月末任何时间都可以参加。下个月仍旧是从月初到月末计算参与时间。">
            ...
            <el-form-item label="级别：" prop="grade">
                <el-select v-model="Commoditygai.grade" placeholder="选择活动类型后显示">
            ...
            <el-form-item label="所属组织：" prop="activityName">
                <el-input v-model="Commoditygai.actOrgName"></el-input>
            </el-form-item>
            ...
            <el-form-item label="创建人：" prop="activityName">
                <el-input v-model="Commoditygai.createdBy" placeholder="请输入活动名称"></el-input>
            </el-form-item>
            <el-form-item label="创建时间：" prop="activityName">
                <el-input v-model="Commoditygai.createdAt" placeholder="请输入活动名称"></el-input>
            </el-form-item>
        </el-form>
            ...
            this.$api.selectActivityOne(this.actID).then(response => {
                if(response.data.code == 0){
                    that.Commoditygai = {
                        ...
                        status: response.data.data.status?'已启用':'未启用',
                        ...
                        ifALlHotel:response.data.data.allHotelFlag,
                        hotelList:response.data.data.actHotelDTOS.map(item => {
                            return {
                                id:item.hotelId,
                    ...
                    this.$api.changeActivityOne(params,this.actID)
                        .then(response => {
                            if(response.data.code==0){
                               ...
                               this.$router.push({name:'MerchantActivityList'});
                            }else{
                               this.$alert(response.data.msg,"警告",{
                                    confirmButtonText: "确定"
                               })
