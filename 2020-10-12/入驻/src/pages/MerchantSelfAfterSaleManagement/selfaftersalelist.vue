  ...
  <div class="aftersaleapplylist">
    ...
    <el-table :data="aftersaleapplylistDataList" border stripe style="width:100%;">
      ...
      <el-table-column label="操作" width="120px" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            type="text"
            v-if="scope.row.status==1 && authzData['F:BM_CS_AFTERSALEDEAL']"
            size="small"
            @click="handle(scope.$index, aftersaleapplylistDataList)"
          >处理</el-button>
          <el-button
            v-if="authzData['F:BM_CS_AFTERSALECHECK']"
            type="text"
            size="small"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          v-if="authzData['F:BM_CS_AFTERSALEDEALREFUSE']"
          type="primary"
          @click="retreatrefuse"
        >拒 绝</el-button>
        <el-button
          v-if="authzData['F:BM_CS_AFTERSALEDEALPASS']"
          type="primary"
          @click="retreatadopt"
        >通 过</el-button>
      </div>
