<template>
  <div class="hoteladd">
    ...
    >
      ...
      <el-form-item>
        <span slot="label">
          <label class="titlebar">账户信息</label>
        </span>
      </el-form-item>
      <hr class="line" />
      ...
      <el-form-item>
        <span slot="label">
          <label class="titlebar">英文版</label>
        </span>
      </el-form-item>
      <hr class="line" />
      ...
      <el-form-item>
        ...
        <el-button
          v-if="authzlist['F:BH_HOTEL_HOTELINFO_SUBMIT']"
          type="primary"
        ...
        if (valid) {
          ...
          this.$api
            ...
            .then((response) => {
              // console.log(response);
              if (response.data.code == "0") {
                const hotelIsSupportTakeOutOrder = that.switchFunc(
                  that.HotelDataModify.isSupportTakeOutOrder
                );
