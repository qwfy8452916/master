<template>
  <div class="HotelFunctionHouseResourceEdit">
    ...
    <el-form
      ...
      :rules="rules"
      ref="formdata"
      class="HotelFunctionHouseResourceEditWid"
    >
      ...
      <el-form-item>
        ...
        <!-- <el-button
          v-if="authzData['F:BO_HOTEL_SELTTAKING_ADDSUBMIT']"
          type="primary"
          :disabled="isSubmit"
...
export default {
  ...
  computed: {
    newName() {
      return this.formdata.inquireBookType;
    },
  },
  watch: {
    newName(val) {
...
.HotelFunctionHouseResourceEdit {
  .HotelFunctionHouseResourceEditWid {
    width: 60%;
  }
}
.sortForm {
