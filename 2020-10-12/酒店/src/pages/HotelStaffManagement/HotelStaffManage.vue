<template>
  <div class="customerlist">
    ...
    <el-table :data="staffDataList" border stripe style="width:100%;">
      ...
      <el-table-column prop="account" label="员工账号" min-width="180px" align="center"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.hotelOrgId = localStorage.getItem("orgId");
  ...
  methods: {
    ...
    funStaffManageDetail(id) {
      this.$router.push({ name: "HotelStaffManageDetail", query: { id } });
    },
    //员工下级
    funEmployeeList(id) {
      this.$router.push({ name: "HotelEmployeeList", query: { id }  });
    },
    //分享记录
    funSharelist() {
