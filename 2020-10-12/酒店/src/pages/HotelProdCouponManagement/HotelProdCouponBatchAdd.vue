<template>
    <div class="ProdCouponBatchAdd">
         ...
         <el-form label-width="130px" style="width:70%" :model="addCoupondata" ref="addCoupondata" :rules="rules">
            ...
            <el-form-item v-if="addCoupondata.couponRange == 1" label="板块" prop="funcRelationFlag">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_COUPON_HOTELBATCH_ADDSUBMIT']" type="primary" @click="sureBtn('addCoupondata')">确 定</el-button>
            </el-form-item>
         </el-form>
...
<script>
import coupondialog from './HotelCoupondia'
export default {
    ...
    mounted(){
      ...
      this.addCoupondata.singleHotelId=localStorage.hotelId;
      this.getsceneList();
    ...
    methods:{
        //获取数据
        sondatamethod(e){
         if(e.functdialogjudge=='UseFunct'){
