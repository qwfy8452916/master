    ...
    <div class="hotelserviceadd">
        ...
        <el-form :model="HotelServiceTypeData" :rules="rules" ref="HotelServiceTypeData" label-width="120px" class="hotelservicetypeform">
            ...
            <el-form-item label="提交成功提示语" prop="prompt">
                <el-input type="textarea" :rows="3" style="width: 400px" v-model="HotelServiceTypeData.prompt"></el-input>
                <el-popover
            ...
            <el-form-item>
                ...
                <el-button v-if="authzlist['F:BH_RMSVC_SERVICELISTADDSUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('HotelServiceTypeData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        serviceTypeList(){
            const params = {
                excludeWithHotelId: this.hotelId
            };
            // console.log(params);
            this.$api.serviceTypeList(params)
                .then(response => {
