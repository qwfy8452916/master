    ...
    <div class="hoteladd">
        ...
        <el-form :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item label="类型" prop="isVisual">
                <el-select v-model="Commoditygai.isVisual" placeholder="请选择" >
                    <el-option label="实体柜" :disabled="true" value="0"></el-option>
                    <el-option label="虚拟码" value="1"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="进场配置" prop="enterSettingId">
                <el-select
                    v-model="Commoditygai.enterSettingId"
                    filterable
                    remote
                    @focus="getCabinetConfig()"
                    placeholder="请选择">
                    <el-option
            ...
            <el-form-item v-if="Commoditygai.bindAreaFlag != 0" prop="roomCode">
                ...
                <el-input v-if="Commoditygai.isVisual=='0'" disabled v-model.trim="Commoditygai.roomCode" maxlength="10"></el-input>
            ...
            <el-form-item label="不间断电源" prop="roomCode">
            ...
            <el-form-item label="WiFi名称" prop="wifiSsid">
                <el-input maxlength="30" v-model.trim="Commoditygai.wifiSsid"></el-input>
            </el-form-item>
            <el-form-item label="WiFi密码" prop="wifiPassword">
                <el-input maxlength="30" v-model.trim="Commoditygai.wifiPassword"></el-input>
            </el-form-item>
...
export default {
    ...
    mounted(){
        this.Commoditygai.hotelId = localStorage.getItem('hotelId')
        this.getHotelList()
        // this.Getdata();
    ...
    methods: {
        ...
        submitForm(Commoditygai) {
            ...
            let params = {
                ...
                remark:that.Commoditygai.remark,
                // lastUpdatedAt:"",
                // lastUpdatedBy:"",
                // isNeedRepair:0,
            ...
            this.$refs[Commoditygai].validate((valid) => {
                if (valid) {
                    ...
                    this.$api.addVirtualCabinet(params)
                        .then(response => {
