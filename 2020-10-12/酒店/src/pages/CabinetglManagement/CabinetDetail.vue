<template>
    <div class="hoteladd">
        ...
        <el-form disabled :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item v-if="Commoditygai.bindAreaFlag != 0" prop="roomFloor">
                ...
                <el-input v-model.trim="Commoditygai.roomFloor" maxlength="32"></el-input>
            </el-form-item>
            <el-form-item v-if="Commoditygai.bindAreaFlag != 0" prop="roomCode">
                ...
                <el-input v-if="Commoditygai.isVisual=='0'" disabled v-model.trim="Commoditygai.roomCode" maxlength="32"></el-input>
                <el-input v-else v-model.trim="Commoditygai.roomCode" maxlength="32"></el-input>
            </el-form-item>
            ...
            <el-form-item label="操作人" prop="remark">
                <el-input maxlength="50" v-model="Commoditygai.createdByName"></el-input>
            </el-form-item>
            <el-form-item label="操作时间" prop="remark">
                <el-input maxlength="50" v-model="Commoditygai.lastUpdatedAt"></el-input>
            </el-form-item>
        </el-form>
