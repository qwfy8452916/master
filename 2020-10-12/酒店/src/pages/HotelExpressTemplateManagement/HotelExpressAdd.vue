        ...
        <el-form :model="Commoditygai" :rules="rules" ref="Commoditygai" label-width="140px" class="hotelform">
            ...
            <el-form-item label="运费设置：" v-show="!ifFree">
                <div class="expressFee">
                    ...
                    <el-button v-if="authzData['F:BH_PROD_EXPRESSTPL_ADD_ASSIGN']" type="primary" @click="addNewModel">为指定地区城市设置运费</el-button>
                </div>
                <div class="freeFee">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_PROD_EXPRESSTPL_ADD_SUBMIT']" type="primary" @click="submitForm('Commoditygai')">确定</el-button>
            </el-form-item>
        </el-form>
        <el-dialog 
    ...
    methods:{
        ...
        submitForm(Commoditygai) {
            ...
            this.$refs[Commoditygai].validate((valid) => {
                if (valid) {
                    this.$api.createExpressFee(params)
                        .then(response => {
