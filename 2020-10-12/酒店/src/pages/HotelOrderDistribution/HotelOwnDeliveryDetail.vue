  ...
  <div class="platdeliverydetail">
    ...
    >
      ...
      <tr>
        ...
        <td class="subcont">{{deliveryDateDetail.payTime=='1970-01-01 00:00:00'?"":deliveryDateDetail.payTime}}</td>
      </tr>
      <tr>
        <td class="subTitle">支付时间</td>
        <td class="subcont">{{deliveryDateDetail.payCompleteTime=='1970-01-01 00:00:00'?"":deliveryDateDetail.payCompleteTime}}</td>
      </tr>
    ...
    <el-table
      :data="deliveryDateDetail.orderDeliveryDetailDTOList"
      border
      style="width:88%;"
    >
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            type="text"
            size="small"
            :disabled="deliveryDateDetail.orderStatus==0?true:false"
    ...
    <el-button
      type="primary"
      v-if="deliveryDateDetail.status == 0 && authzlist['F:BH_DELIV_OWNDELIVERYLIST_DETAILSUBMIT']"
      @click="ensurePlatDelivery"
    >确认</el-button>
    <el-button
      type="primary"
      v-if="deliveryDateDetail.delivWay == 2 && deliveryDateDetail.status == 1 &&  authzlist['F:BH_DELIV_OWNDELIVERYLIST_DETAILSHIP']"
      @click="shipmentsPlatDelivery"
    >发货</el-button>
    <el-button
      type="primary"
      v-if="deliveryDateDetail.status == 2 && deliveryDateDetail.lgcStatus == 5"
      @click="againShipmentsDelivery"
    >重新发单</el-button>
    <el-button
      type="primary"
      v-if="deliveryDateDetail.lgcHotelId != 0 && deliveryDateDetail.lgcStatus != 4 && deliveryDateDetail.status != 0 && deliveryDateDetail.status != 1"
      @click="updateLgcStatus"
    >更新状态</el-button>
