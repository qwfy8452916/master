    ...
    <div class="platdeliverydetail">
        ...
        >
            <tr>
                ...
                <td class="subcont">
                    ...
                    <span v-else-if="deliveryDateDetail.status == 6">已取消</span>
                </td>
            </tr>
            <tr>
        ...
        >
            ...
            <tr>
                ...
                <td
                    class="subcont"
                    v-if="deliveryDateDetail.payChannelFee"
                >{{deliveryDateDetail.payChannelFee.toFixed(2)}}</td>
            </tr>
        </table>
        <el-table
            v-if="deliveryType != 1"
        ...
        <el-button
            type="primary"
            v-if="deliveryDateDetail.status == 0 && authzlist['F:BH_DELIV_SERVICEDELIVERYLIST_DETAILSUBMIT']"
