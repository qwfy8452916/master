    ...
    <div class="platdeliverydetail">
        ...
        >
            ...
            <tr>
                ...
                <td class="subcont">{{deliveryDateDetail.payChannelFee.toFixed(2)}}</td>
            </tr>
        </table>
        <el-table
            v-if="deliveryType == 0"
...
<template>
    <div class="guestminidelidetail">
        ...
        <table v-if="typejudge=='1'">
          ...
          <tr>
            <td>地点</td><td>{{waitorderdetail.cabDelivDetail.roomCode}}</td>
          </tr>
          <tr>
        ...
        <table v-else-if="typejudge=='2'">
          ...
          <tr>
            <td>地点</td><td>{{waitorderdetail.rmsvcDelivDetail.roomCode}}</td>
          </tr>
