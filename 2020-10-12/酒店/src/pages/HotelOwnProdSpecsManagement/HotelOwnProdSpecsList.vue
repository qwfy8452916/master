<template>
  <div class="commodityadd">
    <el-form
      :model="CommodityDataModify"
      :rules="rules"
      ref="CommodityDataModify"
      label-width="120px"
      class="commodityform"
    >
      <el-form-item
      ...
      >
        <el-input
          :disabled="true"
          v-model="CommodityDataModify.prodName"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="显示名称"
      ...
      >
        <el-input
          :disabled="true"
          v-model="CommodityDataModify.prodShowName"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="商品编码"
      ...
      >
        <el-input
          :disabled="true"
          v-model="CommodityDataModify.prodCode"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="商品形式"
      ...
      >
        <el-select
          :disabled="true"
          v-model="CommodityDataModify.prodType"
          placeholder="请选择"
        >
          <el-option
            label="实物"
      ...
      <el-form-item
        v-if="CommodityDataModify.prodType == 2"
        prop="vouBatchId"
      >
        <span slot="label">
          <label class="required-icon">*</label> 卡券选择
        </span>
        <el-select
          :disabled="true"
          v-model="CommodityDataModify.vouBatchId"
          placeholder="请选择"
        >
          <el-option
      ...
      <el-form-item
        label="保质期"
        prop="prodWarrantyPeriod"
      >
        <el-input
          :disabled="true"
          class="inputtime"
          v-model.number="CommodityDataModify.prodWarrantyPeriod"
        ></el-input>
        <el-select
          :disabled="true"
          class="selecttime"
      ...
      <el-form-item
        label="单位"
        prop="prodUnitMeasure"
      >
        <el-input
          :disabled="true"
          v-model="CommodityDataModify.prodUnitMeasure"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="供货价"
        prop="prodSupplyPrice"
      >
        <el-input
          :disabled="true"
          v-model.trim="CommodityDataModify.prodSupplyPrice"
          maxlength="10"
        ></el-input>元
      </el-form-item>
      <el-form-item
        label="零售价"
        prop="prodRetailPrice"
      >
        <el-input
          :disabled="true"
          v-model.trim="CommodityDataModify.prodRetailPrice"
          maxlength="10"
        ></el-input>元
      </el-form-item>
      <el-form-item
        label="划线价"
        prop="prodMarketPrice"
      >
        <el-input
          :disabled="true"
          v-model.trim="CommodityDataModify.prodMarketPrice"
          maxlength="10"
        ></el-input>元
      </el-form-item>
      <el-form-item
      ...
      >
        ...
        <el-select
          :disabled="true"
          v-model="CommodityDataModify.delivWays"
          multiple
          placeholder="请选择"
        >
          <el-option
      ...
      >
        ...
        <el-switch
          :disabled="true"
          v-model="CommodityDataModify.isNeedInv"
        ></el-switch>
      </el-form-item>
      <el-form-item
        v-if="isInvShow && isSafeInv"
        prop="prodSafeCount"
      >
        <span slot="label">
        ...
        <el-input
          :disabled="true"
          v-model.number="CommodityDataModify.prodSafeCount"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="可售数量"
        prop="availableSaleQty"
      >
        <el-input
          :disabled="true"
          v-model.number="CommodityDataModify.availableSaleQty"
        ></el-input>
      </el-form-item>
      <el-form-item
        v-if="isFreeShip"
      ...
      >
        <span slot="label">
          <label class="required-icon">*</label> 快递费
        </span>
        ...
        <el-switch
          :disabled="true"
          v-model="CommodityDataModify.isFreeShipping"
        ></el-switch>
        <span v-if="!CommodityDataModify.isFreeShipping">
          &nbsp;&nbsp;
          <el-select
            :disabled="true"
            v-model="CommodityDataModify.expressFeeId"
    ...
    <div>
      <el-button
        class="addbutton"
        @click="hotelProdSpecsAdd"
      >添加规格</el-button>
    </div>
    <el-table
      :data="ProdSpecsDataList"
      border
      stripe
      style="width:100%;"
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            type="text"
            size="small"
            @click="hotelProdSpecsDetail(scope.row.id)"
          >详情</el-button>
          <el-button
            type="text"
            size="small"
            @click="hotelProdSpecsModify(scope.row.id)"
          >修改</el-button>
          <el-button
            type="text"
            size="small"
            @click="hotelProdSpecsDelete(scope.row.id)"
          >移除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        funcId: [{ required: true, message: "请选择功能区", trigger: "change" }]
        // classifyIds: [
  ...
  methods: {
      ...
      this.$api
        ...
        .then(response => {
          ...
          if (result.code == "0") {
            ...
            this.CommodityDataModify.prodWarrantyPeriod = parseInt(
              qualityType.substr(0, qualityType.length - 1)
            );
          } else {
    ...
    deleteConfirm() {
      const params = {};
      this.$api
        .hotelProdSpecsDelete(params, this.hpsId)
        .then(response => {
          // console.log(response);
          const result = response.data;
          if (result.code == "0") {
