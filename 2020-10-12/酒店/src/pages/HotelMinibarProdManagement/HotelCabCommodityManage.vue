<template>
    <div class="commoditylist">
        ...
        <el-table :data="HotelCommodityDataList" border style="width:100%;" >
            ...
            <el-table-column prop="product.prodName" label="商品名称" align=center></el-table-column>
            <!-- <el-table-column prop="prodSafeCount" label="安全库存" width="140px" align=center></el-table-column> -->
            <el-table-column fixed="right" label="操作" align=center>
                <template slot-scope="scope">
                    <el-button v-if="authzData['F:BH_PROD_CABPROD_EDIT']" type="text" size="small" @click="ModifyHotelCommodity(scope.row.id)">更换商品</el-button>
                    <el-button v-if="scope.row.prodCode && authzData['F:BH_PROD_CABPROD_DELETE']" type="text" size="small" @click="ClearHotelCommodity(scope.row.id)">清除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <div class="returnbtn">
...
export default {
    ...
    methods: {
        ...
        ModifyHotelCommodity(id){
            ...
            this.$router.push({name: 'HotelCabCommodityModify', query: {id, profileId}});
            ...
            //             this.$router.push({name: 'HotelCabCommodityModify', query: {id}, params: {hotelId: this.hotelId}});
            //         }else{
