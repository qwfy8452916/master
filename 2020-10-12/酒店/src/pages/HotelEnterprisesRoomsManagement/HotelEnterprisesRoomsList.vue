  ...
  <div>
    <el-form :inline="true" align="left" class="searchform">
      ...
      <el-form-item label="房源">
        <el-select v-model="roomResourceId" placeholder="请选择房源">
          <el-option
    ...
    <el-table :data="CabinetList" border stripe style="width:100%;">
        ...
        <template slot-scope="scope">
          <div v-if="!scope.row.totalRoomFlag">
            <span
              ...
              v-for="item in scope.row.roomResourceIds"
              :key="item.id"
            >{{item.roomResourceName}}</span>
          </div>
          <div v-else>全部</div>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="contractedPrice" label="折扣/金额" align="center"></el-table-column>
