    ...
    <div class="functionadd">
        ...
        <el-form :model="FunctionProdData" :rules="rules" ref="FunctionProdData" label-width="100px" class="functionform">
            ...
            <el-form-item>
                ...
                <el-button v-if="authzData['F:BH_PROD_FUNCPROD_ADD_SUBMIT']" type="primary" :disabled="isSubmit" @click="submitForm('FunctionProdData')">确定</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        selectProd(value){
            ...
            this.FunctionProdData.EleCouponsData = prodInfo.EleCouponsData;
