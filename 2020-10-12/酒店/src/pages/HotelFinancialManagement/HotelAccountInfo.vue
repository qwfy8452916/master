<template>
    <div class="HotelAccountgMan">
       <h3 class="alignleft">账户管理</h3>
       <div class="btnwrap">
           <el-button v-if="authzlist['F:BH_FIN_HOTELACCOUNTINFO_WAITINCOME']" type="primary" class="waiteBtn" @click="waiteRecord">待入账记录></el-button>
           <el-button v-if="authzlist['F:BH_FIN_HOTELACCOUNTINFO_INCOME']" type="warning" class="entrydis" @click="entryRecord">入账记录></el-button>
           <el-button v-if="authzlist['F:BH_FIN_ACCOUNTGMAN_APPLICATION']" type="success" @click="applycash">提现></el-button>
           <el-button v-if="authzlist['F:BH_FIN_ACCOUNTGMAN_WITHDRAWLIST']" type="primary" @click="Hotelgetcashdetail">提现记录></el-button>
       </div>
       ...
       <!-- <div class="wrap">
           ...
           <el-button v-if="authzlist['F:BH_FIN_ACCOUNTGMAN_APPLICATION']" class="applycash" type="primary" @click="applycash">申请提现</el-button></div>
           <div class="hangitem"><span>账户锁定金额(元):</span>{{accountdetail.frozeAmount}}</div>
           <div class="hangitem"><span v-if="authzlist['F:BH_FIN_ACCOUNTGMAN_DIVIDEDDETAIL']" class="checkdetail" @click="HotelDividedetail">查看分成明细></span></div>
           <div><span v-if="authzlist['F:BH_FIN_ACCOUNTGMAN_WITHDRAWLIST']" class="checkdetail" @click="Hotelgetcashdetail">查看提现明细></span></div>
       </div> -->
        ...
        <!-- 提现弹窗 -->
          <el-dialog title="" :visible.sync='dialogVisibleDelete' center width="30%">
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submitniu">提 交</el-button>
                <div class="ruleswrap">
