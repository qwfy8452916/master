  ...
  <div class="CardticketAdd">
    ...
    <el-form align="left" :model="carddata" label-width="140px" ref="carddata" :rules="rules">
        ...
        <div>
          ...
          <span v-if="carddata.vouDeductibleType==1">
            ...
            <el-form-item
              ...
              prop="vouDeductibleProdSpecId"
              style="display:inline-block;"
            >
              <el-select
                v-model="carddata.vouDeductibleProdSpecId"
                class="specguige"
                @change="specchange"
                value-key="id"
              >
      ...
      <el-form-item>
        ...
        <el-button
          v-if="authzData['F:BH_VOU_CARDTICKET_ADD_SUBMIT']"
          type="primary"
