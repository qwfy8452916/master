  ...
  <div class="CardticketDetail">
    ...
    <el-form align="left" :model="carddata" label-width="140px">
      ...
      <el-form-item label="卡券说明" prop="vouInstruction">
        <el-input
          v-model="carddata.vouInstruction"
          :disabled="true"
          type="textarea"
          :rows="5"
          maxlength="250"
      ...
      <el-form-item label="核销地点" prop="vouVerifiedAddress" v-if="carddata.vouUseScene==1">
        <el-input
          v-model="carddata.vouVerifiedAddress"
          :disabled="true"
          :rows="3"
          type="textarea"
          maxlength="250"
      ...
      <el-form-item label="核销次数" prop="vouVerifiedTotalType" v-if="carddata.vouUseScene==1">
        ...
        <span v-if="carddata.vouVerifiedTotalType==2">
          <el-form-item prop="vouVerifiedTotal" style="display:inline-block;">
            <el-input
              class="vouVerifiedTotal"
              :disabled="true"
              v-model.number="carddata.vouVerifiedTotal"
            ></el-input>次
          </el-form-item>
        </span>
      </el-form-item>
      <el-form-item label="抵扣设置" prop="vouDeductibleType" v-if="carddata.vouUseScene==2">
        <el-radio
          v-model="carddata.vouDeductibleType"
          :disabled="true"
          :label="0"
          @change="setdikou"
        >现金</el-radio>
        ...
        <div>
          ...
          <span v-if="carddata.vouDeductibleType==1">
            <span style="margin-right:5px;color:#C0C4CC">
              {{carddata.deductHotelProdName}}
              <span v-if="carddata.deductHotelProdSpecName!=null">(</span>
              {{carddata.deductHotelProdSpecName}}
              <span v-if="carddata.deductHotelProdSpecName!=null">)</span>
            </span>
          </span>
        </div>
...
export default {
  ...
  methods: {
    ...
    CardticketDetail() {
      ...
      let params = {};
      this.$api
        .CardticketDetail(params, this.detailId)
        .then((response) => {
