<template>
  ...
  <div class="login-bg">
    ...
    <el-dialog title="提示" :visible.sync="isDialogShow" width="30%">
      <span>请联系管理员</span>
      <span slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          @click="isDialogShow = false"
          style="width: 20%; border-radius: 4px;"
        >确 定</el-button>
      </span>
    </el-dialog>
  </div>
          ...
          this.$api
            ...
            .then((response) => {
              ...
              if (result.code == "0") {
                ...
                const hotelIsSupportTakeOutOrder =
                  result.data.hotelDTO.isSupportTakeOutOrder;
                const orgId = result.data.hotelDTO.orgId;
                const hotelServicePhone =
                  result.data.hotelDTO.hotelServicePhone;
                ...
                localStorage.setItem("hotelServicePhone", hotelServicePhone);
