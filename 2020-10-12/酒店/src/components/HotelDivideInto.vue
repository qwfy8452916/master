<template>
    <div class="HotelDivideInto">
        ...
        <div v-if="HotelDivideIntoulshow">
            <ul class="HotelDivideIntoul" v-for="item in HotelDivideIntoList" :key="item">
                <li>
        ...
        <div>
            <el-button  v-if="authzlist['F:BH_FIN_DIVIDEINTOSUBMIT']" class="addbutton" @click="dialogFormVisible = true">提&nbsp;&nbsp;现</el-button>
        </div>
