// pages/waitIncomeRecord/waitIncomeRecord.js
const app=getApp();
...
app.Base({
  ...
  data: {
    ...
    waiteEntryRecordDataList:[], //待入账记录
    date:'',
    date2:'',
    pageNum:1,
    sizeJudge:0,
  ...
  waiteEntryRecord:function(){
    ...
    wxrequest.getWaitDivide(linkData).then(res => {
      wx.hideLoading();
      ...
      if (resdata.code == 0) {
        ...
        that.setData({
          waiteEntryRecordDataList: tempDataSet
        })
      } else {
        wx.showToast({
          title: res.data.msg,
  ...
  //待入账详情
  waitIncomeRecordDetail:function(e){
    let id=e.currentTarget.dataset.id
    wx.navigateTo({
      url: '../waitIncomeRecordDetail/waitIncomeRecordDetail?id=' + id,
    })
  },
