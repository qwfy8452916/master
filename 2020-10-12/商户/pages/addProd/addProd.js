...
Page({
  ...
  surebtn:function(){
    ...
    if (nowfunProdData.funcProdSpecId.toString().length<1){
      nowfunProdData.funcProdSpecId=0;
    }
    let prodAdd={
      id: '',
      ...
      prodSpecs: nowfunProdData.prodSpecs,
  ...
  getCategoryList:function(){
    let that=this;
    let linkData={
      funcId: wx.getStorageSync('funcId'),
  ...
  bindPickerSpec:function(e){
    ...
    this.setData({
      ...
      'funProdData.prodSpecs': nowspecList[index].specName,
    })
  },
