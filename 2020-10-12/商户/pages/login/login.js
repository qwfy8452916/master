...
app.Base({
  ...
  savedata: function (data) {//保存数据
    ...
    const hotelIsSupportTakeOutOrder = data.hotelDTO.isSupportTakeOutOrder;
    ...
    wx.setStorageSync("hotelIsSupportTakeOutOrder", hotelIsSupportTakeOutOrder);
    wx.setStorageSync("hotelName", hotelDTO_data.hotelName);
