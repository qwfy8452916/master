// pages/package/pages/ownProdSpecsAdd/ownProdSpecsAdd.js
const app = getApp();
...
app.Base({
  ...
  sureBtn: function () {
    ...
    let linkData = {
      ...
      bannerImages: nowprodSpecsData.bannerImages,

    }



    wxrequest.hotelProdSpecsAdd(linkData, that.data.id).then(res => {
